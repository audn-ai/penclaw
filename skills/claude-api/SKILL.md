---
name: claude-api
description: "Build apps with the Claude API, Anthropic SDK, or Managed Agents. Use when: code imports `anthropic`/`@anthropic-ai/sdk`/`claude_agent_sdk`, user asks to use Claude API, Anthropic SDKs, Agent SDK, or Managed Agents. DO NOT use when: code imports `openai`/other AI SDK, general programming, or ML/data-science tasks."
metadata:
  {
    "openclaw":
      {
        "emoji": "🤖",
        "os": ["darwin", "linux"],
        "requires": { "anyBins": ["python3", "node", "curl"] },
        "install":
          [
            {
              "id": "pip-anthropic",
              ...
              "package": "anthropic",
              "bins": ["python3"],
              "label": "Install Anthropic Python SDK (pip)",
            },
            {
              "id": "npm-anthropic",
              "kind": "npm",
              ...
              "bins": ["node"],
              "label": "Install Anthropic TypeScript SDK (npm)",
            },
          ],
      },
  }
