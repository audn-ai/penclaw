...
} from "./bundled-sources-D7CuFv_v.js";
...
import { c as clearLoadInstalledPluginIndexInstallRecordsCache } from "./installed-plugin-index-record-reader-D7CXgzhH.js";
import {
...
import { n as resolveBundledInstallPlanForCatalogEntry } from "./plugin-install-plan-BhAMBjAf.js";
import { t as clearPluginMetadataLifecycleCaches } from "./plugin-metadata-lifecycle-C3dWg4tn.js";
import { o as isRecord } from "./record-coerce-DHZ4bFlT.js";
import { t as invalidatePluginRuntimeDiscoveryAfterConfigMutation } from "./registry-refresh-XzeGvhvw.js";
...
function resolveInstallDefaultChoice(params) {
  ...
  if (updateChannel === "stable" || updateChannel === "extended-stable" || updateChannel === "beta")
...
async function installPluginFromClawHubSpecWithProgress(params) {
  ...
  try {
    const { installPluginFromClawHub } = await import("./clawhub-C72iVVMb.js");
    const result = await withTimeout(
...
async function ensureOnboardingPluginInstalled(params) {
  ...
  if (!shouldTryNpm || !npmInstallSpec) {
    await prompter.note(
      t("wizard.plugins.noRemoteInstallSource", { plugin: sanitizeTerminalText(entry.label) }),
      t("wizard.plugins.installTitle"),
    );
    runtime.error?.(
