import {
  C as DiagnosticMemoryUsage,
  Z as DiagnosticSessionActiveWorkKind,
  it as DiagnosticSessionState,
  y as DiagnosticLivenessWarningReason,
...
declare function logSessionStateChange(
  params: SessionRef & {
...
declare function logSessionAttention(
  params: SessionRef & {
    state: SessionStateValue;
    ageMs: number;
    thresholdMs: number;
...
declare function logRunAttempt(
  params: SessionRef & {
    runId: string;
    attempt: number;
  },
): void;
declare function logToolLoopAction(
  params: SessionRef & {
    toolName: string;
...
declare function startDiagnosticHeartbeat(
...
declare function redactIdentifier(
...
export {
  logDebug as A,
  resolveStuckSessionWarnMs as C,
  diagnosticLogger as D,
  updateDiagnosticSessionFile as E,
  logInfo as M,
  logSuccess as N,
  logLaneDequeue as O,
  logWarn as P,
  resolveStuckSessionAbortMs as S,
  stopDiagnosticHeartbeat as T,
  logWebhookProcessed as _,
  logActiveRuns as a,
  requestStuckDiagnosticSessionRecovery as b,
  logMessageProcessed as c,
  logRunAttempt as d,
  logSessionAttention as f,
  logWebhookError as g,
  logToolLoopAction as h,
  isStuckSessionRecoveryEnabled as i,
  logError as j,
  logLaneEnqueue as k,
  logMessageQueued as l,
  logSessionTurnCreated as m,
  sha256HexPrefix as n,
  logMessageDispatchCompleted as o,
  logSessionStateChange as p,
  getDiagnosticSessionStateCountForTest as r,
  logMessageDispatchStarted as s,
  redactIdentifier as t,
  logMessageReceived as u,
  logWebhookReceived as v,
  startDiagnosticHeartbeat as w,
  resetDiagnosticStateForTest as x,
  markDiagnosticSessionProgress as y,
};
