...
const ExecApprovalForwardingSchema = object({
  ...
  mode: union([literal("session"), literal("targets"), literal("both")]).optional(),
...
//#endregion
export {
  ApprovalsSchema as a,
  ChannelHeartbeatVisibilitySchema as i,
  ChannelsSchema as n,
  NativeExecApprovalEnableModeSchema as o,
  ChannelHealthMonitorSchema as r,
  ChannelBotLoopProtectionSchema as t,
};
