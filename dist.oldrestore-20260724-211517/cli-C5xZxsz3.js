...
function registerGoogleMeetCli(params) {
  ...
  root
    ...
    .action(async (sessionId, options) => {
      ...
      if (options.since !== void 0 && sinceIndex === void 0)
