...
import { r as notifyDiscordInboundEventOutboundSuccess } from "./inbound-event-delivery-DO43mRtB.js";
...
import {
  r as isDiscordComponentSpecWithinMessageLimit,
...
import { t as handleDiscordAction } from "./runtime-oJHQJikc.js";
import "./action-runtime-api-C1VI-58_.js";
import {
  n as buildDiscordPresentationComponents,
  t as buildDiscordInteractiveComponents,
} from "./shared-interactive-DZQigUf4.js";
...
async function handleDiscordMessageAction(ctx) {
  ...
  const notifyVisibleOutbound = (to, fallbackSessionKey) =>
  ...
  if (action === "send") {
    ...
    const presentation =
      params.components == null ? normalizeMessagePresentation(params.presentation) : void 0;
