...
import {
  ...
  o as tracePluginLifecyclePhaseAsync,
...
async function runPluginUninstallCommand(id, opts = {}, runtime = defaultRuntime) {
  ...
  const { buildPluginSnapshotReport } = await import("./status-Lj_1VRdO.js");
  const {
  ...
  } = await import("./uninstall-DQK-jpcd.js");
  ...
  const { PromptInputClosedError, promptYesNo } = await import("./prompt-C8Tlccyz.js");
