import { t as createApprovalNativeRouteReporter } from "./approval-native-route-coordinator-Bz8uAvSP.js";
...
import { i as isApprovalMethod } from "./method-scopes-DrxGpKMT.js";
import { t as createOperatorApprovalsGatewayClient } from "./operator-approvals-client-DekCwBNw.js";
...
function createChannelNativeApprovalRuntime(adapter) {
  ...
  const resolveApprovalKind =
    adapter.resolveApprovalKind ?? ((request) => resolveApprovalRequestKind(request));
  const routeReporter = createApprovalNativeRouteReporter({
    ...
    requestGateway: async (method, params) => {
      const { callGatewayLeastPrivilege } = await import("./call-BtFiTrFI.js");
