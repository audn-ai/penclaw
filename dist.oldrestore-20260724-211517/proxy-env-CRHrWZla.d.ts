...
declare const PROXY_ENV_KEYS: readonly [
  "HTTP_PROXY",
  "HTTPS_PROXY",
  "ALL_PROXY",
  "http_proxy",
 ...
 */
declare function resolveEnvHttpProxyAgentOptions(
  env?: NodeJS.ProcessEnv,
...
//#endregion
export {
  hasProxyEnvConfigured as a,
  resolveEnvHttpProxyUrl as c,
  hasEnvHttpProxyConfigured as i,
  shouldUseEnvHttpProxyForUrl as l,
  PROXY_ENV_KEYS as n,
  matchesNoProxy as o,
  hasEnvHttpProxyAgentConfigured as r,
  resolveEnvHttpProxyAgentOptions as s,
  EnvHttpProxyAgentProxyOptions as t,
};
