...
import {
  ...
  p as isPrivateOrLoopbackIpAddress,
  s as isIpInCidr,
} from "./ip-CyyRxPli.js";
import {
  i as safeNetworkInterfaces,
  n as pickMatchingExternalInterfaceAddress,
  r as readNetworkInterfaces,
} from "./network-interfaces-S5y8vKUw.js";
import { a as normalizeLowercaseStringOrEmpty } from "./string-coerce-DW4mBlAt.js";
import { n as pickPrimaryTailnetIPv4 } from "./tailnet-k93TkOdF.js";
...
function resolveLocalInterfaceAddressMatch(ip, snapshot) {
  ...
  for (const entries of Object.values(effectiveSnapshot))
    for (const entry of entries ?? []) if (normalizeIp(entry.address) === normalized) return true;
  return false;
}
/**
