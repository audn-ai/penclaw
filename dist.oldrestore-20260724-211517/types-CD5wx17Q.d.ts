import {
  a as SandboxBackendId,
  i as SandboxBackendHandle,
  u as SandboxFsBridge,
} from "./backend-handle.types-BB1SUqT2.js";
import { a as SkillUsagePath, n as SkillEligibilityContext } from "./types-9R5xAbjv.js";
import { d as SandboxDockerSettings } from "./types.provider-request-CVFNhEKy.js";
...
type RequiredDockerConfigKeys =
  ...
  | "network"
  | "capDrop";
type SandboxDockerConfig = Omit<SandboxDockerSettings, RequiredDockerConfigKeys> &
...
//#endregion
export {
  SandboxToolPolicyResolved as a,
  SandboxToolPolicy as i,
  SandboxContext as n,
  SandboxWorkspaceAccess as o,
  SandboxSshConfig as r,
  SandboxConfig as t,
};
