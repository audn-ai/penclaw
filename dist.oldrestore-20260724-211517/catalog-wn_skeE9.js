...
import { a as listOfficialExternalChannelCatalogEntries } from "./official-external-plugin-catalog-B2V9K3em.js";
  ...
  return (
    options.excludePluginRefs?.some(
      (entry) =>
        ...
        (entry.origin === void 0 || entry.origin === origin),
    ) ?? false
  );
}
...
export {
  ...
  listRawChannelPluginCatalogEntries as r,
