...
} from "./setup-surface-CpvzoBvP.js";
import {
...
} from "./twitch-C10wRDoI.js";
import { _ as MarkdownConfigSchema } from "./zod-schema.core-CWTCY1ZZ.js";
...
const twitchMessageAdapter = defineChannelMessageAdapter({
  ...
  send: {
    text: async (ctx) => {
      ...
      return toTwitchMessageSendResult(
 ...
 */
const TwitchRoleSchema = _enum(["moderator", "owner", "vip", "subscriber", "all"]);
 ...
 */
const TwitchConfigSchema = union([
  object({
...
async function resolveHelixUser(request) {
...
function normalizeTwitchMessagingTarget(target) {
  ...
  return normalizeTwitchChannel(
    kindMatch ? providerTarget.slice(kindMatch[0].length) : providerTarget,
  );
}
/**
      ...
      startAccount: async (ctx) => {
        ...
        try {
          await runStoppablePassiveMonitor({
            ...
            start: async () => {
              const { monitorTwitchProvider } = await import("./monitor-CwfH6n3x.js");
