...
function shouldDeferConfiguredPluginInstallRepair(env) {
  return (
    ...
    (isTruthyEnvValue(env["OPENCLAW_UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR"]) ||
...
//#endregion
export {
  UPDATE_PARENT_SUPPORTS_DOCTOR_CONFIG_WRITE_ENV as a,
  isLegacyPackageUpdateDoctorPass as c,
  isUpdatePackageSwapInProgress as d,
  shouldDeferConfiguredPluginInstallRepair as f,
  UPDATE_PARENT_ALLOWS_GATEWAY_SERVICE_REPAIR_ENV as i,
  isLegacyParentWritableUpdateDoctorPass as l,
  UPDATE_IN_PROGRESS_ENV as n,
  UPDATE_PARENT_SUPPORTS_GATEWAY_RESTART_ENV as o,
  UPDATE_PARENT_ALLOWS_GATEWAY_ACTIVATION_ENV as r,
  UPDATE_POST_CORE_CONVERGENCE_ENV as s,
  UPDATE_DEFER_CONFIGURED_PLUGIN_INSTALL_REPAIR_ENV as t,
  isPostCoreConvergencePass as u,
};
