...
declare function withTempWorkspace<T>(
...
declare function withTempWorkspaceSync<T>(
  options: TempWorkspaceOptions,
  run: (workspace: TempWorkspaceSync) => T,
): T;
//#endregion
export {
  tempWorkspaceSync as a,
  tempWorkspace as i,
  TempWorkspaceOptions as n,
  withTempWorkspace as o,
  TempWorkspaceSync as r,
  withTempWorkspaceSync as s,
  TempWorkspace as t,
};
