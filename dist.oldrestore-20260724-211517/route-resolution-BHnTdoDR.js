import { r as normalizeDiscordAllowList } from "./allow-list-DdPHme1x.js";
...
import { D as canViewDiscordGuildChannel } from "./send.shared-Ciix19qx.js";
...
function createDiscordIngressResolver(params) {
  return createChannelIngressResolver({
    ...
    ...(params.useDefaultPairingStore !== void 0
...
async function resolveDiscordTextCommandAccess(params) {
  ...
  const accessGroupMembership = params.memberAccessConfigured
    ...
    : [];
  return (
    await createDiscordIngressResolver({
      accountId: params.accountId,
      cfg: params.cfg,
      token: params.token,
      rest: params.rest,
...
export {
  ...
  resolveDiscordTextCommandAccess as c,
