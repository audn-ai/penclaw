...
declare function mergeSsrFPolicies(
...
declare function ssrfPolicyFromHttpBaseUrlFakeIpHostnameAllowlist(
  baseUrl: string,
): SsrFPolicy | undefined;
...
declare function resolvePinnedHostnameWithPolicy(
  hostname: string,
  params?: {
    lookupFn?: LookupFn;
    policy?: SsrFPolicy;
...
declare function resolvePinnedHostname(
  hostname: string,
  lookupFn?: LookupFn,
): Promise<PinnedHostname>;
declare function createPinnedDispatcher(
...
//#endregion
export {
  resolveSsrFPolicyForUrl as C,
  ssrfPolicyFromHttpBaseUrlFakeIpHostnameAllowlist as E,
  resolvePinnedHostnameWithPolicy as S,
  ssrfPolicyFromHttpBaseUrlAllowedOrigin as T,
  isSameSsrFPolicy as _,
  SsrFBlockedError as a,
  normalizeHostnameAllowlist as b,
  assertPublicHostname as c,
  createPinnedLookup as d,
  isBlockedHostname as f,
  isPrivateNetworkAllowedByPolicy as g,
  isPrivateIpAddress as h,
  PinnedHostnameOverride as i,
  closeDispatcher as l,
  isHostnameAllowedByPattern as m,
  PinnedDispatcherPolicy as n,
  SsrFPolicy as o,
  isBlockedHostnameOrIp as p,
  PinnedHostname as r,
  assertHostnameAllowedWithPolicy as s,
  LookupFn as t,
  createPinnedDispatcher as u,
  matchesHostnameAllowlist as v,
  ssrfPolicyFromHttpBaseUrlAllowedHostname as w,
  resolvePinnedHostname as x,
  mergeSsrFPolicies as y,
};
