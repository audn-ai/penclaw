...
import {
  ...
  D as resolveGogServeInvocation,
  E as resolveGogExecutable,
  ...
  y as buildTopicPath,
} from "./gmail-setup-utils-DS_47OeJ.js";
import {
...
import { a as displayPath } from "./utils-DtcDeqWS.js";
...
async function startGmailWatch(cfg, fatal = false) {
  const result = await runCommandWithTimeout(
    [resolveGogExecutable(), ...buildGogWatchStartArgs(cfg)],
    { timeoutMs: 12e4 },
  );
  if (result.code !== 0) {
