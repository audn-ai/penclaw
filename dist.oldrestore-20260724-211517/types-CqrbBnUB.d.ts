...
type StreamFunction<TApi extends Api = Api, TOptions extends StreamOptions = StreamOptions> = (
  model: Model<TApi>,
  context: Context,
  options?: TOptions,
...
interface OpenRouterRouting {
  ...
  max_price?: {
    /** Price per million prompt tokens. */ prompt?:
      | number
      | string /** Price per million completion tokens. */;
...
//#endregion
export {
  ToolResultMessage as A,
  TextContent as C,
  ThinkingLevelMap as D,
  ThinkingLevel as E,
  Usage as M,
  UserMessage as N,
  Tool as O,
  StreamOptions as S,
  ThinkingContent as T,
  ProviderStreamOptions as _,
  AssistantMessageEventStreamContract as a,
  StreamFn as b,
  Context as c,
  Message as d,
  Model as f,
  ProviderResponse as g,
  OpenAIResponsesCompat as h,
  AssistantMessageEvent as i,
  Transport as j,
  ToolCall as k,
  ImageContent as l,
  OpenAICompletionsCompat as m,
  Api as n,
  CacheRetention as o,
  ModelThinkingLevel as p,
  AssistantMessage as r,
  CompleteSimpleFn as s,
  AnthropicMessagesCompat as t,
  MaybePromise as u,
  SimpleStreamOptions as v,
  ThinkingBudgets as w,
  StreamFunction as x,
  StopReason as y,
};
