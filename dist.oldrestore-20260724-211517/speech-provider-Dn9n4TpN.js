...
import { n as inferEdgeExtension, t as edgeTTS } from "./tts-DdtXLPm1.js";
...
function buildMicrosoftSpeechProvider() {
  return {
    ...
    listVoices: async (req) => {
      return await listMicrosoftVoices(
        readMicrosoftProviderConfig(req.providerConfig ?? {}).timeoutMs ?? req.timeoutMs,
      );
    },
