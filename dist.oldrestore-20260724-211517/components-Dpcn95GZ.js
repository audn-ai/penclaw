...
import {
  ...
  I as MediaGallery,
  It as ButtonStyle,
  Jt as TextInputStyle,
  L as MentionableSelectMenu,
  M as ChannelSelectMenu,
  N as Container,
  O as Modal,
  P as File,
  R as RoleSelectMenu,
...
function createButtonComponent(params) {
  ...
  return {
    ...
    entry: {
      ...
      ...(params.spec.callbackDataKind !== void 0
...
function buildDiscordComponentMessage(params) {
  ...
  if (params.spec.modal) {
    ...
    modals.push({
      ...
      fields,
      ...(params.spec.modal.callbackData !== void 0
      ...
      ...(params.accountId !== void 0 ? { accountId: params.accountId } : {}),
      ...(params.spec.reusable !== void 0 ? { reusable: params.spec.reusable } : {}),
      ...(params.spec.modal.allowedUsers !== void 0
