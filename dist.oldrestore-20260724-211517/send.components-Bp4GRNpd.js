...
import "./config-api-BbngEjS0.js";
import "./channel-api-D8WPShfA.js";
import "./outbound-session-route-CtKNfzdZ.js";
...
import {
  ...
  b as stripUndefinedFields,
  g as createDiscordMessageNonce,
  l as resolveChannelId,
  m as SUPPRESS_NOTIFICATIONS_FLAG,
...
function pruneUndefinedRegistryValues(value) {
  if (Array.isArray(value))
    return value
      ...
      .map((entry) => pruneUndefinedRegistryValues(entry));
...
const DISCORD_FORUM_LIKE_TYPES = /* @__PURE__ */ new Set([
