...
type ResolvedAgentRoute = {
  ...
  dmScope?:
    ...
    | "per-peer"
    | "per-channel-peer"
    | "per-account-channel-peer" /** Internal session key used for persistence + concurrency. */;
...
//#endregion
export {
  deriveLastRoutePolicy as a,
  buildAgentSessionKey as i,
  RoutePeer as n,
  resolveAgentRoute as o,
  RoutePeerKind as r,
  resolveInboundLastRouteSessionKey as s,
  ResolvedAgentRoute as t,
};
