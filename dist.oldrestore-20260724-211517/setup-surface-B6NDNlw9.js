...
import { r as formatUnknownError } from "./errors-H7JG5Gly.js";
import {
  g as hasConfiguredMSTeamsCredentials,
  v as resolveMSTeamsCredentials,
  y as saveDelegatedTokens,
  ...
  finalize: async (params) => {
    ...
    if (finalCreds?.type === "secret") {
      if (
        ...
        let oauthModule;
        try {
          oauthModule = await import("./oauth-41dKy3XV.js");
        } catch (err) {
