import { g as isGatewayTransportError } from "./call-BVMO6az_.js";
...
const formatHealthChannelLines = (summary, opts = {}) => {
  ...
  for (const channelId of channelOrder) {
    ...
    const selectedSummary = expectDefined(
...
//#endregion
export {
  formatHealthChannelLines as n,
  formatHealthCheckFailure as r,
  formatGatewayClosedDiagnostic as t,
};
