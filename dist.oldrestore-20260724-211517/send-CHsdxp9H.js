...
import { f as saveMediaStream, u as saveMediaBuffer } from "./store-BfbXoJVN.js";
import { a as normalizeLowercaseStringOrEmpty } from "./string-coerce-DW4mBlAt.js";
import { t as convertMarkdownTables } from "./tables-YoFSvuf8.js";
import { i as resolveReceiveIdType, r as normalizeFeishuTarget } from "./targets-5VnlkfaZ.js";
import { i as withTempDownloadPath } from "./temp-download-lJ1zbvdM.js";
...
async function saveFeishuResponseMedia(params) {
  ...
  if (responseWithOptionalFields[Symbol.asyncIterator])
    return saveMediaStream(responseWithOptionalFields, contentType, "inbound", maxBytes, fileName);
    ...
    return {
      textContent:
        [escapeMarkdownText(payload.title.trim()), paragraphs.join("\n").trim()]
          ...
          .join("\n\n")
          .trim() ||
        (options.emptyTextFallback ?? FALLBACK_POST_TEXT),
      imageKeys,
      mediaKeys,
      mentionedOpenIds,
    };
...
//#endregion
export {
  resolveFeishuIdentityEmoji as _,
  sendMarkdownCardFeishu as a,
  parsePostContent as c,
  isMentionForwardRequest as d,
  isFeishuGroupChatType as f,
  normalizeFeishuExternalKey as g,
  shouldSuppressFeishuTextForVoiceMedia as h,
  sendCardFeishu as i,
  extractMentionTargets as l,
  sendMediaFeishu as m,
  getMessageFeishu as n,
  sendMessageFeishu as o,
  saveMessageResourceFeishu as p,
  listFeishuThreadMessages as r,
  sendStructuredCardFeishu as s,
  editMessageFeishu as t,
  isFeishuBroadcastMention as u,
  resolveFeishuIdentityHeaderTitle as v,
};
