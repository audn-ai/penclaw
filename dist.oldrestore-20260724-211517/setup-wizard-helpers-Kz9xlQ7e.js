...
const loadProviderAuthInput = createLazyRuntimeModule(
  () => import("./provider-auth-ref-D7BIqL-l.js"),
);
...
function asAllowFromList(value) {
  return Array.isArray(value)
    ? value.filter((entry) => typeof entry === "string" || typeof entry === "number")
    : void 0;
}
...
function setChannelDmPolicyWithAllowFrom(params) {
  ...
  const allowFrom =
    dmPolicy === "open" ? addWildcardAllowFrom(asAllowFromList(channelConfig?.allowFrom)) : void 0;
  return {
    ...cfg,
    channels: {
      ...cfg.channels,
