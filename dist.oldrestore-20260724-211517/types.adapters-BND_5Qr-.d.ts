import {
  B as ChannelApprovalKind,
  P as ChannelApprovalNativeAdapter,
  l as ChannelApprovalNativeRuntimeAdapter,
} from "./approval-handler-runtime-types-BO5RsjHV.js";
import { n as ChannelRuntimeSurface } from "./channel-runtime-surface.types-CouuvmKm.js";
import { d as ExecApprovalResolved, l as ExecApprovalRequest } from "./exec-approvals-B59RubLo.js";
...
import { r as SecretDefaults, t as ResolverContext } from "./runtime-shared-Djq1PqEV.js";
import { o as SecretTargetRegistryEntry } from "./target-registry-types-Dt3AyW6H.js";
import {
  M as ChannelSecurityDmPolicy,
  N as ChannelSetupInput,
  P as ChannelStatusIssue,
  U as ChannelLegacyStateMigrationPlan,
  g as ChannelLogSink,
  h as ChannelHeartbeatDeps,
  i as ChannelAccountState,
  j as ChannelSecurityContext,
  m as ChannelGroupContext,
  r as ChannelAccountSnapshot,
  u as ChannelDirectoryEntry,
} from "./types.core-CcwzPNhX.js";
import { Vt as AgentBinding, i as OpenClawConfig } from "./types.openclaw-DDo8sH3F.js";
...
type ChannelGroupAdapter = {
  resolveRequireMention?: (
    ...
    | boolean
    | undefined /** @deprecated Core never consumed this; removed after the next release train. */;
...
type ChannelGatewayAdapter<ResolvedAccount = unknown> = {
  ...
  ) => Promise<void> /** Keep gateway auth bypass resolution mirrored through a lightweight top-level `gateway-auth-api.ts` artifact. */;
...
//#endregion
export {
  ChannelGroupAdapter as A,
  ChannelSecretsAdapter as B,
  ChannelDoctorConfigMutation as C,
  ChannelElevatedAdapter as D,
  ChannelDoctorSequenceResult as E,
  ChannelLogoutContext as F,
  ConfigWriteScopeLike as G,
  ChannelSetupAdapter as H,
  ChannelLogoutResult as I,
  ConfigWriteTargetLike as K,
  ChannelResolveKind as L,
  ChannelLifecycleAdapter as M,
  ChannelLoginWithQrStartResult as N,
  ChannelGatewayAdapter as O,
  ChannelLoginWithQrWaitResult as P,
  ChannelResolveResult as R,
  ChannelDoctorAdapter as S,
  ChannelDoctorLegacyConfigRule as T,
  ChannelStatusAdapter as U,
  ChannelSecurityAdapter as V,
  ConfigWriteAuthorizationResultLike as W,
  ChannelConfiguredBindingConversationRef as _,
  ChannelApprovalDeliveryAdapter as a,
  ChannelConversationBindingSupport as b,
  ChannelApprovalRenderAdapter as c,
  ChannelCapabilitiesDiagnostics as d,
  ChannelCapabilitiesDisplayLine as f,
  ChannelConfigAdapter as g,
  ChannelCommandConversationContext as h,
  ChannelApprovalCapability as i,
  ChannelHeartbeatAdapter as j,
  ChannelGatewayContext as k,
  ChannelApproveCommandBehavior as l,
  ChannelCommandAdapter as m,
  ChannelAllowlistAdapter as n,
  ChannelApprovalForwardTarget as o,
  ChannelCapabilitiesDisplayTone as p,
  ChannelApprovalAdapter as r,
  ChannelApprovalInitiatingSurfaceState as s,
  ChannelActionAvailabilityState as t,
  ChannelAuthAdapter as u,
  ChannelConfiguredBindingMatch as v,
  ChannelDoctorEmptyAllowlistAccountContext as w,
  ChannelDirectoryAdapter as x,
  ChannelConfiguredBindingProvider as y,
  ChannelResolverAdapter as z,
};
