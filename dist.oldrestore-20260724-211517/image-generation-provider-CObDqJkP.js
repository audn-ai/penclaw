...
import { m as mergeSsrFPolicies } from "./ssrf-keFRGQLq.js";
...
const KREA_SUPPORTED_ASPECT_RATIOS = ["1:1", "4:3", "3:2", "16:9", "2.35:1", "4:5", "2:3", "9:16"];
...
const KREA_CREATIVITY_LEVELS = ["raw", "low", "medium", "high"];
...
function parseFalImageGenerationResponse(payload) {
  ...
  if (rawImages === void 0 || rawImages === null)
    return {
      images: [],
    ...
    return {
      buffer: await readResponseWithLimit(response, maxBytes, {
        onOverflow: ({ maxBytes: maxBytesLocal }) =>
          /* @__PURE__ */ new Error(`fal generated image download exceeds ${maxBytesLocal} bytes`),
      }),
      mimeType,
    };
  } finally {
