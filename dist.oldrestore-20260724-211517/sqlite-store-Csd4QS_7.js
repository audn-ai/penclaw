...
const WORKBOARD_DB_RELATIVE_PATH = ["plugins", "workboard", "workboard.sqlite"];
...
function readCard(db, row) {
  ...
  return {
    ...
    ...(numberValue(row, "started_at") !== void 0
      ? { startedAt: numberValue(row, "started_at") }
      : {}),
    ...(numberValue(row, "completed_at") !== void 0
