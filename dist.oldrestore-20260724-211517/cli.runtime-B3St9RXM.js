...
import { r as withManager } from "./cli-utils-f3ET47a0.js";
...
import {
  a as removeBackfillDiaryEntries,
  s as writeBackfillDiaryEntries,
} from "./dreaming-narrative-DsWreRa1.js";
import { c as seedHistoricalDailyMemorySignals } from "./dreaming-phases-z-A3H73T.js";
import {
...
import { c as normalizeExtraMemoryPaths, s as listMemoryFiles } from "./internal-Dd4OzKYD.js";
import { i as getRuntimeConfig } from "./io-B3ne6NxF.js";
import { i as formatMemoryVectorDegradedWriteReason } from "./manager-tb_prRdP.js";
...
import "./memory-core-host-runtime-cli-Dhepm3RZ.js";
...
import { n as previewGroundedRemMarkdown, t as previewRemHarness } from "./rem-harness-CiJed17O.js";
import { t as buildAgentSessionKey } from "./resolve-route-oiOq6bK9.js";
import { r as defaultRuntime } from "./runtime-Bz6o617W.js";
import {
  C as resolveShortTermRecallStorePath,
  S as resolveShortTermRecallLockPath,
  _ as recordGroundedShortTermCandidates,
  b as removeGroundedShortTermCandidates,
  o as applyShortTermPromotions,
  p as rankShortTermPromotionCandidates,
      ...
      run: async (manager) => {
        try {
          ...
          if (
            ...
            semanticVectorAvailable === void 0 &&
...
async function runMemorySearch(queryArg, opts, hostOptions) {
  ...
  await withMemoryManagerForAgent({
    ...
    run: async (manager) => {
      ...
      const workspaceDir =
        typeof manager.status === "function" ? manager.status().workspaceDir : void 0;
      if (dreamingEnabled)
    ...
    run: async (manager) => {
      ...
      try {
        ...
        const sourcePathByScratchRelativePath = new Map(
          workspaceSourceFiles.map((scratchPath, index) => [
