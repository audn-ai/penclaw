...
function resolveManifestExternalAuthProviderRefs(params = {}) {
  ...
  return uniqueProviderRefs(
    loadPluginManifestRegistryForInstalledIndex({ index: result.snapshot }).plugins.flatMap(
      (plugin) => plugin.contracts?.externalAuthProviders ?? [],
    ),
  );
}
...
//#endregion
export {
  resolveRuntimeSyntheticAuthProviderRefState as n,
  resolveRuntimeSyntheticAuthProviderRefs as r,
  resolveRuntimeExternalAuthProviderRefs as t,
};
