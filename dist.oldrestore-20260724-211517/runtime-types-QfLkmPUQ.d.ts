...
type PrepareImageDescriptionInputParams = Pick<
  DescribeImageFileWithModelParams,
  "filePath" | "mediaUrl" | "mime" | "cfg" | "timeoutMs"
>;
type DescribePreparedImageWithModelParams = Omit<
  DescribeImageFileWithModelParams,
...
//#endregion
export {
  MediaUnderstandingRuntime as a,
  TranscribeAudioFileParams as c,
  ExtractStructuredWithModelParams as i,
  DescribeImageFileWithModelParams as n,
  RunMediaUnderstandingFileParams as o,
  DescribeVideoFileParams as r,
  RunMediaUnderstandingFileResult as s,
  DescribeImageFileParams as t,
};
