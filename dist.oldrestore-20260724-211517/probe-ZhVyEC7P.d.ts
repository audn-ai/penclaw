 ...
 */
declare function probeIMessage(
  timeoutMs?: number,
  opts?: IMessageProbeOptions,
): Promise<IMessageProbe>;
//#endregion
export {
  looksLikeIMessageTargetId as a,
  listEnabledIMessageAccounts as c,
  resolveIMessageAccount as d,
  DEFAULT_IMESSAGE_PROBE_TIMEOUT_MS as i,
  listIMessageAccountIds as l,
  IMessageProbeOptions as n,
  normalizeIMessageMessagingTarget as o,
  probeIMessage as r,
  ResolvedIMessageAccount as s,
  IMessageProbe as t,
  resolveDefaultIMessageAccountId as u,
};
