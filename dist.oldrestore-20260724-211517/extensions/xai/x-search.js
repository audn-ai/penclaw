...
import {
  r as resolveXaiToolApiKeyWithAuth,
...
} from "../../x-search-shared-BLwCYqA4.js";
import {
...
function normalizeOptionalIsoDate(value, label) {
  ...
  if (yearText === void 0 || monthText === void 0 || dayText === void 0)
    throw new PluginToolInputError(`${label} must use YYYY-MM-DD`);
...
function validateXSearchHandleFilters(params) {
  ...
  for (const [label, handles] of [
    ...
    if (handles && handles.length > 20)
      throw new PluginToolInputError(`${label} cannot contain more than 20 handles`);
}
