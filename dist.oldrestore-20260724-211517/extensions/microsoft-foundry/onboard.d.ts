import { c as listSubscriptions } from "../../cli-CUsM9UZj.js";
import { pt as ProviderAuthContext } from "../../plugin-entry-DPCR66aO.js";
import {
  a as AzDeploymentSummary,
  d as FoundryProviderApi,
  f as FoundryResourceOption,
  p as FoundrySelection,
  r as AzAccount,
} from "../../shared-CIt6cRoQ.js";

//#region extensions/microsoft-foundry/onboard.d.ts
declare function listResourceDeployments(
  resource: FoundryResourceOption,
  subscriptionId?: string,
): AzDeploymentSummary[];
declare function selectFoundryResource(
  ctx: ProviderAuthContext,
  selectedSub: AzAccount,
): Promise<FoundryResourceOption>;
declare function selectFoundryDeployment(
  ctx: ProviderAuthContext,
  resource: FoundryResourceOption,
...
declare function promptEndpointAndModelManually(
  ctx: ProviderAuthContext,
...
declare function promptTenantId(
  ctx: ProviderAuthContext,
  params?: {
    suggestions?: Array<{
      id: string;
