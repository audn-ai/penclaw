import {
  n as inspectDiscordAccount,
  t as InspectedDiscordAccount,
} from "../../account-inspect-BHDKo_bp.js";
import {
  a as mergeDiscordAccountConfig,
  c as resolveDiscordAccountConfig,
  i as listEnabledDiscordAccounts,
  l as resolveDiscordMaxLinesPerMessage,
  n as createDiscordActionGate,
  o as resolveDefaultDiscordAccountId,
  r as listDiscordAccountIds,
  s as resolveDiscordAccount,
  t as ResolvedDiscordAccount,
} from "../../accounts-CkKzmLov.js";
import { t as discordPlugin } from "../../channel-CRJ4EPU9.js";
import { t as discordSetupPlugin } from "../../channel.setup-CToYDSR2.js";
import {
  A as parseDiscordComponentCustomIdForInteraction,
  C as DiscordModalFieldSpec,
  D as buildDiscordComponentCustomId,
  E as DISCORD_MODAL_CUSTOM_ID_KEY,
  M as parseDiscordModalCustomIdForInteraction,
  O as buildDiscordModalCustomId,
  S as DiscordModalFieldDefinition,
  T as DISCORD_COMPONENT_CUSTOM_ID_KEY,
  _ as DiscordComponentSectionAccessory,
  a as DISCORD_COMPONENT_ATTACHMENT_PREFIX,
  b as DiscordComponentSelectType,
  c as buildDiscordComponentMessage,
  d as DiscordComponentBuildResult,
  f as DiscordComponentButtonSpec,
  g as DiscordComponentModalFieldType,
  h as DiscordComponentMessageSpec,
  i as createDiscordFormModal,
  j as parseDiscordModalCustomId,
  k as parseDiscordComponentCustomId,
  l as buildDiscordComponentMessageFlags,
  m as DiscordComponentEntry,
  n as buildDiscordInteractiveComponents,
  o as readDiscordComponentSpec,
  p as DiscordComponentButtonStyle,
  r as DiscordFormModal,
  s as resolveDiscordComponentAttachmentName,
  t as formatDiscordComponentEventText,
  u as DiscordComponentBlock,
  v as DiscordComponentSelectOption,
  w as DiscordModalSpec,
  x as DiscordModalEntry,
  y as DiscordComponentSelectSpec,
} from "../../components-B67qxcYt.js";
import { a as ComponentData } from "../../components.modal-CEbAQY65.js";
import {
  n as listDiscordDirectoryPeersFromConfig,
  t as listDiscordDirectoryGroupsFromConfig,
} from "../../directory-config-AQxLwG6y.js";
...
import { s as ChannelOutboundPayloadHint } from "../../outbound.types-Bu7WWq9f.js";
import {
  a as fetchPluralKitMessageInfo,
  i as PluralKitSystemInfo,
  n as PluralKitMemberInfo,
  r as PluralKitMessageInfo,
  t as DiscordPluralKitConfig,
} from "../../pluralkit-AgiFLDFT.js";
import {
...
import { i as resolveOpenProviderRuntimeGroupPolicy } from "../../runtime-group-policy-DMVwAExj.js";
import { t as collectDiscordSecurityAuditFindings } from "../../security-audit-IOTRnUYE.js";
import { n as DiscordSendComponents, r as DiscordSendEmbeds } from "../../send.shared-B9tglP0k.js";
import { v as DiscordSendResult } from "../../send.types-BuaFrE-z.js";
import { t as normalizeExplicitDiscordSessionKey } from "../../session-key-normalization-D-5WIPZD.js";
import {
  n as MessagingTargetKind,
  r as MessagingTargetParseOptions,
  t as MessagingTarget,
} from "../../targets-CYTLGChd.js";
import { f as ThreadBindingTargetKind } from "../../thread-bindings.manager-Ca-YZLZX.js";
import {
...
} from "../../timeouts-C1sAPUhP.js";
import { n as DiscordTokenResolution, t as DiscordCredentialStatus } from "../../token-jjArAZ6w.js";
import { C as OpenClawPluginApi } from "../../types-Ga3mNO_F.js";
import { f as AgentToolResult } from "../../types-JQFrjdua.js";
import { pt as DiscordExecApprovalConfig } from "../../types.channels-CYB_Xphv.js";
import {
...
declare function handleDiscordMessageAction$1(
  ctx: Pick<
...
type DiscordSubagentDeliveryTargetResult =
  ...
  | undefined;
declare function handleDiscordSubagentSpawning(
...
declare function handleDiscordSubagentDeliveryTarget(
...
declare function requestDiscord<T>(
  path: string,
  token: string,
  options?: DiscordApiRequestOptions,
): Promise<T>;
declare function fetchDiscord<T>(
  path: string,
  token: string,
  fetcher?: typeof fetch,
...
declare function resolveDiscordGroupToolPolicy(
 ...
 */
declare function normalizeDiscordOutboundTarget(
  to?: string,
...
declare function collectDiscordStatusIssues(
...
declare function parseDiscordTarget(
  raw: string,
...
declare const parseDiscordSendTarget: (
  raw: string,
  options?: DiscordTargetParseOptions,
 ...
 */
declare function resolveDiscordTarget(
  raw: string,
