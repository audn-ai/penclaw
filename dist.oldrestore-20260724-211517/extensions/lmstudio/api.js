import {
  A as LMSTUDIO_DEFAULT_MODEL_ID,
  C as resolveLmstudioServerBase,
  D as LMSTUDIO_DEFAULT_EMBEDDING_MODEL,
  E as LMSTUDIO_DEFAULT_BASE_URL,
  F as LMSTUDIO_PROVIDER_ID,
  I as LMSTUDIO_PROVIDER_LABEL,
  M as LMSTUDIO_DOCKER_HOST_INFERENCE_BASE_URL,
  N as LMSTUDIO_LOCAL_API_KEY_PLACEHOLDER,
  O as LMSTUDIO_DEFAULT_INFERENCE_BASE_URL,
  P as LMSTUDIO_MODEL_PLACEHOLDER,
  S as resolveLmstudioReasoningCompat,
  T as LMSTUDIO_DEFAULT_API_KEY_ENV_VAR,
  _ as normalizeLmstudioConfiguredCatalogEntries,
  a as resolveLmstudioConfiguredApiKey,
  b as resolveLmstudioInferenceBase,
  c as resolveLmstudioRequestContext,
  d as resolveLmstudioProviderAuthMode,
  f as shouldUseLmstudioApiKeyPlaceholder,
  g as mapLmstudioWireModelsToConfig,
  h as mapLmstudioWireEntry,
  i as buildLmstudioAuthHeaders,
  j as LMSTUDIO_DOCKER_HOST_BASE_URL,
  k as LMSTUDIO_DEFAULT_LOAD_CONTEXT_LENGTH,
  l as resolveLmstudioRuntimeApiKey,
  m as buildLmstudioModelName,
  r as fetchLmstudioModels,
  s as resolveLmstudioProviderHeaders,
  t as discoverLmstudioModels,
  u as hasLmstudioAuthorizationHeader,
  v as normalizeLmstudioConfiguredCatalogEntry,
  w as resolveLoadedContextWindow,
  x as resolveLmstudioReasoningCapability,
  y as normalizeLmstudioProviderConfig,
} from "../../models.fetch-BqO3XhrY.js";
...
import { a as removeProviderAuthProfilesWithLock } from "../../profiles-DxTOoenK.js";
...
import { n as buildApiKeyCredential } from "../../provider-auth-helpers-CLs4Yz61.js";
import { t as ensureApiKeyFromEnvOrPrompt } from "../../provider-auth-input-BukgsQa4.js";
import { h as withAgentModelAliases } from "../../provider-onboard-CvQgbxgZ.js";
import {
  n as configureOpenAICompatibleSelfHostedProviderNonInteractive,
  t as applyProviderDefaultModel,
} from "../../provider-self-hosted-setup-DgXzrv8Z.js";
