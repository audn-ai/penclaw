import { n as applyNvidiaConfig, t as NVIDIA_DEFAULT_MODEL_REF } from "../../onboard-BfJugsrD.js";
import {
  a as buildSelectableLiveNvidiaProvider,
  o as buildSelectableNvidiaProvider,
  r as buildLiveNvidiaProvider,
} from "../../provider-catalog-iyUb_LuV.js";
...
async function buildNvidiaCatalogModels(ctx) {
  return (
    hasNvidiaApiToken(ctx) ? await buildLiveNvidiaProvider() : buildSelectableNvidiaProvider()
  ).models.map((model) => ({
