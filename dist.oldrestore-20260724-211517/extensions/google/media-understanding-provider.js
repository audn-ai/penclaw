...
import { t as DEFAULT_GOOGLE_API_BASE_URL } from "../../google-api-base-url-B0vh8Owj.js";
...
import "../../runtime-api-BUs-aIaq.js";
...
async function generateGeminiInlineDataText(params) {
  ...
  try {
    ...
    const text = (
      (await readProviderJsonResponse(res, params.httpErrorLabel)).candidates?.[0]?.content
        ?.parts ?? []
    )
