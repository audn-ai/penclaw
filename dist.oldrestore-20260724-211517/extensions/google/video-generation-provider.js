...
} from "../../generation-provider-metadata-BgvAi7lA.js";
...
import { n as resolveGoogleGenerativeAiApiOrigin } from "../../provider-policy-7Kv8Y-Tx.js";
import {
        ...
        return {
          buffer: await readResponseWithLimit(response, params.maxBytes, {
            ...
            onIdleTimeout: ({ chunkTimeoutMs }) =>
              /* @__PURE__ */ new Error(
                `Google generated video download stalled after ${chunkTimeoutMs}ms`,
              ),
          }),
          mimeType:
        ...
        try {
          const buffer = await readResponseWithLimit(
            ...
            GOOGLE_VIDEO_OPERATION_RESPONSE_MAX_BYTES,
            {
              onOverflow: ({ maxBytes }) =>
                /* @__PURE__ */ new Error(
                  `Google video operation response exceeds ${maxBytes} bytes`,
                ),
            },
          );
