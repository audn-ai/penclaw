...
import { Zt as TalkEvent } from "../../diagnostic-events-CKz1uC46.js";
...
import { u as TtsConfigSchema } from "../../zod-schema.core-Czv0DE47.js";
...
declare const VoiceCallRealtimeConfigSchema: ZodDefault<
  ZodObject<
    {
...
declare const NormalizedEventSchema: ZodDiscriminatedUnion<
  [
    ZodObject<
      {
        id: ZodString;
...
declare class RealtimeCallHandler {
  ...
  constructor(
    ...
    servePath: string,
    coreConfig?: OpenClawConfig | undefined,
    resolveInstructions?: ((call: CallRecord) => string) | undefined,
  );
  setPublicUrl(url: string): void;
