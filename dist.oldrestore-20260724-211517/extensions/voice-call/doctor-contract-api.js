...
import {
  a as MAX_CALL_RECORD_EVENTS,
  d as parseVoiceCallRecordLine,
  i as CALL_RECORD_EVENT_META_MAX_ENTRIES,
  m as resolveVoiceCallLegacyCallLogPath,
  n as CALL_RECORD_EVENTS_NAMESPACE,
  o as RAW_CALL_RECORD_CHUNK_BYTES,
  p as prepareVoiceCallRecordForStorage,
  r as CALL_RECORD_EVENT_CHUNKS_NAMESPACE,
  s as buildVoiceCallLegacyJsonlEventKey,
  t as CALL_RECORD_CHUNK_MAX_ENTRIES,
...
const stateMigrations = [
  {
    ...
    async detectLegacyState(params) {
      const { entries } = await readLegacyCallRecords(
        resolveVoiceCallLegacyCallLogPath(resolveVoiceCallStorePath(params)),
      );
