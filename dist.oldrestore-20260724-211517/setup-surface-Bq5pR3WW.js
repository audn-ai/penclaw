...
import { n as updateMatrixAccountConfig } from "./config-update-C6P4f3lI.js";
import { n as ensureMatrixSdkInstalled, r as isMatrixSdkAvailable } from "./deps-C6pm28wx.js";
...
async function promptMatrixAllowFrom(params) {
  ...
  while (true) {
    ...
    if (pending.length > 0) {
      const { resolveMatrixTargets } = await import("./resolve-targets-DswS-j5a.js");
      ...
      if (accessConfig.entries.length > 0)
        try {
          ...
          for (const entry of accessConfig.entries) {
            ...
            const { listMatrixDirectoryGroupsLive } = await import("./directory-live-RMwh2H46.js");
