...
import {
  ...
  r as __exportAll,
  t as __commonJSMin,
} from "./rolldown-runtime-DE1ahGrs.js";
...
var init_getSmithyContext = __esmMin(() => {
  ...
  getSmithyContext = (context) =>
    context[import_dist_cjs$6.SMITHY_CONTEXT_KEY] ||
    (context[import_dist_cjs$6.SMITHY_CONTEXT_KEY] = {});
});
//#endregion
...
var init_poller = __esmMin(() => {
  ...
  runPolling = async (
    ...
    while (true) {
      if (currentAttempt > 0) {
        const delayMs = exponentialBackoffWithJitter(
          minDelayMs,
          maxDelayMs,
          currentAttempt,
          waitUntil,
  ...
  checkWarn403 = (observedResponses = {}, client) => {
    ...
    const warningLogger =
      typeof clientLogger?.warn === "function" &&
      !clientLogger.constructor?.name?.includes?.("NoOpLogger")
        ? clientLogger
        : console;
...
var init_schemaDeserializationMiddleware = __esmMin(() => {
  ...
  schemaDeserializationMiddleware = (config) => (next, context) => async (args) => {
    ...
    try {
      return {
        response,
        output: await config.protocol.deserializeResponse(
...
var init_ListSchema = __esmMin(() => {
  ...
  list = (namespace, name, traits, valueSchema) =>
...
var init_MapSchema = __esmMin(() => {
  ...
  map$1 = (namespace, name, traits, keySchema, valueSchema) =>
...
var init_OperationSchema = __esmMin(() => {
  ...
  op = (namespace, name, traits, input, output) =>
...
var init_StructureSchema = __esmMin(() => {
  ...
  struct = (namespace, name, traits, memberNames, memberList) =>
...
var init_ErrorSchema = __esmMin(() => {
  ...
  error = (namespace, name, traits, memberNames, memberList, ctor) =>
  ...
  NormalizedSchema = class NormalizedSchema {
    ...
    constructor(ref, memberName) {
      ...
      if (schema instanceof NormalizedSchema) {
        ...
        this.memberTraits = Object.assign(
          {},
          computedMemberTraits,
          schema.getMemberTraits(),
      ...
      if (this._isMemberSchema && !memberName)
        throw new Error(
          `@smithy/core/schema - NormalizedSchema member init ${this.getName(true)} missing member name.`,
        );
    }
    static [Symbol.hasInstance](lhs) {
      const isPrototype = this.prototype.isPrototypeOf(lhs);
    ...
    static of(ref) {
      ...
      if (isMemberSchema(sc)) {
        ...
        throw new Error(
          `@smithy/core/schema - may not init unwrapped member schema=${JSON.stringify(ref, null, 2)}.`,
        );
      }
    ...
    getEventStreamMember() {
      if (this.isStructSchema()) {
        for (const [memberName, memberSchema] of this.structIterator())
          if (memberSchema.isStreaming() && memberSchema.isStructSchema()) return memberName;
      }
      return "";
    }
    *structIterator() {
...
var init_SimpleSchema = __esmMin(() => {
  ...
  sim = (namespace, name, schemaRef, traits) =>
  ...
  simAdapter = (namespace, name, traits, schemaRef) =>
    Schema.assign(new SimpleSchema(), {
      name,
      namespace,
      traits,
      ...
      if (!this.schemas.has(id)) {
        if (!shapeId.includes("#")) {
          ...
          for (const [shapeId, schema] of this.schemas.entries())
            if (shapeId.endsWith(suffix)) candidates.push(schema);
...
function schemaLogFilter(schema, data) {
  ...
  if (ns.isListSchema()) {
    ...
    if (
      !!ns.getKeySchema().getMergedTraits().sensitive ||
      !!ns.getValueSchema().getMergedTraits().sensitive
    )
    ...
    for (const [member, memberNs] of ns.structIterator())
      if (object[member] != null) newObject[member] = schemaLogFilter(memberNs, object[member]);
    return newObject;
  }
  return data;
}
  ...
  Command = class {
    ...
    resolveMiddlewareWithContext(
      ...
      return stack.resolve(
        (request) => requestHandler.handle(request.request, requestOptions),
        ...
        resolveMiddleware(stack, configuration, options) {
          ...
          return this.resolveMiddlewareWithContext(stack, configuration, options, {
            ...
            inputFilterSensitiveLog:
              ...
              (op ? schemaLogFilter.bind(null, input) : (_) => _),
            outputFilterSensitiveLog:
              closure._outputFilterSensitiveLog ??
              (op ? schemaLogFilter.bind(null, output) : (_) => _),
      ...
      if (Client.prototype[waiterName] === void 0)
        Client.prototype[waiterName] = async function (
          ...
          if (typeof waiterConfiguration === "number")
            config = { maxWaitTime: waiterConfiguration };
          return waiterFn(
            {
              ...config,
              client: this,
...
var init_default_error_handler = __esmMin(() => {
  ...
  throwDefaultError = ({ output, parsedBody, exceptionCtor, errorCode }) => {
    ...
    throw decorateServiceException(
      new exceptionCtor({
...
var init_object_mapping = __esmMin(() => {
  ...
  applyInstruction = (target, source, instructions, targetKey) => {
    if (source !== null) {
      ...
      if (
        (typeof filter === "function" && filter(source[sourceKey])) ||
...
var init_parse_utils = __esmMin(() => {
  ...
  expectObject = (value) => {
    ...
    throw new TypeError(
      `Expected object, got ${Array.isArray(value) ? "array" : typeof value}: ${value}`,
    );
  };
  expectString = (value) => {
    if (value === null || value === void 0) return;
...
var init_date_utils = __esmMin(() => {
  ...
  RFC3339_WITH_OFFSET$1 = /* @__PURE__ */ new RegExp(
  ...
  IMF_FIXDATE$1 = /* @__PURE__ */ new RegExp(
    /^(?:Mon|Tue|Wed|Thu|Fri|Sat|Sun), (\d{2}) (Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec) (\d{4}) (\d{1,2}):(\d{2}):(\d{2})(?:\.(\d+))? GMT$/,
  );
  RFC_850_DATE$1 = /* @__PURE__ */ new RegExp(
    /^(?:Monday|Tuesday|Wednesday|Thursday|Friday|Saturday|Sunday), (\d{2})-(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)-(\d{2}) (\d{1,2}):(\d{2}):(\d{2})(?:\.(\d+))? GMT$/,
  );
  ASC_TIME$1 = /* @__PURE__ */ new RegExp(
...
var init_schema_date_utils = __esmMin(() => {
  ...
  date = `(\\d?\\d)`;
  year = `(\\d{4})`;
  RFC3339_WITH_OFFSET = /* @__PURE__ */ new RegExp(
  ...
  _parseRfc3339DateTimeWithOffset = (value) => {
    ...
    const date = new Date(
      Date.UTC(
        ...
        Number(minutes),
        Number(seconds),
        Number(ms) ? Math.round(parseFloat(`0.${ms}`) * 1e3) : 0,
      ),
    );
    ...
    if (offsetStr.toUpperCase() != "Z") {
      ...
      date.setTime(
        date.getTime() + scalar * (Number(offsetH) * 60 * 60 * 1e3 + Number(offsetM) * 60 * 1e3),
      );
    }
    return date;
  };
  _parseRfc7231DateTime = (value) => {
    ...
    if (year && second) {
      const timestamp = Date.UTC(
        ...
        Number(minute),
        Number(second),
        fraction ? Math.round(parseFloat(`0.${fraction}`) * 1e3) : 0,
      );
      range(day, 1, 31);
      range(hour, 0, 23);
      range(minute, 0, 59);
    ...
    getConfigData = (data) =>
      Object.entries(data)
        .filter(([key]) => {
          ...
          return Object.values(import_dist_cjs$3.IniSectionType).includes(
        ...
        .reduce(
          (acc, [key, value]) => {
            const indexOfSeparator = key.indexOf(".");
            const updatedKey =
              key.substring(0, indexOfSeparator) === import_dist_cjs$3.IniSectionType.PROFILE
    ...
    for (const iniLine of iniData.split(/\r?\n/)) {
      ...
      if (trimmedLine[0] === "[" && trimmedLine[trimmedLine.length - 1] === "]") {
        ...
        if (matches) {
          ...
          if (Object.values(import_dist_cjs$2.IniSectionType).includes(prefix))
...
var init_loadSharedConfigFiles = __esmMin(() => {
  ...
  loadSharedConfigFiles = async (init = {}) => {
    ...
    const parsedFiles = await Promise.all([
      readFile$1(resolvedConfigFilepath, { ignoreCache: init.ignoreCache })
        .then(parseIni)
        .then(getConfigData)
        .catch(swallowError$1),
      readFile$1(resolvedFilepath, { ignoreCache: init.ignoreCache })
        .then(parseIni)
        .catch(swallowError$1),
    ]);
    return {
...
var init_getSsoSessionData = __esmMin(() => {
  ...
  getSsoSessionData = (data) =>
    Object.entries(data)
      .filter(([key]) => key.startsWith(import_dist_cjs$1.IniSectionType.SSO_SESSION + "."))
      .reduce(
        (acc, [key, value]) => ({
          ...acc,
...
var init_loadSsoSessionData = __esmMin(() => {
  ...
  loadSsoSessionData = async (init = {}) =>
    readFile$1(init.configFilepath ?? getConfigFilepath())
      .then(parseIni)
...
var init_NodeUseDualstackEndpointConfigOptions = __esmMin(() => {
  ...
  NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS = {
    ...
    configFileSelector: (profile) =>
      booleanSelector(profile, CONFIG_USE_DUALSTACK_ENDPOINT, SelectorType.CONFIG),
    default: false,
  };
  nodeDualstackConfigSelectors = {
    environmentVariableSelector: (env) =>
...
var init_NodeUseFipsEndpointConfigOptions = __esmMin(() => {
  ...
  NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS = {
    ...
    configFileSelector: (profile) =>
      booleanSelector(profile, CONFIG_USE_FIPS_ENDPOINT, SelectorType.CONFIG),
    default: false,
  };
  nodeFipsConfigSelectors = {
    environmentVariableSelector: (env) =>
...
var init_getEndpointFromRegion = __esmMin(() => {
  getEndpointFromRegion = async (input) => {
    ...
    if (
      !/* @__PURE__ */ new RegExp(/^([a-zA-Z0-9]|[a-zA-Z0-9][a-zA-Z0-9-]{0,61}[a-zA-Z0-9])$/).test(
        region,
      )
    )
    ...
    try {
      ...
      return (
        (
          ...
          .toString()
          .trim() || cacheNegativeAndReturnUndefined()
      );
    } catch {
    ...
    return new Promise((resolve, reject) => {
      ...
      req.on("response", (res) => {
        ...
        if (statusCode < 200 || statusCode >= 300) {
          reject(
            Object.assign(
              /* @__PURE__ */ new Error("Error response received from instance metadata service"),
              { statusCode },
            ),
          );
          req.destroy();
...
var init_getHostnameFromVariants = __esmMin(() => {
  getHostnameFromVariants = (variants = [], { useFipsEndpoint, useDualstackEndpoint }) =>
    variants.find(
      ({ tags }) =>
...
var init_getResolvedHostname = __esmMin(() => {
  getResolvedHostname = (resolvedRegion, { regionHostname, partitionHostname }) =>
    regionHostname
      ? regionHostname
      : partitionHostname
...
var init_getResolvedPartition = __esmMin(() => {
  getResolvedPartition = (region, { partitionHash }) =>
    Object.keys(partitionHash || {}).find((key) => partitionHash[key].regions.includes(region)) ??
    "aws";
});
//#endregion
...
var init_getRegionInfo = __esmMin(() => {
  ...
  getRegionInfo = (
    ...
    const resolvedRegion =
      region in regionHash ? region : (partitionHash[partition]?.endpoint ?? region);
    const hostnameOptions = {
      useFipsEndpoint,
      useDualstackEndpoint,
    };
    const hostname = getResolvedHostname(resolvedRegion, {
      regionHostname: getHostnameFromVariants(
        regionHash[resolvedRegion]?.variants,
        hostnameOptions,
      ),
      partitionHostname: getHostnameFromVariants(
        partitionHash[partition]?.variants,
        hostnameOptions,
      ),
    });
  ...
  createConfigValueProvider = (
    ...
    const configProvider = async () => {
      ...
      if (isClientContextParam)
        configValue =
          config.clientContextParams?.[configKey] ??
          config[configKey] ??
    ...
    while (currentIndex < template.length) {
      ...
      if (parameterName.includes("#")) {
        ...
        evaluatedTemplateArr.push(
          getAttr(referenceRecord[refName] ?? endpointParams[refName], attrName),
        );
      } else
  ...
  callFunction = ({ fn, argv }, options) => {
    ...
    if (namespaceSeparatorIndex !== -1) {
      const customFunction =
        customEndpointFunctions[fn.slice(0, namespaceSeparatorIndex)]?.[
          fn.slice(namespaceSeparatorIndex + 1)
        ];
...
var init_evaluateCondition = __esmMin(() => {
  ...
  evaluateCondition = (condition, options) => {
    ...
    options.logger?.debug?.(
      `${debugId} evaluateCondition: ${toDebugString(condition)} = ${toDebugString(value)}`,
    );
...
var init_getEndpointHeaders = __esmMin(() => {
  init_types();
  init_evaluateExpression();
  getEndpointHeaders = (headers, options) =>
...
var init_getEndpointProperties = __esmMin(() => {
  init_types();
  init_evaluateTemplate();
  getEndpointProperties = (properties, options) =>
...
var init_stream_type_check = __esmMin(() => {
  ...
  isBlob = (blob) => {
    return (
      typeof Blob === "function" && (blob?.constructor?.name === Blob.name || blob instanceof Blob)
    );
  };
});
//#endregion
...
var init_serde = __esmMin(() => {
  ...
  init_stream_type_check();
  init_stream_collector();
  Uint8ArrayBlobAdapter = class extends (
    bindUint8ArrayBlobAdapter(toUtf8$1, fromUtf8$1, toBase64$1, fromBase64)
  ) {};
...
var init_fileStreamHasher = __esmMin(() => {
  init_HashCalculator();
  fileStreamHasher = (hashCtor, fileStream) =>
...
var init_Md5Js = __esmMin(() => {
  ...
  INIT$1 = [1732584193, 4023233417, 2562383102, 271733878];
  M = 4294967295;
...
var init_Sha256WebCrypto = __esmMin(() => {
  ...
  subtle =
    typeof digest === "function" && typeof sign$1 === "function" && typeof importKey === "function"
...
var init_EventStreamSerdeConfig = __esmMin(() => {
  resolveEventStreamSerdeConfig = (input) =>
    Object.assign(input, { eventStreamMarshaller: input.eventStreamSerdeProvider(input) });
});
//#endregion
...
//#endregion
export {
  init_createChecksumStream as $,
  translateTraits as $n,
  init_split_every as $t,
  init_EventStreamCodec as A,
  getValueFromTextNode as An,
  init_config$1 as At,
  init_Sha256Js as B,
  decorateServiceException as Bn,
  init_booleanSelector as Bt,
  SmithyMessageDecoderStream as C,
  isArrayBuffer as Cn,
  require_dist_cjs as Cr,
  resolveDefaultsModeConfig as Ct,
  MessageDecoderStream as D,
  makeBuilder as Dn,
  NODE_REGION_CONFIG_OPTIONS as Dt,
  init_MessageEncoderStream as E,
  init_client_command_builder as En,
  NODE_REGION_CONFIG_FILE_OPTIONS as Et,
  checksum_exports as F,
  emitWarningIfUnsupportedVersion as Fn,
  init_configLoader as Ft,
  init_serde as G,
  init_command as Gn,
  init_toUint8Array as Gt,
  init_Crc32Node as H,
  createAggregatedClient as Hn,
  init_ProviderError as Ht,
  init_checksum as I,
  init_emitWarningIfUnsupportedVersion as In,
  loadConfig as It,
  init_sdk_stream_mixin as J,
  TypeRegistry as Jn,
  init_calculateBodyLength as Jt,
  serde_exports as K,
  init_schema as Kn,
  toUint8Array as Kt,
  Sha256Node as L,
  init_defaults_mode as Ln,
  SelectorType as Lt,
  init_HeaderMarshaller as M,
  getDefaultExtensionConfiguration as Mn,
  init_NodeUseFipsEndpointConfigOptions as Mt,
  Int64 as N,
  init_defaultExtensionConfiguration as Nn,
  NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS as Nt,
  init_MessageDecoderStream as O,
  NoOpLogger as On,
  REGION_ENV_NAME as Ot,
  init_Int64 as P,
  resolveDefaultRuntimeConfig as Pn,
  init_NodeUseDualstackEndpointConfigOptions as Pt,
  createChecksumStream as Q,
  init_translateTraits as Qn,
  splitHeader as Qt,
  init_Sha256Node as R,
  loadConfigsForDefaultMode as Rn,
  init_types$1 as Rt,
  init_SmithyMessageEncoderStream as S,
  init_is_array_buffer as Sn,
  init_getSmithyContext as Sr,
  init_resolveDefaultsModeConfig as St,
  MessageEncoderStream as T,
  init_client as Tn,
  resolveRegionConfig as Tt,
  Uint8ArrayBlobAdapter as U,
  init_create_aggregated_client as Un,
  concatBytes as Ut,
  Crc32Node as V,
  init_exceptions as Vn,
  ProviderError as Vt,
  generateIdempotencyToken as W,
  Command as Wn,
  init_concatBytes as Wt,
  createBufferedReadable as X,
  NormalizedSchema as Xn,
  init_NumericValue as Xt,
  sdkStreamMixin as Y,
  init_TypeRegistry as Yn,
  NumericValue as Yt,
  init_createBufferedReadable as Z,
  init_NormalizedSchema as Zn,
  init_split_header as Zt,
  getUnmarshalledStream as _,
  toBase64$1 as _n,
  HttpResponse as _r,
  init_BinaryDecisionDiagram as _t,
  init_EventStreamSerdeConfig as a,
  init_quote_header as an,
  init_client$1 as ar,
  resolveEndpoint as at,
  init_getChunkedStream as b,
  fromBase64 as bn,
  init_httpRequest as br,
  config_exports as bt,
  iterableToReadableStream as c,
  init_lazy_json as cn,
  parseUrl as cr,
  init_isIpAddress as ct,
  eventStreamSerdeProvider as d,
  parseEpochTimestamp as dn,
  init_normalizeProvider as dr,
  init_customEndpointFunctions as dt,
  splitEvery as en,
  getSchemaSerdePlugin as er,
  endpoints_exports as et,
  init_EventStreamMarshaller as f,
  parseRfc3339DateTimeWithOffset as fn,
  normalizeProvider as fr,
  EndpointError as ft,
  getMessageUnmarshaller as g,
  init_toBase64 as gn,
  isValidHostLabel as gr,
  BinaryDecisionDiagram as gt,
  init_EventStreamMarshaller$1 as h,
  toUtf8$1 as hn,
  init_isValidHostLabel as hr,
  init_EndpointCache as ht,
  init_EventStreamSerde as i,
  init_schema_date_utils as in,
  Client as ir,
  init_resolveEndpoint as it,
  HeaderMarshaller as j,
  init_get_value_from_text_node as jn,
  NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS as jt,
  EventStreamCodec as k,
  init_NoOpLogger as kn,
  REGION_INI_NAME as kt,
  readableStreamToIterable as l,
  dateToUtcString as ln,
  init_parseQueryString as lr,
  isIpAddress as lt,
  eventStreamSerdeProvider$1 as m,
  init_toUtf8 as mn,
  isValidHostname as mr,
  EndpointCache as mt,
  init_event_streams as n,
  _parseRfc3339DateTimeWithOffset as nn,
  deref as nr,
  init_endpoints as nt,
  resolveEventStreamSerdeConfig as o,
  quoteHeader as on,
  init_transport as or,
  decideEndpoint as ot,
  EventStreamMarshaller$1 as p,
  parseRfc7231DateTime as pn,
  init_isValidHostname as pr,
  init_EndpointError as pt,
  v4 as q,
  schema_exports as qn,
  calculateBodyLength as qt,
  EventStreamSerde as r,
  _parseRfc7231DateTime as rn,
  init_deref as rr,
  resolveEndpointConfig as rt,
  init_utils as s,
  LazyJsonString as sn,
  init_parseUrl as sr,
  init_decideEndpoint as st,
  event_streams_exports as t,
  _parseEpochTimestamp as tn,
  init_getSchemaSerdePlugin as tr,
  getEndpointPlugin as tt,
  EventStreamMarshaller as u,
  init_date_utils as un,
  parseQueryString as ur,
  customEndpointFunctions as ut,
  init_getUnmarshalledStream as v,
  fromUtf8$1 as vn,
  init_httpResponse as vr,
  init_getEndpointFromInstructions as vt,
  init_SmithyMessageDecoderStream as w,
  client_exports as wn,
  init_resolveRegionConfig as wt,
  SmithyMessageEncoderStream as x,
  init_fromBase64 as xn,
  getSmithyContext as xr,
  init_config as xt,
  getChunkedStream as y,
  init_fromUtf8 as yn,
  HttpRequest as yr,
  resolveParams as yt,
  Sha256Js as z,
  ServiceException as zn,
  booleanSelector as zt,
};
