...
declare function resolveLmstudioReasoningCompat(
 ...
 */
declare function resolveLmstudioReasoningCapability(
  entry: Pick<LmstudioModelWire, "capabilities">,
): boolean;
/**
 ...
 */
declare function resolveLoadedContextWindow(
...
declare function normalizeLmstudioProviderConfig(
  provider: ModelProviderDeclarationConfig,
): ModelProviderDeclarationConfig;
declare function normalizeLmstudioConfiguredCatalogEntry(
  entry: unknown,
): LmstudioConfiguredCatalogEntry | null;
declare function normalizeLmstudioConfiguredCatalogEntries(
  models: unknown,
 ...
 */
declare function mapLmstudioWireModelsToConfig(
...
declare function buildLmstudioAuthHeaders(
...
//#endregion
export {
  LMSTUDIO_PROVIDER_LABEL as A,
  LMSTUDIO_DEFAULT_LOAD_CONTEXT_LENGTH as C,
  LMSTUDIO_LOCAL_API_KEY_PLACEHOLDER as D,
  LMSTUDIO_DOCKER_HOST_INFERENCE_BASE_URL as E,
  LMSTUDIO_MODEL_PLACEHOLDER as O,
  LMSTUDIO_DEFAULT_INFERENCE_BASE_URL as S,
  LMSTUDIO_DOCKER_HOST_BASE_URL as T,
  resolveLmstudioServerBase as _,
  resolveLmstudioRuntimeApiKey as a,
  LMSTUDIO_DEFAULT_BASE_URL as b,
  buildLmstudioModelName as c,
  normalizeLmstudioConfiguredCatalogEntries as d,
  normalizeLmstudioConfiguredCatalogEntry as f,
  resolveLmstudioReasoningCompat as g,
  resolveLmstudioReasoningCapability as h,
  resolveLmstudioRequestContext as i,
  LMSTUDIO_PROVIDER_ID as k,
  mapLmstudioWireEntry as l,
  resolveLmstudioInferenceBase as m,
  resolveLmstudioConfiguredApiKey as n,
  LmstudioModelBase as o,
  normalizeLmstudioProviderConfig as p,
  resolveLmstudioProviderHeaders as r,
  LmstudioModelWire as s,
  buildLmstudioAuthHeaders as t,
  mapLmstudioWireModelsToConfig as u,
  resolveLoadedContextWindow as v,
  LMSTUDIO_DEFAULT_MODEL_ID as w,
  LMSTUDIO_DEFAULT_EMBEDDING_MODEL as x,
  LMSTUDIO_DEFAULT_API_KEY_ENV_VAR as y,
};
