...
declare function readRegularFile(params: { filePath: string; maxBytes?: number }): Promise<{
  buffer: Buffer;
  stat: Stats;
}>;
declare function readRegularFileSync(params: { filePath: string; maxBytes?: number }): {
  buffer: Buffer;
  stat: Stats;
};
