 ...
 */
declare function resolveGeminiOutputDimensionality(
  model: string,
  requested?: number,
): number | undefined;
...
//#endregion
export {
  buildGeminiEmbeddingRequest as a,
  isGeminiEmbedding2Model as c,
  GeminiTextEmbeddingRequest as i,
  normalizeGeminiModel as l,
  GEMINI_EMBEDDING_2_MODELS as n,
  buildGeminiTextEmbeddingRequest as o,
  GeminiEmbeddingClient as r,
  createGeminiEmbeddingProvider as s,
  DEFAULT_GEMINI_EMBEDDING_MODEL as t,
  resolveGeminiOutputDimensionality as u,
};
