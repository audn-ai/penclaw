...
import { n as resolveDoctorCrossStateDirImports } from "./doctor-invocation-C25PAPM1.js";
...
function registerMaintenanceCommands(program) {
    ...
    .action(async (opts, command) => {
      ...
      if (opts.lint === true) {
        await runCommandWithRuntime(
          defaultRuntime,
          async () => {
            const { runDoctorLintCli } = await import("./doctor-lint-DlH9Ds2i.js");
      ...
      await runCommandWithRuntime(defaultRuntime, async () => {
        const { doctorCommand } = await import("./doctor-RCwy0WEl.js");
  ...
  program
    ...
    .action(async (opts) => {
      await runCommandWithRuntime(defaultRuntime, async () => {
        const { dashboardCommand } = await import("./dashboard-BzAdD67a.js");
  ...
  program
    ...
    .action(async (opts) => {
      await runCommandWithRuntime(defaultRuntime, async () => {
        const { resetCommand } = await import("./reset-DGKsybNh.js");
  ...
  program
    ...
    .action(async (opts) => {
      await runCommandWithRuntime(defaultRuntime, async () => {
        const { uninstallCommand } = await import("./uninstall-DfKT-B58.js");
