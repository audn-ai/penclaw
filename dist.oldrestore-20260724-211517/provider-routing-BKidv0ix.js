...
const BLOCKED_RECORD_KEYS = /* @__PURE__ */ new Set(["__proto__", "prototype", "constructor"]);
function sanitizeJsonLikeValue(value) {
  if (value === void 0) return;
  if (Array.isArray(value))
    return value.map(sanitizeJsonLikeValue).filter((entry) => entry !== void 0);
...
function sanitizeRecord(value) {
  return Object.fromEntries(
    Object.entries(value)
      .filter(([key, entry]) => !BLOCKED_RECORD_KEYS.has(key) && entry !== void 0)
