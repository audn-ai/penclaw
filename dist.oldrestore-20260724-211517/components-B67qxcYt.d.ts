import {
  n as Modal,
  o as ComponentParserResult,
  r as TextDisplay,
  t as Label,
} from "./components.modal-CEbAQY65.js";
import { n as InteractiveReply } from "./payload-DYmvszuK.js";
...
declare function buildDiscordComponentMessageFlags(
  components: TopLevelComponents[],
): number | undefined;
//#endregion
 ...
 */
declare function buildDiscordInteractiveComponents(
...
//#endregion
export {
  parseDiscordComponentCustomIdForInteraction as A,
  DiscordModalFieldSpec as C,
  buildDiscordComponentCustomId as D,
  DISCORD_MODAL_CUSTOM_ID_KEY as E,
  parseDiscordModalCustomIdForInteraction as M,
  buildDiscordModalCustomId as O,
  DiscordModalFieldDefinition as S,
  DISCORD_COMPONENT_CUSTOM_ID_KEY as T,
  DiscordComponentSectionAccessory as _,
  DISCORD_COMPONENT_ATTACHMENT_PREFIX as a,
  DiscordComponentSelectType as b,
  buildDiscordComponentMessage as c,
  DiscordComponentBuildResult as d,
  DiscordComponentButtonSpec as f,
  DiscordComponentModalFieldType as g,
  DiscordComponentMessageSpec as h,
  createDiscordFormModal as i,
  parseDiscordModalCustomId as j,
  parseDiscordComponentCustomId as k,
  buildDiscordComponentMessageFlags as l,
  DiscordComponentEntry as m,
  buildDiscordInteractiveComponents as n,
  readDiscordComponentSpec as o,
  DiscordComponentButtonStyle as p,
  DiscordFormModal as r,
  resolveDiscordComponentAttachmentName as s,
  formatDiscordComponentEventText as t,
  DiscordComponentBlock as u,
  DiscordComponentSelectOption as v,
  DiscordModalSpec as w,
  DiscordModalEntry as x,
  DiscordComponentSelectSpec as y,
};
