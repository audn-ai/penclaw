...
function isGeneratedPluginModelCatalog(value) {
  return (
    ...
    value !== null &&
    !Array.isArray(value) &&
    value.generatedBy === "openclaw-plugin-model-catalog-v1"
  );
}
...
function filterGeneratedPluginModelCatalogProviders(params) {
  if (
    ...
    (params.parsedCatalog !== void 0 && !isGeneratedPluginModelCatalog(params.parsedCatalog))
  )
    return {};
...
//#endregion
export {
  isGeneratedPluginModelCatalog as a,
  listPluginModelCatalogRelativePaths as c,
  filterGeneratedPluginModelCatalogProviders as i,
  resolvePluginModelCatalogOwnerPluginId as l,
  decodePluginModelCatalogRelativePathPluginId as n,
  isPluginModelCatalogRelativePath as o,
  encodePluginModelCatalogRelativePath as r,
  listPluginModelCatalogFiles as s,
  PLUGIN_MODEL_CATALOG_GENERATED_BY as t,
};
