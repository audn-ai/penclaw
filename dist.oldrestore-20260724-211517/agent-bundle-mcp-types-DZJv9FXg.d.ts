...
type SessionMcpRuntimeManager = {
  ...
  resolveSessionId: (
    ...
    | string
    | undefined /** Looks up an existing runtime only; must not create runtimes or connect transports. */;
  peekSession: (params: {
    sessionId?: string;
    sessionKey?: string;
...
//#endregion
export {
  SessionMcpRuntimeManager as a,
  SessionMcpRuntime as i,
  McpCatalogTool as n,
  McpToolCatalog as r,
  BundleMcpToolRuntime as t,
};
