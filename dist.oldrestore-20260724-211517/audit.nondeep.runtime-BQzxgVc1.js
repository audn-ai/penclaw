...
import { n as resolveConfiguredToolPolicies } from "./agent-tools.policy-BQgyHzcD.js";
...
import {
  ...
  s as listInstalledPluginDirs,
  t as collectIncludeFilePermFindings,
} from "./audit-extra.async-CxcjBcx7.js";
import { n as resolveGatewayAuth } from "./auth-resolve-PY0Y7GYi.js";
import { t as formatCliCommand } from "./command-format-H_Arqann.js";
import { r as resolveNativeSkillsEnabled } from "./commands-6pnBRTEm.js";
...
import { n as GATEWAY_CONTROL_PLANE_TOOLS } from "./dangerous-tools-EO69Px8j.js";
...
import {
  ...
  s as listDangerousPluginNodeCommands,
  t as DEFAULT_DANGEROUS_NODE_COMMANDS,
} from "./node-command-policy-pdhFRd-t.js";
import { i as readInstalledPackageVersion } from "./package-update-utils-T2vDkLHN.js";
...
import { t as getBlockedBindReason } from "./validate-sandbox-security-Cdz9Nkl5.js";
...
function listOpenInboundPolicies(cfg) {
  ...
  const inspectSection = (section, basePath) => {
    ...
    if ((section.dmPolicy ?? legacyDmPolicy) === "open")
...
function collectHooksHardeningFindings(cfg, env = process.env, options = {}) {
  ...
  const reusedGatewayAuth = findHooksTokenGatewayAuthReuse({
    ...
    overrideGatewayAuth: options.gatewayAuthOverride
      ? resolveGatewayAuth({
          authConfig: cfg.gateway?.auth,
...
const loadPluginTrustPolicyDeps = createLazyPromise(
  () =>
    Promise.all([
      import("./config-U4wJXcqc.js"),
      import("./tool-policy-DAE0nl0H.js"),
      import("./tool-policy-match-CLvNlcPN.js"),
      import("./tool-policy-BeCEdw0r.js"),
