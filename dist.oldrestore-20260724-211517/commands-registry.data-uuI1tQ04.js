import {
  d as resolveFastModeModelAutoOnSeconds,
  t as formatFastModeAutoLabel,
} from "./fast-mode-BhVbWk_p.js";
import { i as listLoadedChannelPlugins } from "./registry-loaded-D8eZo-vR.js";
...
import { a as listThinkingLevels } from "./thinking-CVcRbjTC.js";
...
function buildBuiltinChatCommands(params = {}) {
  ...
  const listThinkingLevelChoices = (provider, model, catalog, agentRuntime) => {
    return [
      "default",
      ...configuredThinkingLevels(provider, model, catalog, agentRuntime).filter(
        (level) => level !== "default",
      ),
    ];
  };
