import {
  D as ThinkingLevelMap,
  h as OpenAIResponsesCompat,
  m as OpenAICompletionsCompat,
...
declare const MODEL_THINKING_FORMATS: readonly [
  "openai",
  "openrouter",
  "deepseek",
  "together",
...
type ModelCompatConfig = SupportedOpenAICompatFields &
...
type ModelsConfig = {
  /** Merge provider config with bundled catalogs or replace bundled catalogs entirely. */ mode?:
    | "merge"
    | "replace" /** Configured provider catalog keyed by provider id. */;
...
//#endregion
export {
  ModelsConfigInput as _,
  ModelApi as a,
  ModelImageInputConfig as c,
  ModelProviderAuthMode as d,
  ModelProviderConfig as f,
  ModelsConfig as g,
  ModelProviderLocalServiceConfig as h,
  MODEL_THINKING_FORMATS as i,
  ModelMediaInputConfig as l,
  ModelProviderDeclarationConfig as m,
  DiscoveryToggleConfig as n,
  ModelCompatConfig as o,
  ModelProviderConfigInput as p,
  MODEL_APIS as r,
  ModelDefinitionConfig as s,
  BedrockDiscoveryConfig as t,
  ModelPricingConfig as u,
  SupportedThinkingFormat as v,
  isModelThinkingFormat as y,
};
