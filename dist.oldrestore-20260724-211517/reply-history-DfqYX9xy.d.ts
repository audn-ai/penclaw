...
type ChannelHistoryWindow<T extends HistoryEntry = HistoryEntry> = {
  ...
  recordWithMedia: (params: {
    ...
    media?:
      ...
      | null
      | (() => MaybePromise$1<readonly HistoryMediaEntry[] | null | undefined>);
    mediaLimit?: number;
    messageId?: string;
...
//#endregion
export {
  createChannelHistoryWindow as _,
  buildHistoryContextFromMap as a,
  buildPendingHistoryContextFromMap as c,
  evictOldHistoryKeys as d,
  normalizeHistoryMediaEntries as f,
  ChannelHistoryWindow as g,
  recordPendingHistoryEntryWithMedia as h,
  buildHistoryContextFromEntries as i,
  clearHistoryEntries as l,
  recordPendingHistoryEntryIfEnabled as m,
  HISTORY_CONTEXT_MARKER as n,
  buildInboundHistoryFromEntries as o,
  recordPendingHistoryEntry as p,
  buildHistoryContext as r,
  buildInboundHistoryFromMap as s,
  DEFAULT_GROUP_HISTORY_LIMIT as t,
  clearHistoryEntriesIfEnabled as u,
};
