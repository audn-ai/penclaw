...
import { r as buildMatrixReactionContent } from "./reaction-common-DQN9ie7R.js";
...
const loadMatrixSendClientRuntime = createLazyRuntimeModule(
  () => import("./client-bootstrap-ByfEeLAd.js"),
);
...
const MATRIX_MENTION_USER_ID_PATTERN = new RegExp(
  `^@[A-Za-z0-9._=+\\-/]+:(?:${/(?:[A-Za-z0-9](?:[A-Za-z0-9-]*[A-Za-z0-9])?)(?:\.(?:[A-Za-z0-9](?:[A-Za-z0-9-]*[A-Za-z0-9])?))*(?::\d+)?/.source}|\\[[0-9A-Fa-f:.]+\\](?::\\d+)?)$`,
);
  ...
  return await withResolvedMatrixSendClient(
    ...
    async (client) => {
      ...
      const content = withMatrixExtraContentFields(
        buildTextContent(convertedText, relation, { msgtype: opts.msgtype }),
        opts.extraContent,
      );
      await enrichMatrixFormattedContent({
        client,
...
//#endregion
export {
  isPollStartType as _,
  sendMessageMatrix as a,
  resolvePollReferenceEventId as b,
  sendSingleTextMessageMatrix as c,
  resolveMatrixMentionsForBody as d,
  buildPollResponseContent as f,
  isPollEventType as g,
  formatPollResultsAsText as h,
  reactMatrixMessage as i,
  sendTypingMatrix as l,
  formatPollAsText as m,
  editMessageMatrix as n,
  sendPollMatrix as o,
  buildPollResultsSummary as p,
  prepareMatrixSingleText as r,
  sendReadReceiptMatrix as s,
  chunkMatrixText as t,
  resolveMatrixRoomId as u,
  parsePollStart as v,
  parsePollStartContent as y,
};
