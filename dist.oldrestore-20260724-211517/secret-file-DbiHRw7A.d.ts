...
declare function readSecretFileSync(
  filePath: string,
  label: string,
  options?: SecretFileReadOptions,
): string;
declare function tryReadSecretFileSync(
...
declare function loadSecretFileSync(
  filePath: string,
  label: string,
...
//#endregion
export {
  PRIVATE_SECRET_FILE_MODE as a,
  tryReadSecretFileSync as c,
  PRIVATE_SECRET_DIR_MODE as i,
  writeSecretFileAtomic as l,
  loadSecretFileSync as n,
  SecretFileReadOptions as o,
  DEFAULT_SECRET_FILE_MAX_BYTES as r,
  readSecretFileSync as s,
  SecretFileReadResult as t,
};
