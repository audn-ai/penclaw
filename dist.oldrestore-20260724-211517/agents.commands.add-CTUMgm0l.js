...
} from "./agents.bindings-DKqOOMOo.js";
import {
  r as requireValidConfigFileSnapshot,
  t as createQuietRuntime,
} from "./agents.command-shared-DvQ8DcU3.js";
import { r as findAgentEntryIndex, t as applyAgentConfig } from "./agents.config-ClyzacE8.js";
import { i as applyAuthChoice, r as warnIfModelConfigLooksOff } from "./auth-choice-CvpCVHJc.js";
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-BaQnBKNE.js";
import { t as buildPortableAuthProfileStoreForAgentCopy } from "./auth-profiles-CX7JDmZ9.js";
import { t as createClackPrompter } from "./clack-prompter-Cu4E8Cn1.js";
import { t as formatCliCommand } from "./command-format-H_Arqann.js";
import { c as resolveUserPath } from "./home-dir-DxrrpDft.js";
import {
  o as transformConfigWithPendingPluginInstalls,
  t as commitConfigWithPendingPluginInstalls,
...
import { r as ensureWorkspaceAndSessions } from "./onboard-helpers-CUS3BGDx.js";
...
import { g as saveAuthProfileStore, i as ensureAuthProfileStore } from "./store-B7DoDdVM.js";
import {
...
async function agentsAddCommand(opts, runtime = defaultRuntime, params) {
  ...
  if (nonInteractive) {
    ...
    let committed;
    try {
      committed = await transformConfigWithPendingPluginInstalls({
    ...
    await ensureWorkspaceAndSessions(
      ...
      opts.json ? createQuietRuntime(runtime) : runtime,
      {
        ...
        skipOptionalBootstrapFiles:
          committed.nextConfig.agents?.defaults?.skipOptionalBootstrapFiles,
        agentId,
      },
    );
    const payload = {
