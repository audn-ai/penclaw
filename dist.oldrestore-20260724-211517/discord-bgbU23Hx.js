...
import {
  n as parseRetryAfterHeaderSeconds,
  t as parseDiscordRetryAfterBodySeconds,
} from "./retry-after-pg8EX56Z.js";
...
var require_v10$5 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  (function (GatewayRequestChannelInfoField) {
    ...
    GatewayRequestChannelInfoField ||
      (exports.GatewayRequestChannelInfoField = GatewayRequestChannelInfoField = {}),
  );
});
//#endregion
...
var require_common$1 = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  (function (RESTJSONErrorCodes) {
    ...
    RESTJSONErrorCodes[(RESTJSONErrorCodes["UnknownInviteTargetUsersJob"] = 10124)] =
      "UnknownInviteTargetUsersJob";
    RESTJSONErrorCodes[(RESTJSONErrorCodes["UnknownInviteTargetUsers"] = 10129)] =
      "UnknownInviteTargetUsers";
    ...
    RESTJSONErrorCodes[(RESTJSONErrorCodes["ThisActionRequiresAPremiumSubscription"] = 20015)] =
      "ThisActionRequiresAPremiumSubscription";
    RESTJSONErrorCodes[
    ...
    RESTJSONErrorCodes[
      (RESTJSONErrorCodes["CannotSendVoiceEffectWhenUserIsServerMutedDeafenedOrSuppressed"] = 50167)
    ...
    RESTJSONErrorCodes[
      (RESTJSONErrorCodes["AccessToJoiningNewServersHasBeenLimitedForTheUser"] = 340015)
    ...
    try {
      ...
      if (onDisk?.hashes && typeof onDisk.hashes === "object") {
        for (const [key, value] of Object.entries(onDisk.hashes))
          if (typeof value === "string" && key.trim() && value.trim()) merged.set(key, value);
      }
...
const nullableLocalizationFields = /* @__PURE__ */ new Set([
...
function colorToNumber(value) {
  if (typeof value === "number")
    return Number.isInteger(value) && value >= 0 && value <= 16777215 ? value : void 0;
  ...
  return {
    ...
    guild:
      "guild_id" in channelData && typeof channelData.guild_id === "string"
        ? new Guild(clientForTest, channelData.guild_id)
        : void 0,
...
function readDiscordCode(body) {
  return parseStrictNonNegativeInteger(
    body && typeof body === "object" && "code" in body ? body.code : void 0,
  );
}
...
async function readResponseBodyText(response, idleTimeoutMs) {
  return decodeResponseBody(
    await readResponseWithLimit(response, DISCORD_REST_RESPONSE_BODY_MAX_BYTES, {
      chunkTimeoutMs: idleTimeoutMs,
      onOverflow: ({ size }) => createResponseBodyOverflowError(size),
      onIdleTimeout: ({ chunkTimeoutMs }) =>
        /* @__PURE__ */ new Error(
          `Discord REST response stalled: no data received for ${chunkTimeoutMs}ms`,
        ),
    }),
  );
}
...
function decodeResponseBody(buffer) {
  ...
  if (buffer[0] === GZIP_MAGIC[0] && buffer[1] === GZIP_MAGIC[1])
    try {
      return gunzipSync(buffer, { maxOutputLength: DISCORD_REST_RESPONSE_BODY_MAX_BYTES }).toString(
        "utf8",
      );
    } catch (err) {
...
var RequestClient = class {
  ...
  async executeRequest(method, path, params, routeKey = createRouteKey(method, path)) {
    ...
    try {
      ...
      const parsed = coerceResponseBody(
        await readResponseBodyText(response, this.options.timeout ?? 15e3),
      );
...
//#endregion
export {
  listMessageReactionUsers as $,
  TextInput as A,
  moveGuildChannels as At,
  Section as B,
  GatewayDispatchEvents as Bt,
  User as C,
  getGuildMember as Ct,
  Label as D,
  listGuildEmojis as Dt,
  CheckboxGroup as E,
  listGuildChannels as Et,
  LinkButton as F,
  ApplicationCommandOptionType as Ft,
  UserSelectMenu as G,
  MessageType as Gt,
  StringSelectMenu as H,
  GatewayOpcodes as Ht,
  MediaGallery as I,
  ButtonStyle as It,
  createChannelWebhook as J,
  TextInputStyle as Jt,
  BaseMessageInteractiveComponent as K,
  PermissionFlagsBits as Kt,
  MentionableSelectMenu as L,
  ChannelType as Lt,
  ChannelSelectMenu as M,
  removeGuildMember as Mt,
  Container as N,
  removeGuildMemberRole as Nt,
  Modal as O,
  listGuildRoles as Ot,
  File as P,
  timeoutGuildMember as Pt,
  deleteOwnMessageReaction as Q,
  RoleSelectMenu as R,
  ComponentType as Rt,
  Message as S,
  getGuild as St,
  Embed as T,
  listGuildActiveThreads as Tt,
  TextDisplay as U,
  MessageFlags as Ut,
  Separator as V,
  GatewayIntentBits as Vt,
  Thumbnail as W,
  MessageReferenceType as Wt,
  getCurrentUser as X,
  createUserDmChannel as Y,
  require_v10$4 as Yt,
  createOwnMessageReaction as Z,
  readDiscordMessage as _,
  createGuildChannel as _t,
  PresenceUpdateListener as a,
  editChannelMessage as at,
  CommandWithSubcommands as b,
  createGuildSticker as bt,
  ThreadUpdateListener as c,
  listChannelArchivedThreads as ct,
  Plugin as d,
  pinChannelMessage as dt,
  createChannelMessage as et,
  RequestClient as f,
  searchGuildMessages as ft,
  readDiscordCode as g,
  createGuildBan as gt,
  isUnknownDiscordVoiceStateError as h,
  addGuildMemberRole as ht,
  MessageReactionRemoveListener as i,
  editChannel as it,
  Button as j,
  putChannelPermission as jt,
  RadioGroup as k,
  listGuildScheduledEvents as kt,
  VoiceStateUpdateListener as l,
  listChannelMessages as lt,
  RateLimitError as m,
  unpinChannelMessage as mt,
  MessageCreateListener as n,
  deleteChannel as nt,
  ReadyListener as o,
  getChannel as ot,
  DiscordError as p,
  sendChannelTyping as pt,
  parseCustomId as q,
  StickerFormatType as qt,
  MessageReactionAddListener as r,
  deleteChannelMessage as rt,
  ResumedListener as s,
  getChannelMessage as st,
  InteractionCreateListener as t,
  createThread as tt,
  Client as u,
  listChannelPins as ut,
  readRetryAfter as v,
  createGuildEmoji as vt,
  serializePayload as w,
  getGuildVoiceState as wt,
  Guild as x,
  deleteChannelPermission as xt,
  Command as y,
  createGuildScheduledEvent as yt,
  Row as z,
  GatewayCloseCodes as zt,
};
