...
} from "./setup-surface-CVz_wk9c.js";
...
import { _ as resolvePinnedHostnameWithPolicy } from "./ssrf-keFRGQLq.js";
import { a as normalizeLowercaseStringOrEmpty } from "./string-coerce-DW4mBlAt.js";
import { u as normalizeStringEntriesLower } from "./string-normalization-CRyoFBPt.js";
import { r as truncateUtf16Safe } from "./utf16-slice-lH-m0h6-.js";
import { a as createFixedWindowRateLimiter } from "./webhook-ingress-BloIhSnv.js";
import {
...
function normalizeSynologyChatTarget(target) {
  ...
  if (!trimmed) return;
  const chatUserId = parseStrictNonNegativeInteger(
    trimmed.replace(/^synology(?:[-_]?chat)?:/i, "").trim(),
  );
