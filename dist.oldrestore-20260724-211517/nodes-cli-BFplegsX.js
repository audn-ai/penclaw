...
import { _ as randomIdempotencyKey } from "./call-BVMO6az_.js";
...
import {
  a as nodesCallOpts,
  c as parseOptionalNodePositiveInteger,
  d as resolveNodeId,
  f as unauthorizedHintForMessage,
  i as callNodePairApprovalGatewayCli,
  l as resolveNode,
  n as callGatewayCli,
  o as parseOptionalNodeFiniteNumber,
  p as formatPermissions,
  r as callNodeDiagnosticsGatewayCli,
  s as parseOptionalNodeNonNegativeInteger,
  t as buildNodeInvokeParams,
  u as resolveNodeDiagnosticsId,
} from "./rpc-8cxl1gqF.js";
...
async function registerNodesCli(program, argv = process.argv) {
  ...
  const { registerPluginCliCommandsFromValidatedConfig } = await import("./cli-7HKqAFzS.js");
