...
const loadModelsAliasesCommands = createModuleLoader(() => import("./aliases-DnzxVwlu.js"));
const loadModelsFallbacksCommands = createModuleLoader(() => import("./fallbacks-DEr3Ejh0.js"));
const loadModelsImageFallbacksCommands = createModuleLoader(
  () => import("./image-fallbacks-DS4M03f1.js"),
);
const loadModelsAuthCommands = createModuleLoader(() => import("./auth-D52tXFem.js"));
const loadModelsAuthOrderCommands = createModuleLoader(() => import("./auth-order-CGefcYIo.js"));
...
function registerModelsCli(program) {
  ...
  models
    ...
    .action(async (opts) => {
      await withModelsRuntime(async ({ defaultRuntime }) => {
        const { modelsListCommand } = await import("./list.list-command-BWQX24yw.js");
  ...
  models
    ...
    .action(async (model, _opts, command) => {
      ...
      await runtime.runModelsCommand(async () => {
        const { modelsSetCommand } = await import("./set-C4bPoUSM.js");
  ...
  models
    ...
    .action(async (model, _opts, command) => {
      ...
      await runtime.runModelsCommand(async () => {
        const { modelsSetImageCommand } = await import("./set-image-DilEJdha.js");
  ...
  models
    ...
    .action(async (opts) => {
      await withModelsRuntime(async ({ defaultRuntime }) => {
        const { modelsScanCommand } = await import("./scan--ejSImZQ.js");
  ...
  auth
    ...
    .action(async (opts, command) => {
      await withModelsRuntime(async ({ defaultRuntime, resolveModelAgentOption }) => {
        const agent = resolveModelAgentOption(command, opts);
        const { modelsAuthListCommand } = await import("./auth-list-CuZFFXAM.js");
