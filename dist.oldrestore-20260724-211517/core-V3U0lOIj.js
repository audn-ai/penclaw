...
import { i as buildChatChannelMetaById } from "./chat-meta-B_W7YKQn.js";
import { o as emptyChannelConfigSchema } from "./config-schema-qmCQZl6j.js";
...
import "./delegate-DXtLyRKu.js";
import "./resolve-route-oiOq6bK9.js";
...
async function ensureConfiguredAcpBindingReady(params) {
  return (
    await import("./persistent-bindings.lifecycle-CUs5L53Z.js")
...
function buildChannelOutboundSessionRoute(params) {
  ...
  return {
    ...
    baseSessionKey,
    ...(params.recipientSessionExact !== void 0
