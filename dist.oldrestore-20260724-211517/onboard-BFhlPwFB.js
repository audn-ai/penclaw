...
} from "./auth-choice-legacy-CW2uqEG-.js";
...
import { r as resolveLocalControlUiProbeLinks } from "./control-ui-links-BImlWgwk.js";
import { r as formatInvalidPortOption } from "./error-format-CG7mpTEd.js";
import { c as resolveUserPath } from "./home-dir-DxrrpDft.js";
import {
  a as stripPendingPluginInstallRecords,
  i as hasPendingPluginInstallRecords,
  n as commitConfigWriteWithPendingPluginInstalls,
  s as unchangedPendingPluginInstallRecordIds,
} from "./install-record-commit-BKVujmT7.js";
...
import {
  n as applySkipBootstrapConfig,
  t as applyLocalSetupWorkspaceConfig,
} from "./onboard-config-joIO1LST.js";
import { t as runGuidedOnboarding } from "./onboard-guided-4cHB67Bz.js";
import {
...
import { n as runInteractiveSetup } from "./onboard-interactive-B4ynrJpj.js";
...
function applyNonInteractiveGatewayConfig(params) {
  ...
  if (
    gatewayPort !== void 0 &&
    (!Number.isFinite(gatewayPort) || gatewayPort <= 0 || gatewayPort > 65535)
  ) {
...
async function collectGatewayHealthFailureDiagnostics() {
  ...
  try {
    const { readLastGatewayErrorLine } = await import("./diagnostics-CD5-SRRE.js");
...
async function runNonInteractiveLocalSetup(params) {
  ...
  const inferredAuthChoice = opts.authChoice
    ? void 0
    : (await import("./auth-choice-inference-GwcYkRU0.js")).inferAuthChoiceFromFlags(opts, {
        config: nextConfig,
        workspaceDir,
        env: process.env,
      });
  ...
  if (authChoice !== "skip") {
    const { applyNonInteractiveAuthChoice } = await import("./auth-choice-C6mBETpo.js");
  ...
  if (opts.installDaemon) {
    const { installGatewayDaemonNonInteractive } = await import("./daemon-install-DfratxiH.js");
...
async function runNonInteractiveMigrationImport(params) {
  ...
  const { detectSetupMigrationSources, runSetupMigrationImport } =
    await import("./setup.migration-import-BtkYg3Zt.js");
 ...
 */
const VALID_RESET_SCOPES = /* @__PURE__ */ new Set(["config", "config+creds+sessions", "full"]);
/**
