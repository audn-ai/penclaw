...
declare function resolveOpenedFileRealPathForHandle(
  handle: FileHandle,
  ioPath: string,
): Promise<string>;
//#endregion
...
type RootWriteOptions = Pick<
  RootDefaults,
  "denyMutations" | "mkdir" | "mode" | "renameIdentity"
> & {
...
declare function openLocalFileSafely(params: { filePath: string }): Promise<OpenResult>;
...
export {
  SymlinkPolicy as a,
  root as c,
  RootReadOptions as i,
  resolveOpenedFileRealPathForHandle as l,
  OpenResult as n,
  openLocalFileSafely as o,
  Root as r,
  readLocalFileSafely as s,
  HardlinkPolicy as t,
};
