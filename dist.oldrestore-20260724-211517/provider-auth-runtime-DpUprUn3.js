...
import "./model-auth-env-DLe5znyS.js";
import path from "node:path";
import "./api-key-rotation-BCk3rfbn.js";
import { fileURLToPath, pathToFileURL } from "node:url";
import { f as resolveApiKeyForProvider$1 } from "./model-auth-BWFdcEzF.js";
...
function resolveProviderAuthProfileMetadata(params) {
  ...
  const [profileId, profile] =
    (params.profileId
      ? [params.profileId, store.profiles[params.profileId]]
    ...
    const server = createServer((req, res) => {
      try {
        applyOAuthCallbackCorsHeaders(
          req,
          res,
          hasCorsOriginAllowlist ? resolveOAuthCallbackOrigin : void 0,
        );
...
export {
  ...
  generateOAuthState as n,
  resolveProviderAuthProfileMetadata as o,
  getRuntimeAuthForModel as r,
  waitForLocalOAuthCallback as s,
  buildOAuthCallbackOriginResolver as t,
};
