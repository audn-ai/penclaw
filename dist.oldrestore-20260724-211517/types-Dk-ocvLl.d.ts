...
import { t as Skill } from "./skill-contract-Cj6jU-ff.js";
...
type SessionEntry = SessionRestartRecoveryState &
  SessionEntryProvenance & {
    ...
    heartbeatTaskState?: Record<
      string,
      number
    > /** Plugin-owned session state, grouped by plugin id then extension namespace. */;
    pluginExtensions?: Record<
      string,
      Record<string, SessionPluginJsonValue>
    ...
    pluginExtensionSlotKeys?: Record<
      string,
    ...
    subagentRole?:
      | "orchestrator"
      | "leaf" /** Explicit control scope assigned at spawn time for subagent control decisions. */;
    subagentControlScope?:
      | "children"
      | "none" /** Session-scoped tool deny entries inherited from the caller that created this session. */;
    ...
    cronRunContinuation?: {
      ...
      phase:
        | "running"
        | "ready"
        | "continuing" /** True only after this row's session changes were projected to the stable cron row. */;
    ...
    modelOverrideSource?:
      | "auto"
      | "user" /** Selected model that produced the current auto fallback override. */;
    ...
    pendingFinalDeliveryText?:
      | string
      | null /** Original delivery context (channel, recipient, etc). */;
...
//#endregion
export {
  SessionChatType as a,
  SessionPluginJsonValue as c,
  RestartRecoveryRun as i,
  SessionScope as l,
  CliSessionBinding as n,
  SessionContextBudgetStatus as o,
  GroupKeyResolution as r,
  SessionEntry as s,
  AmbientTranscriptWatermark as t,
  SessionSystemPromptReport as u,
};
