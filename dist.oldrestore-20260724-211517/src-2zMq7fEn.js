...
var require_gaxios = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var Gaxios = class {
    ...
    static async #getProxyAgent() {
      this.#proxyAgent ||= (
        await import("./dist-BAQVGNtY.js").then((m) => /* @__PURE__ */ __toESM(m.default))
      ).HttpsProxyAgent;
...
var require_getCredentials = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const readFile = fs$5.readFile
    ? (0, util_1$1.promisify)(fs$5.readFile)
    : async () => {
...
var require_certificatesubjecttokensupplier = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  var CertificateSubjectTokenSupplier = class {
    ...
    async #processChainFromPaths(leafCertBuffer) {
      ...
      try {
        const chainCerts = (
          (await fs$3.promises.readFile(this.trustChainPath, "utf8")).match(
        ...
        if (client instanceof gdchclient_1.GdchClient && !client.apiAudience) {
          ...
          if (endpoint) {
            const formattedAudience =
              `${endpoint.startsWith("http") ? "" : "https://"}${endpoint}`.replace(/\/+$/, "");
