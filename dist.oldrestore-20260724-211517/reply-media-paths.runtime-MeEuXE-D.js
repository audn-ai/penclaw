...
import { r as toRelativeWorkspacePath, t as resolvePathFromInput } from "./path-policy-D_kcZMAl.js";
...
import { t as MEDIA_MAX_BYTES } from "./store-BfbXoJVN.js";
...
function createReplyMediaPathNormalizer(params) {
  ...
  return async (payload) => {
    ...
    const text =
      firstMediaDropError === void 0 ? payload.text : appendReplyMediaFailureWarning(payload.text);
