...
import "./zod-schema.core-CWTCY1ZZ.js";
import { y as transcodeAudioBuffer } from "./media-services-Czws84B5.js";
...
import {
  ...
  d as voiceProviderSupportsModel,
  l as resolveVoiceModelRefs,
  s as resolvePrimaryVoiceProviderCandidate,
  u as resolveVoiceProviderCandidates,
...
import { n as summarizeText } from "./speech-core-CWj6o89Y.js";
import {
...
function resolveRawProviderConfig(raw, providerId) {
  ...
  return withSpeakerSelectionCompat(
    asProviderConfig(asProviderConfigMap(raw.providers)[providerId] ?? raw[providerId]),
  );
}
...
export {
  ...
  setTtsMaxLength as C,
  synthesizeSpeech as D,
  streamSpeech as E,
  withSpeakerSelectionCompat as M,
  withSpeakerSelectionFallbackCompat as N,
  testApi as O,
  setTtsEnabled as S,
  setTtsProvider as T,
  resolveTtsPrefsPath as _,
  getTtsMaxLength as a,
  setSummarizationEnabled as b,
  isSummarizationEnabled as c,
  listSpeechVoices as d,
  listTtsPersonas as f,
  resolveTtsConfig as g,
  resolveTtsAutoMode as h,
  getResolvedSpeechProviderConfig as i,
  textToSpeechTelephony as j,
  textToSpeech as k,
  isTtsEnabled as l,
  resolveExplicitTtsOverrides as m,
  ...
  resolveTtsProviderOrder as v,
  setTtsPersona as w,
  setTtsAutoMode as x,
  setLastTtsAttempt as y,
};
