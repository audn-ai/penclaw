...
var require_helpers = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  function req(url, opts = {}) {
    const req = (
      (typeof url === "string" ? url : url.href).startsWith("https:") ? https : http$1
    ).request(url, opts);
...
var require_parse_proxy_response = /* @__PURE__ */ __commonJSMin((exports) => {
  ...
  const debug = (0, __importDefault(require_src()).default)(
  ...
  function parseProxyResponse(socket) {
    return new Promise((resolve, reject) => {
      ...
      function onend() {
        ...
        debug("onend");
        reject(
          /* @__PURE__ */ new Error("Proxy connection ended before receiving CONNECT response"),
        );
      }
      ...
      function ondata(b) {
        ...
        if (!firstLine) {
          socket.destroy();
          return reject(
            /* @__PURE__ */ new Error("No header received from proxy CONNECT response"),
          );
        }
