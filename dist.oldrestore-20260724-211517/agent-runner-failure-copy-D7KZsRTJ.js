...
function replaceGenericExternalRunFailureText(text) {
  ...
  if (text.slice(genericStart + 110).trim())
    return {
      text,
      replaced: false,
    };
...
//#endregion
export {
  HEARTBEAT_EXTERNAL_RUN_FAILURE_TEXT as n,
  replaceGenericExternalRunFailureText as r,
  GENERIC_EXTERNAL_RUN_FAILURE_TEXT as t,
};
