...
import {
  n as hasBundledChannelConfiguredState,
  r as listBundledChannelIdsWithConfiguredState,
  t as isChannelConfigured,
} from "./channel-configured-DcJL7IdZ.js";
import { t as findChatChannelMeta } from "./chat-meta-B_W7YKQn.js";
import { i as listPotentialConfiguredChannelPresenceSignals } from "./config-presence-dDm96tuW.js";
...
import { m as resolveInstalledPluginIndexPolicyHash } from "./installed-plugin-index-lBfkb-7L.js";
...
import { l as resolveOwningPluginIdsForModelRef } from "./providers-D0H29WPB.js";
import { o as isRecord } from "./record-coerce-DHZ4bFlT.js";
import { l as hashRuntimeConfigValue } from "./runtime-snapshot-BbbqRiDR.js";
import { t as resolvePluginSetupAutoEnableReasons } from "./setup-registry-B--wI5Zy.js";
import {
...
import {
  n as listBundledWorkerProviderOwners,
...
function resolveConfiguredPluginAutoEnableCandidates(params) {
  ...
  for (const providerId of collectConfiguredSpeechProviderIds(params.config))
    for (const pluginId of resolvePluginIdsForConfiguredSpeechProvider(providerId, params.registry))
      changes.push({
        pluginId,
...
function resolveChannelAutoEnableDisplayLabel(entry, manifestRegistry) {
  ...
  return (
    (builtInChannelId ? findChatChannelMeta(builtInChannelId)?.label : void 0) ??
...
function applyPluginAutoEnable(params) {
  ...
  if (config && typeof config === "object" && params.manifestRegistry && params.discovery) {
    ...
    const discoveryCache = getOrCreateWeakMap(
      getOrCreateWeakMap(
        getOrCreateWeakMap(
          (sameTurnApplyCache ??= /* @__PURE__ */ new WeakMap()),
          config,
...
//#endregion
export {
  detectPluginAutoEnableCandidates as a,
  materializePluginAutoEnableCandidates as i,
  fingerprintPluginAutoEnableConfig as n,
  configMayNeedPluginAutoEnable as o,
  fingerprintPluginAutoEnableEnv as r,
  resolvePluginAutoEnableCandidateReason as s,
