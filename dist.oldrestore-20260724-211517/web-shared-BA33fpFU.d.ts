...
declare function fetchWithWebToolsNetworkGuard(
  params: WebToolGuardedFetchOptions,
): Promise<GuardedFetchResult>;
/** Runs a fetch for trusted endpoints, allowing env proxy with pinned-host policy. */
declare function withTrustedWebToolsEndpoint<T>(
...
declare function withSelfHostedWebToolsEndpoint<T>(
  params: WebToolEndpointFetchOptions,
  run: (result: { response: Response; finalUrl: string }) => Promise<T>,
): Promise<T>;
/** Runs a fetch under strict SSRF protection without env proxy trust. */
declare function withStrictWebToolsEndpoint<T>(
  params: WebToolEndpointFetchOptions,
  run: (result: { response: Response; finalUrl: string }) => Promise<T>,
): Promise<T>;
//#endregion
...
declare function readResponseText(
  res: Response,
  options?: {
    maxBytes?: number;
  },
...
//#endregion
export {
  normalizeCacheKey as a,
  resolveCacheTtlMs as c,
  withTimeout as d,
  writeCache as f,
  withTrustedWebToolsEndpoint as g,
  withStrictWebToolsEndpoint as h,
  ReadResponseTextResult as i,
  resolvePositiveTimeoutSeconds as l,
  withSelfHostedWebToolsEndpoint as m,
  DEFAULT_CACHE_TTL_MINUTES as n,
  readCache as o,
  fetchWithWebToolsNetworkGuard as p,
  DEFAULT_TIMEOUT_SECONDS as r,
  readResponseText as s,
  CacheEntry as t,
  resolveTimeoutSeconds as u,
};
