import {
  d as PluginPackageInstall,
  i as PluginDiscoveryResult,
  o as OpenClawPackageBuild,
  r as PluginCandidate,
  t as PluginManifestRecord,
  u as PluginPackageChannel,
...
declare const PLUGIN_COMPAT_RECORDS: readonly [
  ...
  },
  {
    ...
    readonly diagnostics: readonly [
      "TypeScript @deprecated WebInboundMessage flat field annotations",
    ];
  ...
  },
  {
    ...
    readonly diagnostics: readonly [
      "TypeScript @deprecated WebInboundMessage admission field annotations",
    ];
    readonly tests: readonly ["src/plugins/compat/registry.test.ts"];
...
type InstalledPluginInstallRecordInfo = Pick<
  PluginInstallRecord,
  | "source"
  | "spec"
  | "sourcePath"
...
//#endregion
export {
  PluginCompatCode as a,
  PluginInstallSourceInfo as i,
  InstalledPluginIndexRefreshReason as n,
  LoadInstalledPluginIndexParams as r,
  InstalledPluginIndex as t,
};
