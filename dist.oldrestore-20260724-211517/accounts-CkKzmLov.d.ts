...
declare function resolveDiscordAccountConfig(
  cfg: OpenClawConfig,
  accountId: string,
): DiscordAccountConfig | undefined;
declare function mergeDiscordAccountConfig(
  cfg: OpenClawConfig,
  accountId: string,
...
export {
  ...
  resolveDiscordAccountConfig as c,
  listEnabledDiscordAccounts as i,
  resolveDiscordMaxLinesPerMessage as l,
  createDiscordActionGate as n,
  resolveDefaultDiscordAccountId as o,
  listDiscordAccountIds as r,
  resolveDiscordAccount as s,
  ResolvedDiscordAccount as t,
};
