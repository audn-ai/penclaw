import { Gn as SpeechProviderPlugin } from "./types-Ga3mNO_F.js";
...
declare function createOpenAiCompatibleSpeechProvider<
  ExtraConfig extends Record<string, unknown> = Record<string, never>,
>(options: OpenAiCompatibleSpeechProviderOptions<ExtraConfig>): SpeechProviderPlugin;
//#endregion
export {
  createOpenAiCompatibleSpeechProvider as a,
  OpenAiCompatibleSpeechProviderOptions as i,
  OpenAiCompatibleSpeechProviderConfig as n,
  OpenAiCompatibleSpeechProviderExtraJsonBodyField as r,
  OpenAiCompatibleSpeechProviderBaseUrlPolicy as t,
};
