...
import {
  ...
  d as resolvePluginNpmProjectsDir,
} from "./install-paths-CqMnrXsY.js";
import {
  g as hashJson,
  m as resolveInstalledPluginIndexPolicyHash,
} from "./installed-plugin-index-lBfkb-7L.js";
import { i as readPersistedInstalledPluginIndexSync } from "./installed-plugin-index-store-XopnPfaM.js";
...
} from "./manifest-registry-installed-CdFNhCi1.js";
  ...
  return (
    (snapshotPluginIds === void 0 ||
      ...
      (requestedPluginIds !== void 0 &&
        serializePluginIdScope(snapshotPluginIds) ===
          serializePluginIdScope(requestedPluginIds))) &&
  ...
  if (
    ...
    if (
      isPluginMetadataSnapshotCompatible({
        ...
        workspaceDir:
          params.workspaceDir ??
          (params.allowWorkspaceScopedCurrent === true ? current.workspaceDir : void 0),
        index: params.index,
      })
    )
      return current;
...
//#endregion
export {
  resolvePluginMetadataSnapshot as a,
  isDiagnosticsTimelineEnabled as c,
  loadPluginMetadataSnapshot as i,
  measureDiagnosticsTimelineSpan as l,
  isPluginMetadataSnapshotCompatible as n,
  resolvePluginMetadataSnapshotMemoEnvFingerprint as o,
  listPluginOriginsFromMetadataSnapshot as r,
  emitDiagnosticsTimelineEvent as s,
  clearLoadPluginMetadataSnapshotMemo as t,
