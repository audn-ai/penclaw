...
import { En as AccessGroupConfig } from "./types.openclaw-DDo8sH3F.js";
...
declare function decideChannelIngress(
...
type ChannelIngressIdentityField = {
  ...
  normalize?: (
    ...
    | string
    | null
    | undefined /** Normalizes configured allowlist entries for this identity field. */;
  normalizeEntry?: (
    value: string,
  ) => string | null | undefined /** Normalizes inbound subject values for this identity field. */;
  normalizeSubject?: (
    value: string,
  ) =>
    | string
    | null
    | undefined /** Marks identifiers as dangerous in diagnostics, for example mutable display names. */;
  dangerous?:
    | boolean
    | ((
        value: string,
      ) => boolean | undefined) /** Redaction hint for diagnostics and access graph consumers. */;
  sensitivity?: "normal" | "pii";
};
...
type ChannelIngressIdentityDescriptor = {
  ...
  isWildcardEntry?: (
    value: string,
  ) => boolean /** Optional custom match hook for platform-specific identity equivalence. */;
  matchEntry?: (params: {
...
type StableChannelIngressIdentityParams = ChannelIngressIdentityField &
...
type ChannelIngressIdentitySubjectInput = {
  /** Stable sender id appended to effective allowlists when access groups matched. */ stableId?:
    | string
    | number
    | null /** Optional identity aliases keyed by `ChannelIngressIdentityAlias.key`. */;
...
type ChannelMessageIngressCommandInput = NonNullable<ChannelIngressPolicyInput["command"]> & {
  /** Explicit command-owner allowlist; defaults to effective DM allowlist. */ commandOwnerAllowFrom?: Array<
    string | number
  > | null /** Controls whether group command owners inherit configured DM owners. */;
  groupOwnerAllowFrom?:
    | "configured"
    | "none" /** Allows direct-message command checks to reuse effective group allowlists. */;
  directGroupAllowFrom?:
    | "effective"
    | "none" /** Group command allowFrom fallback, separate from normal group sender policy. */;
  commandGroupAllowFromFallbackToAllowFrom?: boolean;
};
/** Preset form for command gates accepted by `createChannelIngressResolver`. */
type ChannelIngressCommandPresetInput = Omit<
...
> & {
  ...
  useAccessGroups?:
    | boolean
    | null /** Config subset used to derive command access-group behavior. */;
...
type ChannelIngressRouteDescriptor = {
  ...
  senderAllowFrom?: Array<
    string | number
  > | null /** Indicates whether route sender entries came from effective DM or group policy. */;
...
type ResolveChannelMessageIngressParams = {
  ...
  groupAllowFrom?: Array<
    string | number
  > | null /** Route descriptors used to build route gates. */;
  route?:
    | ChannelIngressRouteDescriptor
    | readonly ChannelIngressRouteDescriptor[] /** Prebuilt route facts for lower-level callers. */;
  ...
  accessGroupMatchedAllowFromEntry?:
    | string
    | number
    | null /** Records whether a provider-specific missing-config fallback was applied. */;
...
type CreateChannelIngressResolverParams = Pick<
...
type ChannelIngressResolverMessageParams = Omit<
  ResolveChannelMessageIngressParams,
  | "channelId"
  | "accountId"
  | "identity"
  ...
  | "command"
> & {
  /** Event facts or presets; defaults to a normal inbound message event. */ event?:
    | ChannelIngressEventInput
    | ChannelIngressEventPresetInput /** DM policy override for this event. */;
  ...
  policy?: Partial<
    Omit<ChannelIngressPolicyInput, "dmPolicy" | "groupPolicy">
...
type ChannelIngressResolver = {
  /** Resolve a normal inbound message with sender, route, command, event, and activation gates. */ message(
    params: ChannelIngressResolverMessageParams,
  ): Promise<ResolvedChannelMessageIngress> /** Resolve a command-oriented event with command auth defaults enabled. */;
  command(
    params: ChannelIngressResolverMessageParams,
  ): Promise<ResolvedChannelMessageIngress> /** Resolve a non-message event with event-gate defaults enabled. */;
...
type ResolveStableChannelMessageIngressParams = Omit<
...
declare function defineStableChannelIngressIdentity(
 ...
 * descriptor.
 */
declare function createChannelIngressResolver(
 ...
 */
declare function resolveStableChannelMessageIngress(
 ...
 * entries.
 */
declare function channelIngressRoutes(
 ...
 * channel event.
 */
declare function resolveChannelMessageIngress(
...
//#endregion
export {
  ResolvedRouteGateFacts as $,
  ChannelIngressChannelId as A,
  IngressGatePhase as B,
  ResolvedChannelMessageIngress as C,
  AccessGraphGate as D,
  AccessGraph as E,
  ChannelIngressPolicyInput as F,
  InternalMatchMaterial as G,
  InternalChannelIngressAdapter as H,
  ChannelIngressState as I,
  RedactedChannelIngressEvent as J,
  InternalNormalizedEntry as K,
  ChannelIngressStateInput as L,
  ChannelIngressEventInput as M,
  ChannelIngressIdentifierKind as N,
  AccessGroupMembershipFact as O,
  ChannelIngressNormalizedEntry as P,
  ResolvedIngressAllowlist as Q,
  IngressGateEffect as R,
  ResolveStableChannelMessageIngressParams as S,
  decideChannelIngress as T,
  InternalChannelIngressNormalizeResult as U,
  IngressReasonCode as V,
  InternalChannelIngressSubject as W,
  RedactedIngressEntryDiagnostic as X,
  RedactedIngressAllowlistFacts as Y,
  RedactedIngressMatch as Z,
  ChannelIngressRouteAccess as _,
  resolveStableChannelMessageIngress as a,
  CreateChannelIngressResolverParams as b,
  ChannelIngressCommandPresetInput as c,
  ChannelIngressIdentityAlias as d,
  RouteGateFacts as et,
  ChannelIngressIdentityDescriptor as f,
  ChannelIngressResolverMessageParams as g,
  ChannelIngressResolver as h,
  resolveChannelMessageIngress as i,
  ChannelIngressDecision as j,
  ChannelIngressAdmission as k,
  ChannelIngressConfigInput as l,
  ChannelIngressIdentitySubjectInput as m,
  channelIngressRoutes as n,
  RouteSenderAllowlistSource as nt,
  defineStableChannelIngressIdentity as o,
  ChannelIngressIdentityField as p,
  MatchableIdentifier as q,
  createChannelIngressResolver as r,
  RouteSenderPolicy as rt,
  ChannelIngressAccessGroupMembershipResolver as s,
  readChannelIngressStoreAllowFromForDmPolicy as t,
  RouteGateState as tt,
  ChannelIngressEventPresetInput as u,
  ChannelIngressRouteDescriptor as v,
  StableChannelIngressIdentityParams as w,
  ResolveChannelMessageIngressParams as x,
  ChannelMessageIngressCommandInput as y,
  IngressGateKind as z,
};
