import {
  ...
  r as resolveAcpStreamingConfig,
...
import {
  i as appendRecentHistoryImageContext,
  n as resolveAgentTurnAttachments,
  r as resolveInlineAgentImageAttachments,
  t as loadAgentTurnMediaRuntime,
} from "./agent-turn-attachments-C5wjYmcd.js";
import { r as createBlockReplyPipeline } from "./block-reply-pipeline-BnR5cPlu.js";
import { r as resolveFirstContextText } from "./context-text-DMuk8Wh5.js";
import { _ as markDiagnosticSessionProgress } from "./diagnostic-DE-wbBb7.js";
...
import { t as formatAcpRuntimeErrorText } from "./error-text-ojwLnndS.js";
import { r as formatErrorMessage } from "./errors-BoHeli7m.js";
import { a as toAcpRuntimeError, n as AcpRuntimeError } from "./errors-BTjUwYsc.js";
...
import { s as hasOutboundReplyContent } from "./reply-payload-DDwHXDkv.js";
import {
...
import { n as classifySessionStateActor } from "./session-state-events-DXdC9X_q.js";
import { t as resolveStatusTtsSnapshot } from "./status-config-Ts_niR31.js";
import {
...
const channelPluginRuntimeLoader = createLazyImportLoader(() => import("./plugins-DKUiZRqh.js"));
const messageActionRuntimeLoader = createLazyImportLoader(
  () => import("./message-action-runner-C5gBIfAI.js"),
);
...
function createAcpDispatchDeliveryCoordinator(params) {
  ...
  const deliver = async (kind, payload, meta) => {
    ...
    const isStatusNotice = isReplyPayloadStatusNotice(payload);
    const rawFinalText =
      kind === "final" && !isStatusNotice ? normalizeOptionalString(payload.text) : void 0;
    if (rawFinalText) {
...
function resolveMergedAcpAttachments(entries) {
  return entries
    .toSorted((left, right) => {
      if (left.sourceIndex !== void 0 && right.sourceIndex !== void 0)
