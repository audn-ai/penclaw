...
import { t as withResolvedActionClient } from "./client-qez4y8VO.js";
import { r as resolveMatrixAuthContext } from "./config-sv-OBcvj.js";
import {
  n as updateMatrixAccountConfig,
  t as resolveMatrixConfigPath,
} from "./config-update-C6P4f3lI.js";
import {
  n as summarizeMatrixDeviceHealth,
  t as isOpenClawManagedMatrixDevice,
} from "./device-health-Dtq8SwPm.js";
...
import { i as setMatrixSdkLogMode, r as setMatrixSdkConsoleLogging } from "./logging-Cn2NKweb.js";
...
} from "./profile-update-CduSJZax.js";
import { t as getMatrixRuntime } from "./runtime-C3viBnoh.js";
import { n as matrixSetupAdapter } from "./setup-core-jlLCuFmn.js";
import {
...
const loadMatrixActionClientModule = createLazyRuntimeModule(() => import("./client-BnJFcTbO.js"));
...
async function addMatrixAccount(params) {
  ...
  if (accountConfig.encryption === true) {
    const { maybeBootstrapNewEncryptedMatrixAccount } =
      await import("./setup-bootstrap-VeUULZmk.js");
