...
import { dt as SessionsPatchParams } from "./sessions-xbYJ30YJ.js";
 ...
 */
declare function createInternalHookEvent(
...
declare function isMessageReceivedEvent(
...
declare function isMessageTranscribedEvent(
  event: InternalHookEvent,
): event is MessageTranscribedHookEvent;
declare function isMessagePreprocessedEvent(
  event: InternalHookEvent,
...
//#endregion
export {
  isMessageSentEvent as C,
  setInternalHooksEnabled as D,
  registerInternalHook as E,
  triggerInternalHook as O,
  isMessageReceivedEvent as S,
  isSessionPatchEvent as T,
  getRegisteredEventKeys as _,
  MessagePreprocessedHookContext as a,
  isGatewayStartupEvent as b,
  MessageReceivedHookEvent as c,
  MessageTranscribedHookContext as d,
  MessageTranscribedHookEvent as f,
  createInternalHookEvent as g,
  clearInternalHooks as h,
  GatewayStartupHookEvent as i,
  unregisterInternalHook as k,
  MessageSentHookContext as l,
  SessionPatchHookEvent as m,
  AgentBootstrapHookEvent as n,
  MessagePreprocessedHookEvent as o,
  SessionPatchHookContext as p,
  GatewayStartupHookContext as r,
  MessageReceivedHookContext as s,
  AgentBootstrapHookContext as t,
  MessageSentHookEvent as u,
  hasInternalHookListeners as v,
  isMessageTranscribedEvent as w,
  isMessagePreprocessedEvent as x,
  isAgentBootstrapEvent as y,
};
