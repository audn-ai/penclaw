...
import { t as dispatchAssembledChannelTurn } from "./kernel-BhdvbEs2.js";
...
import { t as dispatchReplyWithBufferedBlockDispatcher } from "./provider-dispatcher-Cxi0TUNw.js";
import { a as normalizeChannelId, t as getChannelPlugin } from "./registry-mc8oBRx8.js";
import {
  a as formatRestartSentinelMessage,
  c as readRestartSentinel,
  l as summarizeRestartSentinel,
  n as clearRestartSentinel,
  r as finalizeUpdateRestartSentinelRunningVersion,
...
import { t as runStartupTasks } from "./startup-tasks-tqDIwhuO.js";
import { z as parseSessionThreadInfo } from "./store-CzZJhTF6.js";
...
import "./get-reply-run-queue-BkNZBmat.js";
import { i as resolveOutboundTarget } from "./targets-CnpDCogZ.js";
import { a as isPendingControlPlaneUpdateRestartSentinel } from "./update-control-plane-sentinel-DS3ELeta.js";
...
function isRestartContinuationBusyPayload(payload) {
  return (
    ...
    payload.text.trim() === "⚠️ Previous run is still shutting down. Please try again in a moment."
  );
}
...
async function loadRestartSentinelStartupTask(params) {
  ...
  const run = async () => {
    ...
    await clearRestartSentinel();
    if (!(payload.continuation?.kind === "agentTurn" && continuationRoute !== void 0))
