...
import {
  i as registryContainsRuntimePluginIds,
...
import { l as resolveChannelPluginIds } from "./gateway-startup-plugin-ids-C7oHc3ol.js";
import {
...
import {
  ...
  d as getActivePluginRegistryWorkspaceDir,
...
function activeRegistrySatisfiesScope(
  ...
  if (requestedPluginIds !== void 0) {
    ...
    if (requestedWorkspaceDir !== void 0 && activeWorkspaceDir !== requestedWorkspaceDir)
      return false;
...
function ensurePluginRegistryLoaded(options) {
  ...
  const requestedPluginIdsForScope =
    scope === "all" && expectedPluginIds.length === 0 ? expectedPluginIds : void 0;
  if (
    !scopedLoad &&
