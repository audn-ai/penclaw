...
declare function walkDirectorySync(
  rootDir: string,
  options?: WalkDirectoryOptions,
): WalkDirectoryResultWithFailures;
declare function walkDirectory(
  rootDir: string,
  options?: WalkDirectoryOptions,
...
declare function ensureAbsoluteDirectory(
  dirPath: string,
  options?: {
    scopeLabel?: string;
    mode?: number;
...
>;
declare function writeExternalFileWithinRoot(
...
export {
  FsSafeError as _,
  writeExternalFileWithinRoot as a,
  WalkDirectoryOptions as c,
  walkDirectorySync as d,
  SecureFileReadOptions as f,
  isPathInside as g,
  isNotFoundPathError as h,
  readFileWithinRoot as i,
  WalkDirectoryResult as l,
  readSecureFile as m,
  ExternalFileWriteResult as n,
  writeFileWithinRoot as o,
  SecureFileReadResult as p,
  ensureAbsoluteDirectory as r,
  WalkDirectoryEntry as s,
  ExternalFileWriteOptions as t,
  walkDirectory as u,
  FsSafeErrorCode as v,
};
