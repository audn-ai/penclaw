...
declare function resolvePollMaxSelections(
  optionCount: number,
  allowMultiselect: boolean | undefined,
): number;
declare function normalizePollInput(
  input: PollInput,
  options?: NormalizePollOptions,
): NormalizedPollInput;
declare function normalizePollDurationHours(
...
//#endregion
export {
  resolvePollMaxSelections as a,
  normalizePollInput as i,
  PollInput as n,
  normalizePollDurationHours as r,
  NormalizedPollInput as t,
};
