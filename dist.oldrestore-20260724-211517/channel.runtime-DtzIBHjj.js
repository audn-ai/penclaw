import { n as resolveMatrixAuth } from "./config-sv-OBcvj.js";
import {
  n as listMatrixDirectoryPeersLive,
  t as listMatrixDirectoryGroupsLive,
} from "./directory-live-DpyWxvdz.js";
import { r as formatErrorMessage } from "./errors-BoHeli7m.js";
import { r as createLazyRuntimeModule } from "./lazy-runtime-B-Fc-m0I.js";
import { p as renderMessagePresentationFallbackText } from "./payload-BFbDi85B.js";
...
const loadMatrixProbeRuntimeDeps = createLazyRuntimeModule(() =>
  import("./probe.runtime-D9KVfvLY.js").then((runtimeModule) => ({
...
function resolveMatrixPresentationContent(payload) {
  const presentation = toRecord(
    toRecord(resolveMatrixChannelData(payload).extraContent)?.[MATRIX_OPENCLAW_PRESENTATION_KEY],
  );
  if (
    !presentation ||
