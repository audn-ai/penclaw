...
import {
  d as readResponseWithLimit,
  o as readChunkWithIdleTimeout,
  u as readResponseTextSnippet,
} from "./http-body-aoMvQQlg.js";
import { n as detectMime, r as extensionForMime } from "./mime-BSEMEb3s.js";
...
import { i as isTransientNetworkError } from "./unhandled-rejections-DwDskC0u.js";
...
function resolveRemoteFileName(params) {
  ...
  return (
    ...
    (params.filePathHint ? basenameFromAnyPath(params.filePathHint) : void 0) ||
    fileNameFromUrl
  );
}
...
function resolveResponseContentType(params) {
  ...
  if (
    ...
    headerContentType.slice(6) === fallbackContentType.slice(6)
  )
...
//#endregion
export {
  saveRemoteMedia as a,
  readRemoteMediaBuffer as i,
  MediaFetchError as n,
  saveResponseMedia as o,
  fetchRemoteMedia as r,
  DEFAULT_FETCH_MEDIA_MAX_BYTES as t,
};
