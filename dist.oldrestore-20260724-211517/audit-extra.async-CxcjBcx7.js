...
import { t as collectIncludePathsRecursive } from "./includes-scan-xn7WmV1f.js";
import {
...
import { _ as resolveOAuthDir } from "./paths-DEklnbzU.js";
import { t as extensionUsesSkippedScannerPath } from "./scan-paths-Bve2UhXh.js";
import { o as resolveAuthProfileDatabaseFilePaths } from "./sqlite-BXljtvPf.js";
import {
...
const IGNORED_INSTALLED_PLUGIN_DIR_NAMES = /* @__PURE__ */ new Set([
  "node_modules",
...
const loadSkillsModule = createLazyRuntimeModule(() => import("./workspace-Bmb6l2FU.js"));
...
function normalizeDockerProbeTimeoutMs(timeoutMs) {
  if (Number.isFinite(timeoutMs) && timeoutMs !== void 0)
...
async function collectStateDeepFilesystemFindings(params) {
  ...
  const ids = uniqueStrings([resolveDefaultAgentId(params.cfg), ...agentIds]).map((id) =>
    normalizeAgentId(id),
  );
