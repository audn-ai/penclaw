...
declare const TelegramConfigSchema: ZodObject<
  {
    ...
    threadBindings: ZodOptional<
      ...
      >
    >;
    reactionNotifications: ZodOptional<
      ZodEnum<{
        off: "off";
        all: "all";
        own: "own";
...
declare const DiscordConfigSchema: ZodObject<
  {
    ...
    token: ZodOptional<
      ...
      >
    >;
    applicationId: ZodOptional<
      ZodPipe<
        ZodPipe<ZodUnion<readonly [ZodString, ZodNumber]>, ZodTransform<string, string | number>>,
        ZodString
      >
    >;
    proxy: ZodOptional<ZodString>;
            ...
            ZodArray<
              ZodPipe<
                ZodPipe<
                  ...
                  ZodTransform<string, string | number>
                >,
                ZodString
              >
            >
                    ...
                    ZodObject<
                      {
                        ...
                        autoThreadName: ZodOptional<
                          ZodEnum<{
                            message: "message";
                            generated: "generated";
                          }>
                        >;
                        autoArchiveDuration: ZodOptional<
                          ZodUnion<
                            readonly [
                              ZodEnum<{
                                60: "60";
            ...
            ZodObject<
              {
                ...
                bootstrapContextFiles: ZodOptional<
                  ZodArray<
                    ZodEnum<{
                ...
                providers: ZodOptional<
                  ZodRecord<ZodString, ZodOptional<ZodRecord<ZodString, ZodUnknown>>>
                >;
              },
              $strict
            >
          >;
          autoJoin: ZodOptional<
            ZodArray<
              ZodObject<
                {
                  guildId: ZodString;
...
declare const SlackConfigSchema: ZodObject<
  {
    ...
    replyToMode: ZodOptional<
      ...
      >
    >;
    replyToModeByChatType: ZodOptional<
      ZodObject<
        {
          direct: ZodOptional<
            ZodUnion<
                    ...
                    ZodObject<
                      {
                        ...
                        toolsBySender: ZodOptional<
                          ...
                          >
                        >;
                        allowBots: ZodOptional<
                          ZodUnion<readonly [ZodBoolean, ZodLiteral<"mentions">]>
                        >;
                        botLoopProtection: ZodOptional<
                          ZodObject<
                            {
          ...
          ZodObject<
            {
              ...
              autoStart: ZodOptional<ZodBoolean>;
              startupTimeoutMs: ZodOptional<ZodNumber>;
              receiveMode: ZodOptional<
                ZodUnion<readonly [ZodLiteral<"on-start">, ZodLiteral<"manual">]>
              >;
              ignoreAttachments: ZodOptional<ZodBoolean>;
              ignoreStories: ZodOptional<ZodBoolean>;
              sendReadReceipts: ZodOptional<ZodBoolean>;
...
declare const IMessageConfigSchema: ZodObject<
  {
    ...
    >;
    service: ZodOptional<
      ZodUnion<readonly [ZodLiteral<"imessage">, ZodLiteral<"sms">, ZodLiteral<"auto">]>
    >;
    sendTransport: ZodOptional<
      ZodEnum<{
        auto: "auto";
        bridge: "bridge";
