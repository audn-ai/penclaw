...
const loadPluginsAuthoringCommands = createModuleLoader(
  () => import("./plugins-authoring-command-c5Zgb9SP.js"),
);
function registerPluginsCli(program) {
  ...
  plugins
    ...
    .action(async (id, opts) => {
      const { runPluginsInspectCommand } = await import("./plugins-inspect-command-CiG8qphM.js");
  ...
  plugins
    ...
    .action(async (id, opts) => {
      const { runPluginUninstallCommand } = await import("./plugins-uninstall-command-yIIKIbO5.js");
  ...
  plugins
    ...
    .action(async (id, opts) => {
      const { runPluginUpdateCommand } = await import("./plugins-update-command-DBAn0QI9.js");
