...
function bumpSkillsSnapshotVersion(params) {
  ...
  if (params?.workspaceDir) {
    const next = bumpVersion(
      Math.max(globalVersion, workspaceVersions.get(params.workspaceDir) ?? 0),
    );
...
//#endregion
export {
  resetSkillsRefreshStateForTest as a,
  registerSkillsChangeListener as i,
  clearSkillsSnapshotVersionForWorkspace as n,
  setSkillsChangeListenerErrorHandler as o,
  getSkillsSnapshotVersion as r,
  shouldRefreshSnapshotForVersion as s,
