...
import { n as isAccountConfigured, o as resolveTwitchToken } from "./twitch-C10wRDoI.js";
...
const twitchSetupWizard = {
  ...
  status: {
    ...
    resolveStatusLines: ({ cfg, accountId }) => {
      ...
      return [
        `Twitch${resolvedAccountId !== "default" ? ` (${resolvedAccountId})` : ""}: ${configured ? t("wizard.channels.statusConfigured") : t("wizard.channels.statusNeedsUsernameTokenClientId")}`,
      ];
    },
  },
  credentials: [],
