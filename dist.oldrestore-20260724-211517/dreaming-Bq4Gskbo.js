import {
  B as MANAGED_MEMORY_DREAMING_CRON_TAG,
  G as resolveMemoryDeepDreamingConfig,
  V as MEMORY_DREAMING_SYSTEM_EVENT_TEXT,
  W as resolveMemoryCorePluginConfig,
  Y as resolveMemoryDreamingWorkspaces,
  z as MANAGED_MEMORY_DREAMING_CRON_NAME,
...
} from "./dreaming-shared-BS6J1klu.js";
...
import { l as peekSystemEventEntries } from "./system-events-CIAdjAwz.js";
...
async function runShortTermDreamingPromotionIfTriggered(params) {
  ...
  const [
    ...
    import("./dreaming-markdown-CuWjyYKd.js"),
    import("./dreaming-narrative-DHPzzrnp.js"),
    import("./dreaming-phases-CwRY5Xe-.js"),
    import("./short-term-promotion-CbCkUjny.js"),
  ]);
...
function registerShortTermPromotionDreaming(api) {
  ...
  const scheduleStartupCronRetry = () => {
    ...
    startupCronRetryTimer = setTimeout(() => {
      ...
      reconcileManagedDreamingCron({ reason: "startup_retry" })
        .then(async () => {
          if (disposed || hasStartupCron()) {
            clearStartupCronRetry();
            return;
