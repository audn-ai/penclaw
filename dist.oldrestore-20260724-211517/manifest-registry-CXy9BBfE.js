...
import { a as loadBundleManifest } from "./bundle-manifest-Dxp5qa20.js";
...
} from "./config-normalization-shared-DXCRDrH7.js";
import { t as isBundledPluginInsideDevSourceRoot } from "./dev-source-root-CqCwQZ8r.js";
...
import {
  ...
  o as normalizeManifestChannelCommandDefaults,
...
function hasTrustedClawHubSourceAuthority(record, officialClawHubSpec) {
  if (record.clawhubUrl !== void 0 || record.clawhubChannel !== void 0)
...
function mergeManifestCatalog(manifestCatalog, officialCatalog) {
  ...
  const order =
    typeof orderCandidate === "number" && Number.isFinite(orderCandidate) ? orderCandidate : void 0;
...
function buildRecord(params) {
  const providerSourceEntry =
    params.manifest.providerCatalogEntry !== void 0
      ? {
...
//#endregion
export {
  hasExplicitPluginConfig as a,
  resolveMemorySlotDecision as c,
  resolveTrustedSourceLinkedOfficialNpmSpec as i,
  resolveTrustedSourceLinkedOfficialClawHubInstall as n,
  normalizePluginsConfigWithResolver as o,
  resolveTrustedSourceLinkedOfficialClawHubSpec as r,
  resolveEffectivePluginActivationState as s,
