...
import {
  ...
  l as resolveZalouserGroupScope,
  o as buildZalouserGroupCandidates,
  t as getZalouserRuntime,
} from "./runtime-B686E1bn.js";
import {
  a as listZalouserAccountIds,
  i as checkZcaAuthenticated,
  n as zalouserSetupAdapter,
  o as resolveDefaultZalouserAccountId,
  r as writeQrDataUrlToTempFile,
  s as resolveZalouserAccountSync,
...
const loadZalouserChannelRuntime$1 = createLazyRuntimeModule(
  () => import("./channel.runtime-BJHrTurc.js"),
);
...
async function sendZalouserTextFromContext({ to, text, accountId, cfg, onDeliveryResult }) {
  ...
  return toZalouserMessageSendResult(
    await sendMessageZalouser(target.threadId, text, {
...
const zalouserSetupWizardProxy = createZalouserSetupWizardProxy(
  async () => (await import("./setup-surface-DKmf2p8U.js")).zalouserSetupWizard,
);
  ...
  base: {
    ...
    gateway: {
      startAccount: async (ctx) => {
        ...
        const { monitorZalouserProvider } = await import("./monitor-GJMmfQhK.js");
