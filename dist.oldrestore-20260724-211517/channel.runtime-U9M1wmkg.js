...
import { i as getMe, n as ZaloApiError, t as resolveZaloProxyFetch } from "./proxy-CNK10_dW.js";
import "./accounts-C71qLp4D.js";
import "./runtime-api-DiCWdjCC.js";
import { t as sendMessageZalo } from "./send-CEFpUix8.js";
...
async function notifyZaloPairingApproval(params) {
  const { resolveZaloAccount } = await import("./accounts-DalpVY-L.js");
...
async function startZaloGatewayAccount(ctx) {
  ...
  const { monitorZaloProvider } = await import("./monitor-C2TnV18q.js");
