...
const WorkerAdmissionResponseFrameSchema = Type.Union([
...
const WorkerHeartbeatResponseFrameSchema = Type.Union([
...
const WorkerTranscriptAssistantMessageSchema = closedObject({
  ...
  diagnostics: Type.Optional(
    Type.Array(WorkerTranscriptAssistantDiagnosticSchema, { maxItems: 128 }),
  ),
...
const WorkerLiveEventErrorDetailsSchema = Type.Union([
  workerLiveObject({
    reason: Type.Union([
      Type.Literal("epoch-mismatch"),
      Type.Literal("session-not-attached"),
...
//#endregion
export {
  WorkerLiveEventRequestFrameSchema as A,
  WorkerTranscriptCommitResultSchema as B,
  WorkerHeartbeatRequestFrameSchema as C,
  WorkerLiveEventErrorDetailsSchema as D,
  WorkerHelloOkSchema as E,
  WorkerTranscriptCommitErrorReasonSchema as F,
  WorkerTranscriptCommitErrorShapeSchema as I,
  WorkerTranscriptCommitParamsSchema as L,
  WorkerLiveEventResultSchema as M,
  WorkerLiveEventSchema as N,
  WorkerLiveEventErrorShapeSchema as O,
  WorkerProtocolCloseReasonSchema as P,
  WorkerTranscriptCommitRequestFrameSchema as R,
  WorkerHeartbeatParamsSchema as S,
  WorkerHeartbeatResultSchema as T,
  WorkerTranscriptMessageSchema as V,
  WorkerAdmissionHandshakeSchema as _,
  WORKER_PROTOCOL_MAX_FEATURE_LENGTH as a,
  WorkerConnectRequestFrameSchema as b,
  WORKER_PROTOCOL_MAX_METHOD_LENGTH as c,
  WORKER_RPC_SET_VERSION as d,
  WORKER_TRANSCRIPT_COMMIT_PROTOCOL_FEATURE as f,
  WorkerAdmissionFailureReasonSchema as g,
  WORKER_TRANSCRIPT_MAX_JSON_DEPTH as h,
  WORKER_PROTOCOL_MAX_FEATURES as i,
  WorkerLiveEventResponseFrameSchema as j,
  WorkerLiveEventParamsSchema as k,
  WORKER_PROTOCOL_MAX_PAYLOAD_BYTES as l,
  WORKER_TRANSCRIPT_MAX_CONTENT_PARTS as m,
  WORKER_LIVE_EVENT_PROTOCOL_FEATURE as n,
  WORKER_PROTOCOL_MAX_FRAME_ID_LENGTH as o,
  WORKER_TRANSCRIPT_MAX_BATCH_MESSAGES as p,
  WORKER_PROTOCOL_FEATURES as r,
  WORKER_PROTOCOL_MAX_IDENTIFIER_LENGTH as s,
  WORKER_HEARTBEAT_INTERVAL_MS as t,
  WORKER_PROTOCOL_METHODS as u,
  WorkerAdmissionResponseFrameSchema as v,
  WorkerHeartbeatResponseFrameSchema as w,
  WorkerErrorShapeSchema as x,
  WorkerConnectParamsSchema as y,
  WorkerTranscriptCommitResponseFrameSchema as z,
};
