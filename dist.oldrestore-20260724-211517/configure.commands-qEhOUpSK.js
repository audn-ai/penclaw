...
import { i as applyAuthChoice } from "./auth-choice-CvpCVHJc.js";
import { n as promptAuthChoiceGrouped } from "./auth-choice-prompt-BaQnBKNE.js";
import { r as listChatChannels } from "./chat-meta-B_W7YKQn.js";
import { t as createClackPrompter } from "./clack-prompter-Cu4E8Cn1.js";
import { t as describeCodexNativeWebSearch } from "./codex-native-web-search.shared-D7KzlpGf.js";
...
import {
  ...
  i as intro,
  l as text,
  n as CONFIGURE_WIZARD_SECTIONS,
  o as parseConfigureWizardSections,
  r as confirm,
  s as password,
  t as CONFIGURE_SECTION_OPTIONS,
} from "./configure.shared-BaORZxEM.js";
import { t as ensureControlUiAssetsBuilt } from "./control-ui-assets-Bfrq0NUW.js";
import {
  r as resolveLocalControlUiProbeLinks,
  t as resolveAdvertisedControlUiLinks,
} from "./control-ui-links-BImlWgwk.js";
import {
  n as gatewayInstallErrorHint,
  t as buildGatewayInstallPlan,
} from "./daemon-install-helpers-DbcV1pnD.js";
import {
...
import {
  a as validateDottedDecimalIPv4Input,
  i as maybeAddTailnetOriginToControlUiAllowedOrigins,
  n as TAILSCALE_EXPOSURE_OPTIONS,
  r as TAILSCALE_MISSING_BIN_NOTE_LINES,
  t as TAILSCALE_DOCS_LINES,
} from "./gateway-config-prompts.shared-CQ97gOwV.js";
import { t as resolveGatewayInstallToken } from "./gateway-install-token-CwKaSRw3.js";
import { c as healthCommand } from "./health-B7JDh_rX.js";
import { r as formatHealthCheckFailure } from "./health-format-DQ9OK_xq.js";
...
import { t as loadStaticManifestCatalogRowsForList } from "./list.manifest-catalog-Cfm7M_VF.js";
...
} from "./model-picker-BaWNF8Vw.js";
import { t as note } from "./note-Uvqr4R1d.js";
import { i as setupChannels } from "./onboard-channels-3laABAla.js";
import "./auth-profiles-CX7JDmZ9.js";
import "./workspace-DXzCbuC0.js";
import { t as promptCustomApiConfig } from "./onboard-custom-bCrVziXQ.js";
import {
  a as guardCancel,
...
import { t as promptRemoteGatewayConfig } from "./onboard-remote-CNvxNTEB.js";
import { t as setupSkills } from "./onboard-skills-B2UQyxvA.js";
import { t as parsePort } from "./parse-port-DxlKuJRE.js";
import { f as resolveGatewayPort, t as CONFIG_PATH } from "./paths-DEklnbzU.js";
import { s as resolvePluginContributionOwners } from "./plugin-registry-BckMdz4f.js";
...
import { t as resolvePreferredProviderForAuthChoice } from "./provider-auth-choice-preference-CXeOGofu.js";
...
import {
  a as resolveGatewayService,
  t as describeGatewayServiceRestart,
} from "./service-Dw37Ek79.js";
import { t as resolveSetupSecretInputString } from "./setup.secret-input-CSZyNx9j.js";
import { t as mergeWizardConfigOntoLatest } from "./setup.shared-p7f7ug1s.js";
...
import { r as isNonFatalSystemdInstallProbeError } from "./systemd-BI3sgDKJ.js";
import { t as ensureSystemdUserLingerInteractive } from "./systemd-linger-B85eNUhO.js";
import { a as findTailscaleBinary } from "./tailscale-DdW1pRs5.js";
import { d as isValidEnvSecretRefId, l as isSecretRef } from "./types.secrets-BV0ywRAy.js";
import { h as shortenHomePath } from "./utils-DtcDeqWS.js";
import { t as formatWindowsGatewayFirewallGuidance } from "./windows-gateway-firewall-diagnostics-Cwjm2Cse.js";
    ...
    if (
      ...
      gatewayTokenForCalls =
        normalizeGatewayTokenInput(
          guardCancel(await password({ message: "Gateway token (blank to generate)" }), runtime),
        ) || randomToken();
...
const setupPluginConfigModuleLoader = createLazyImportLoader(
  () => import("./setup.plugin-config-Dp8DjkcG.js"),
);
...
async function promptWebToolsConfig(nextConfig, runtime, prompter) {
  ...
  const { isCodexNativeWebSearchRelevant } = await import("./codex-native-web-search-B25OQCJ0.js");
  ...
  if (enableSearch) {
    ...
    if (configureManagedProvider) {
      const { resolveSearchProviderOptions, setupSearch } =
        await import("./onboard-search-CIFl14rz.js");
