...
declare function resolveDiscordPrivilegedIntentsFromFlags(
  flags: number,
): DiscordPrivilegedIntentsSummary;
declare function fetchDiscordApplicationSummary(
  token: string,
  timeoutMs: number,
  fetcher?: typeof fetch,
): Promise<DiscordApplicationSummary | undefined>;
declare function probeDiscord(
  token: string,
  timeoutMs: number,
  opts?: {
    fetcher?: typeof fetch;
...
declare function fetchDiscordApplicationId(
  token: string,
  timeoutMs: number,
  fetcher?: typeof fetch,
...
//#endregion
export {
  fetchDiscordApplicationId as a,
  probeDiscord as c,
  DiscordProbe as i,
  resolveDiscordPrivilegedIntentsFromFlags as l,
  DiscordPrivilegedIntentStatus as n,
  fetchDiscordApplicationSummary as o,
  DiscordPrivilegedIntentsSummary as r,
  parseApplicationIdFromToken as s,
  DiscordApplicationSummary as t,
};
