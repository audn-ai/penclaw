...
} from "./doctor-contract-DdOiWoTq.js";
...
const TlonAuthorizationSchema = object({
  channelRules: record(string(), TlonChannelRuleSchema).optional(),
});
const TlonNetworkSchema = object({ dangerouslyAllowPrivateNetwork: boolean().optional() })
  .strict()
  .optional();
...
const loadTlonChannelRuntime = createLazyRuntimeModule(
  () => import("./channel.runtime-D81xk4xZ.js"),
);
