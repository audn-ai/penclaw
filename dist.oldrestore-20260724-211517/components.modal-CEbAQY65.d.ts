import {
  A as MessageType,
  At as APIRole,
  D as APITextDisplayComponent,
  E as APIMessageReference,
  I as APIGuild,
  O as APITextInputComponent,
  S as APIAttachment,
  T as APIMessage,
  Z as APIStickerItem,
  a as MessagePayload,
  ...
  d as APIApplicationCommandInteraction,
  g as APIApplicationCommandInteractionDataOption,
  gt as APINewsChannel,
  h as APIApplicationCommandInteractionDataBasicOption,
  ht as APIGuildVoiceChannel,
  j as TextInputStyle,
  k as ComponentType,
  kt as APIUser,
  l as APIMessageComponentInteraction,
  ...
  v as APIInteractionDataResolvedChannel,
  vt as APIPrivateThreadChannel,
  w as APIEmbed,
  y as InteractionResponseType,
  yt as APIPublicThreadChannel,
  z as APIGuildMember,
} from "./send.shared-B9tglP0k.js";
import { C as RequestClient } from "./send.types-BuaFrE-z.js";
...
declare class BaseInteraction {
  ...
  defer(options?: { ephemeral?: boolean }): Promise<unknown>;
...
export {
  ComponentData as a,
  AutocompleteInteraction as c,
  Message as d,
  User as f,
  BaseMessageInteractiveComponent as i,
  Guild as l,
  Modal as n,
  ComponentParserResult as o,
  TextDisplay as r,
  parseCustomId as s,
  Label as t,
  GuildMember as u,
