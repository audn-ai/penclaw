...
function resolveWindowsExecutablePath(command, env) {
  ...
  const pathEntries = normalizeStringEntries(
    (env.PATH ?? env.Path ?? process.env.PATH ?? process.env.Path ?? "").split(";"),
  );
...
//#endregion
export {
  resolveWindowsSpawnProgram as a,
  resolveWindowsExecutablePath as i,
  detectWindowsSpawnCommandInlineArgs as n,
  resolveWindowsSpawnProgramCandidate as o,
  materializeWindowsSpawnProgram as r,
