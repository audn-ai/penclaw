...
>;
declare function resolvePathsWithinRoot(
  params: ResolvePathsWithinRootParams,
): ResolvePathsWithinRootResult;
declare function resolveExistingPathsWithinRoot(
  params: ResolvePathsWithinRootParams,
): Promise<ResolvePathsWithinRootResult>;
declare function resolveStrictExistingPathsWithinRoot(
  params: ResolvePathsWithinRootParams,
): Promise<ResolvePathsWithinRootResult>;
...
declare function writeSiblingTempFile<T>(
...
declare function testRegexWithBoundedInput(
  regex: RegExp,
  input: string,
  maxWindow?: number,
): boolean;
...
type ReplaceFileAtomicSyncFileSystem = Pick<
  typeof fs,
  | "mkdirSync"
  | "chmodSync"
  | "readFileSync"
...
declare function replaceFileAtomic$1(
  options: ReplaceFileAtomicOptions,
): Promise<ReplaceFileAtomicResult>;
declare function replaceFileAtomicSync(
...
declare function safeEqualSecret(
...
export {
  pathScope as A,
  WriteSiblingTempFileOptions as C,
  AssertNoSymlinkParentsOptions as D,
  writeViaSiblingTempPath as E,
  resolveWritablePathWithinRoot as F,
  resolvePathWithinRoot as M,
  resolvePathsWithinRoot as N,
  assertNoSymlinkParents as O,
  resolveStrictExistingPathsWithinRoot as P,
  buildUntrustedChannelMetadata as S,
  writeSiblingTempFile as T,
  SafeRegexRejectReason as _,
  movePathWithCopyFallback as a,
  hasNestedRepetition as b,
  ReplaceFileAtomicOptions as c,
  ReplaceFileAtomicSyncOptions as d,
  replaceFileAtomicSync as f,
  SafeRegexCompileResult as g,
  privateFileStoreSync as h,
  MovePathWithCopyFallbackOptions as i,
  resolveExistingPathsWithinRoot as j,
  assertNoSymlinkParentsSync as k,
  ReplaceFileAtomicResult as l,
  privateFileStore as m,
  writeFileFromPathWithinRoot as n,
  replaceFileAtomic as o,
  PrivateFileStore as p,
  safeEqualSecret as r,
  ReplaceFileAtomicFileSystem as s,
  openFileWithinRoot as t,
  ReplaceFileAtomicSyncFileSystem as u,
  compileSafeRegex as v,
  WriteSiblingTempFileResult as w,
  testRegexWithBoundedInput as x,
  compileSafeRegexDetailed as y,
};
