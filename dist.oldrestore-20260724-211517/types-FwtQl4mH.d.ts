...
declare const durableFinalDeliveryCapabilities: readonly [
  "text",
  "media",
  "poll",
  "payload",
...
type ChannelMessageSendTextContext<TConfig = OpenClawConfig> = {
  ...
  deliveryPartIndex?: number /** @internal Refresh durable timing before recipient-visible or finalizing platform I/O. */;
...
type ChannelMessageSendMediaContext<TConfig = OpenClawConfig> =
...
type ChannelMessageSendPayloadContext<TConfig = OpenClawConfig> =
  ChannelMessageSendTextContext<TConfig> & {
...
type ChannelMessageSendPollContext<TConfig = OpenClawConfig> = Omit<
  ChannelMessageSendTextContext<TConfig>,
  "text" | "threadId"
> & {
  poll: PollInput;
...
declare const unknownSendReconciliationKinds: readonly [
  "text",
  "media",
  "payload",
  "poll",
...
type ChannelMessageSendAttemptContext<TConfig = OpenClawConfig> =
  | (ChannelMessageSendTextContext<TConfig> & {
      kind: "text";
    })
...
type ChannelMessageDurableFinalAdapter = {
  ...
  ) => ChannelMessageDeferredDeliveryAdmissionResult /** Send shapes for which reconciliation can prove the complete durable intent. */;
...
declare const livePreviewFinalizerCapabilities: readonly [
  "finalEdit",
  "normalFallback",
  "discardPending",
  "previewReceipt",
...
//#endregion
export {
  LiveMessageState as A,
  RenderedMessageBatchPlan as B,
  DeriveDurableFinalDeliveryRequirementsParams as C,
  DurableFinalRequirementExtras as D,
  DurableFinalDeliveryRequirementMap as E,
  MessageReceiptPart as F,
  RenderedMessageBatchPlanKind as H,
  MessageReceiptPartKind as I,
  MessageReceiptSourceResult as L,
  LivePreviewFinalizerCapabilityMap as M,
  MessageDurabilityPolicy as N,
  DurableMessageSendIntent as O,
  MessageReceipt as P,
  MessageSendContext as R,
  ChannelMessageUnknownSendReconciliationResult as S,
  DurableFinalDeliveryPayloadShape as T,
  RenderedMessageBatchPlanItem as V,
  ChannelMessageSendPollContext as _,
  ChannelMessageLiveCapability as a,
  ChannelMessageSendTextContext as b,
  ChannelMessageReceiveAdapterShape as c,
  ChannelMessageSendAttemptKind as d,
  ChannelMessageSendCommitContext as f,
  ChannelMessageSendPayloadContext as g,
  ChannelMessageSendMediaContext as h,
  ChannelMessageLiveAdapterShape as i,
  LivePreviewFinalizerCapability as j,
  LiveMessagePhase as k,
  ChannelMessageSendAdapter as l,
  ChannelMessageSendLifecycleAdapter as m,
  ChannelMessageAdapterShape as n,
  ChannelMessageLiveFinalizerAdapterShape as o,
  ChannelMessageSendFailureContext as p,
  ChannelMessageDurableFinalAdapter as r,
  ChannelMessageReceiveAckPolicy as s,
  ChannelMessageAdapter as t,
  ChannelMessageSendAttemptContext as u,
  ChannelMessageSendResult as v,
  DurableFinalDeliveryCapability as w,
  ChannelMessageUnknownSendContext as x,
  ChannelMessageSendSuccessContext as y,
  RenderedMessageBatch as z,
};
