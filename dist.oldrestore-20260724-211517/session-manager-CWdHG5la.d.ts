import { C as TextContent, d as Message, l as ImageContent } from "./types-CqrbBnUB.js";
import {
  b as CustomMessage,
 ...
 */
declare function buildSessionContext(
 ...
 */
declare function normalizeLoadedFileEntry(entry: FileEntry): FileEntry;
/** Exported for testing */
...
declare class SessionManager {
  ...
  private replacePersistedTranscript;
  isPersisted(): boolean;
  getCwd(): string;
...
//#endregion
export {
  getDefaultSessionDir as C,
  normalizeLoadedFileEntry as D,
  migrateSessionEntries as E,
  parseSessionEntries as O,
  findMostRecentSession as S,
  loadEntriesFromFile as T,
  SessionManager as _,
  FileEntry as a,
  ThinkingLevelChangeEntry as b,
  NewSessionOptions as c,
  SessionEntry as d,
  SessionEntryBase as f,
  SessionListProgress as g,
  SessionInfoEntry as h,
  CustomMessageEntry as i,
  CURRENT_SESSION_VERSION as k,
  ReadonlySessionManager as l,
  SessionInfo as m,
  CompactionEntry as n,
  LabelEntry as o,
  SessionHeader as p,
  CustomEntry as r,
  ModelChangeEntry as s,
  BranchSummaryEntry as t,
  SessionContext as u,
  SessionMessageEntry as v,
  getLatestCompactionEntry as w,
  buildSessionContext as x,
  SessionTreeNode as y,
};
