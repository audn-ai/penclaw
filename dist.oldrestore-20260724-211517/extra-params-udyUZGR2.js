import { i as isNativeWebSearchAllowedByToolPolicy } from "./codex-native-web-search-core-DGXC1P49.js";
...
import { P as resolveModelExtraParamSources } from "./openai-routing-Cu28Ynzk.js";
import {
  d as resolveMaxTokensParam,
  u as canonicalizeMaxTokensParam,
} from "./openai-transport-stream-BFFr80cz.js";
import {
  o as resolveProviderExtraParamsForTransport,
  p as wrapProviderStreamFn,
  r as prepareProviderExtraParams,
...
import {
  d as createThinkingOnlyFinalTextWrapper,
  i as createDeepSeekV4OpenAICompatibleThinkingWrapper,
  k as streamWithPayloadPatch,
  o as createGoogleThinkingPayloadWrapper,
} from "./provider-stream-shared-CMy-5I0G.js";
import {
  g as createOpenAIStringContentWrapper,
  l as createOpenAICompletionsStrictMessageKeysWrapper,
  m as createOpenAIResponsesContextManagementWrapper,
  n as createOpenRouterSystemCacheWrapper,
  o as createMinimaxThinkingDisabledWrapper,
  u as createOpenAICompletionsToolsCompatWrapper,
  w as resolveAnthropicCacheRetentionFamily,
...
function createStreamFnWithExtraParams(baseStreamFn, extraParams, provider, model) {
  ...
  if (
    ...
    streamParams.responseFormat = resolvedResponseFormat;
...
const MIMO_REASONING_AS_VISIBLE_TEXT_MODEL_IDS = /* @__PURE__ */ new Set([
  "mimo-v2-pro",
  "mimo-v2-omni",
]);
...
export {
  ...
  isGooglePromptCacheEligible as o,
  resolveExplicitSettingsTransport as r,
  resolveCacheRetention as s,
