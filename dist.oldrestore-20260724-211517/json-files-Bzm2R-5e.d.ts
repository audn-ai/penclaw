...
type WriteJsonOptions = Pick<
  WriteTextAtomicOptions$1,
...
declare function writeTextAtomic(
  filePath: string,
  content: string,
...
//#endregion
export {
  readJsonFileStrict as a,
  writeTextAtomic as c,
  readRootJsonObjectSync as d,
  readRootJsonSync as f,
  writeJsonSync as g,
  writeJson as h,
  readJsonFile as i,
  JsonFileReadError as l,
  tryReadJsonSync as m,
  readDurableJsonFile as n,
  readJsonIfExists as o,
  readRootStructuredFileSync as p,
  readJson as r,
  tryReadJson as s,
  WriteTextAtomicOptions as t,
  readJsonSync as u,
};
