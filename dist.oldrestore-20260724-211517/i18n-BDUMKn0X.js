...
const LOCALES = {
  en: {
    ...
    wizard: {
      ...
      zalouser: {
        ...
        couldNotResolve:
          "Could not resolve: {entries}. Use numeric user ids or exact friend names.",
  ...
  "zh-CN": {
    ...
    wizard: {
      ...
      line: {
        allowFromInvalid:
          "LINE allowFrom 需要原始用户 ID，例如 U1234567890abcdef1234567890abcdef。",
      ...
      msteams: {
        ...
        envPrompt:
          "检测到 MSTEAMS_APP_ID + MSTEAMS_APP_PASSWORD + MSTEAMS_TENANT_ID。使用环境变量？",
        examples: "示例：",
      ...
      twitch: {
        ...
        helpTokenTools:
          "   可使用 https://twitchtokengenerator.com/ 或 https://twitchapps.com/tmi/",
        oauthTokenPrompt: "Twitch OAuth token（oauth:...）",
        refreshTokenInputPrompt: "Twitch Refresh Token",
      ...
      finalize: {
        ...
        daemonRuntimeNodeHint:
          "OpenClaw 状态使用 node:sqlite，因此必须使用 Node；Bun 无法运行网关。",
  ...
  "zh-TW": {
    ...
    wizard: {
      ...
      remote: {
        ...
        loopbackSshHint:
          "如果 Gateway 僅監聽 loopback，請選擇 SSH 通道並保持 ws://127.0.0.1:18789。",
      ...
      msteams: {
        ...
        envPrompt:
          "偵測到 MSTEAMS_APP_ID + MSTEAMS_APP_PASSWORD + MSTEAMS_TENANT_ID。使用環境變數？",
        examples: "範例：",
      ...
      finalize: {
        ...
        daemonRuntimeNodeHint:
          "OpenClaw 狀態使用 node:sqlite，因此必須使用 Node；Bun 無法執行閘道。",
...
function wizardT(key, params, options) {
  ...
  return interpolate(
    readKey(LOCALES[locale], key) ?? readKey(LOCALES[WIZARD_DEFAULT_LOCALE], key) ?? key,
    params,
  );
}
const t = wizardT;
