...
import {
  a as ChannelSetupWizardCredentialValues,
  c as PromptAccountId,
  i as ChannelSetupWizardAllowFromEntry,
  n as ChannelSetupWizard,
  o as ChannelSetupWizardStatus,
  s as ChannelSetupWizardTextInput,
  t as ChannelSetupDmPolicy,
} from "./setup-wizard-types-BkGT_-Ru.js";
import { g as DmPolicy, v as GroupPolicy } from "./types.base-ibSxQuK3.js";
...
declare function mergeAllowFromEntries(
...
declare function parseSetupEntriesWithParser(
  raw: string,
...
declare function parseSetupEntriesAllowingWildcard(
  raw: string,
  parseEntry: (entry: string) => ParsedSetupEntry,
): {
  entries: string[];
...
declare function normalizeAllowFromEntries(
...
declare function setSetupChannelEnabled(
  cfg: OpenClawConfig,
  channel: string,
  enabled: boolean,
): OpenClawConfig;
 ...
 */
declare function createDelegatedResolveConfigured(
  loadWizard: () => Promise<ChannelSetupWizard>,
): ({ cfg, accountId }: ResolveConfiguredParams) => Promise<boolean>;
/**
 * Delegates setup preparation to a lazily loaded wizard.
 */
declare function createDelegatedPrepare(loadWizard: () => Promise<ChannelSetupWizard>): (
 ...
 */
declare function createDelegatedFinalize(loadWizard: () => Promise<ChannelSetupWizard>): (
 ...
 */
declare function createDelegatedSetupWizardStatusResolvers(
  loadWizard: () => Promise<ChannelSetupWizard>,
): Pick<
  ChannelSetupWizardStatus,
...
//#endregion
export {
  setLegacyChannelDmPolicyWithAllowFrom as $,
  noteChannelLookupSummary as A,
  promptParsedAllowFromForAccount as B,
  createTopLevelChannelDmPolicy as C,
  mergeAllowFromEntries as D,
  createTopLevelChannelParsedAllowFromPrompt as E,
  patchNestedChannelConfigSection as F,
  resolveGroupAllowlistWithLookupNotes as G,
  promptResolvedAllowFrom as H,
  patchTopLevelChannelConfigSection as I,
  runSingleChannelSecretStep as J,
  resolveParsedAllowFromEntries as K,
  promptAccountId as L,
  parseSetupEntriesAllowingWildcard as M,
  parseSetupEntriesWithParser as N,
  normalizeAllowFromEntries as O,
  patchChannelConfigForAccount as P,
  setChannelDmPolicyWithAllowFrom as Q,
  promptLegacyChannelAllowFrom as R,
  createTopLevelChannelAllowFromSetter as S,
  createTopLevelChannelGroupPolicySetter as T,
  promptSingleChannelSecretInput as U,
  promptParsedAllowFromForScopedChannel as V,
  resolveEntriesWithOptionalToken as W,
  setAccountDmAllowFromForChannel as X,
  setAccountAllowFromForChannel as Y,
  setAccountGroupPolicyForChannel as Z,
  createNestedChannelDmPolicy as _,
  createAllowlistSetupWizardProxy as a,
  setTopLevelChannelGroupPolicy as at,
  createPromptParsedAllowFromForAccount as b,
  createDelegatedResolveConfigured as c,
  createSetupTranslator as ct,
  buildSingleChannelSecretPromptState as d,
  setNestedChannelAllowFrom as et,
  createAccountScopedAllowFromSection as f,
  createNestedChannelAllowFromSetter as g,
  createLegacyCompatChannelDmPolicy as h,
  createDetectedBinaryStatus as i,
  setTopLevelChannelDmPolicyWithAllowFrom as it,
  parseMentionOrPrefixedId as j,
  noteChannelLookupFailure as k,
  createDelegatedSetupWizardProxy as l,
  WizardI18nParams as lt,
  createAllowFromSection as m,
  createDelegatedSetupWizardStatusResolvers as n,
  setSetupChannelEnabled as nt,
  createDelegatedFinalize as o,
  splitSetupEntries as ot,
  createAccountScopedGroupAccessSection as p,
  resolveSetupAccountId as q,
  createDelegatedTextInputShouldPrompt as r,
  setTopLevelChannelAllowFrom as rt,
  createDelegatedPrepare as s,
  SetupTranslator as st,
  createCliPathTextInput as t,
  setNestedChannelDmPolicyWithAllowFrom as tt,
  addWildcardAllowFrom as u,
  createNestedChannelDmPolicySetter as v,
  createTopLevelChannelDmPolicySetter as w,
  createStandardChannelSetupStatus as x,
  createNestedChannelParsedAllowFromPrompt as y,
  promptLegacyChannelAllowFromForAccount as z,
};
