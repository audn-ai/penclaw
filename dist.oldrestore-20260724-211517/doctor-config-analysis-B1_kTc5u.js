...
function stripUnknownConfigKeys(config) {
  ...
  for (const issue of parsed.error.issues) {
    ...
    const record = target;
    const parentKey =
      issuePath.length === 1 && typeof issuePath[0] === "string" ? issuePath[0] : void 0;
    const protectedSet =
      issuePath.length === 0
...
//#endregion
export {
  resolveConfigPathTarget as a,
  noteOpencodeProviderOverrides as i,
  noteImplicitFallbackClobberWarnings as n,
  stripUnknownConfigKeys as o,
  noteIncludeConfinementWarning as r,
