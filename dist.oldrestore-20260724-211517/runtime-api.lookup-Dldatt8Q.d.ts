...
declare function listDiscordDirectoryGroupsLive(
  params: DirectoryConfigParams,
): Promise<ChannelDirectoryEntry[]>;
declare function listDiscordDirectoryPeersLive(
  params: DirectoryConfigParams,
): Promise<ChannelDirectoryEntry[]>;
//#endregion
...
//#endregion
export {
  listDiscordDirectoryGroupsLive as a,
  collectDiscordAuditChannelIds as c,
  resolveDiscordChannelAllowlist as i,
  resolveDiscordUserAllowlist as n,
  listDiscordDirectoryPeersLive as o,
  DiscordChannelResolution as r,
  auditDiscordChannelPermissions as s,
  DiscordUserResolution as t,
};
