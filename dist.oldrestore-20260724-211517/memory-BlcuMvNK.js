...
import { o as resolveMemoryCoreLocalServiceHostIdentity } from "./manager-tb_prRdP.js";
...
const managerRuntimeLoader = createLazyRuntimeModule(
  () => import("./extensions/memory-core/manager-runtime.js"),
);
const loadManagerRuntime = managerRuntimeLoader;
const loadQmdManagerModule = createLazyRuntimeModule(() => import("./qmd-manager-CWNRKn9D.js"));
...
function buildQmdManagerIdentityKey(agentId, config, runtimeConfig, acquireLocalService) {
...
//#endregion
export {
  closeMemorySearchManager as n,
  getMemorySearchManager as r,
