import {
  Di as $brand,
  Fi as $ZodFormattedError,
  Ii as $ZodIssue,
  Mi as output,
  Ni as $ZodErrorMap,
  Pi as $ZodFlattenedError,
  Yi as $ZodShape,
  Zi as $ZodType,
...
type inferFormattedError<T extends $ZodType<any, any>, U = string> = $ZodFormattedError<
  output<T>,
  U
>;
/** Use `z.$brand` instead */
...
export {
  ...
  inferFlattenedErrors as o,
  ZodIssueCode as r,
  inferFormattedError as s,
  BRAND as t,
};
