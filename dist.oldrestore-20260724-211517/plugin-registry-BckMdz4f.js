...
import { n as resolveBundledPluginsDir } from "./bundled-dir-CehpKn-r.js";
...
import {
  d as buildLegacyBundledRootPath,
  l as listBundledSourceOverlayDirs,
  t as discoverConfiguredPluginLoadPaths,
} from "./discovery-Df2IhoW5.js";
import { t as expectDefined } from "./expect-CyE8FADM.js";
import { c as resolveUserPath } from "./home-dir-DxrrpDft.js";
import {
  c as hasMissingConfigPathActivationMetadata,
  d as hasOptionalMissingPluginManifestFile,
  f as extractPluginInstallRecordsFromInstalledPluginIndex,
  g as hashJson,
  h as fileSignatureMatches,
  i as loadInstalledPluginIndexWithDiscovery,
  m as resolveInstalledPluginIndexPolicyHash,
  n as isInstalledPluginEnabled,
  t as getInstalledPluginRecord,
...
import {
  a as refreshPersistedInstalledPluginIndex,
...
import { r as getPackageManifestMetadata } from "./manifest-DnFAzqZi.js";
import { t as loadPluginManifestRegistry } from "./manifest-registry-CXy9BBfE.js";
import { t as loadPluginManifestRegistryForInstalledIndex } from "./manifest-registry-installed-CdFNhCi1.js";
...
function canMemoizePluginRegistrySnapshot(params) {
  return (
    params.index === void 0 &&
    params.candidates === void 0 &&
    params.diagnostics === void 0 &&
    params.discovery === void 0 &&
    params.installRecords === void 0 &&
    params.now === void 0 &&
    params.filePath === void 0 &&
    params.pluginIndexFilePath === void 0
  );
}
function resolvePluginRegistrySnapshotMemoKey(params, env) {
  if (!canMemoizePluginRegistrySnapshot(params)) return;
  const persistedRegistryFingerprint =
...
function isPathInsideOrEqual(childPath, parentPath) {
  return isRelativePathInsideOrEqual(
    path.relative(resolveComparablePath(parentPath), resolveComparablePath(childPath)),
  );
}
...
function sourcePluginOptsOutOfBundledDist(pluginRootDir) {
  return (
    getPackageManifestMetadata(tryReadJsonSync(path.join(pluginRootDir, "package.json")) ?? void 0)
...
function resolveRecordPackageJsonPath(plugin) {
  ...
  return isRelativePathInsideOrEqual(
    path.relative(resolveComparablePath(rootDir), resolveComparablePath(resolved)),
  )
    ? resolved
    : null;
}
...
function canReuseCurrentManifestRegistry(params) {
  return (
    params.bundledChannelConfigCollector === void 0 &&
    params.index === void 0 &&
    params.preferPersisted !== false &&
    params.stateDir === void 0 &&
    params.filePath === void 0 &&
