...
} from "./fetch-headers-DPnOMwOE.js";
...
import { i as isMockedFetch, n as fetchWithRuntimeDispatcher } from "./runtime-fetch-0IXFHW_8.js";
import {
...
import { o as globalUndiciStreamTimeoutMs } from "./undici-global-dispatcher-BoVfmODy.js";
import {
...
async function captureGuardedFetchExchange(params) {
  ...
  const { captureHttpExchange, isDebugProxyGlobalFetchPatchInstalled } =
    await import("./runtime-C1OWSrpp.js");
...
async function fetchConfiguredLocalOriginWithSsrFGuard({
      ...
      if (canUseTrustedEnvProxy) dispatcher = createHttp1EnvHttpProxyAgent(void 0, timeoutMs);
        ...
        if (shouldCheckManagedProxyBypass) {
          ...
          dispatcher = shouldUseConfiguredLocalOriginManagedProxyBypass({
            ...
            : createHttp1EnvHttpProxyAgent(void 0, timeoutMs);
...
//#endregion
export {
  withStrictGuardedFetchMode as a,
  retainSafeHeadersForCrossOriginRedirectHeaders as i,
  fetchConfiguredLocalOriginWithSsrFGuard as n,
  withTrustedEnvProxyGuardedFetchMode as o,
  fetchWithSsrFGuard as r,
  withTrustedExplicitProxyGuardedFetchMode as s,
