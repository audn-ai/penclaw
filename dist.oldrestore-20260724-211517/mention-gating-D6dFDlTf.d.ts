...
declare function implicitMentionKindWhen(
  kind: InboundImplicitMentionKind,
  enabled: boolean,
): InboundImplicitMentionKind[];
declare function resolveInboundMentionDecision(
...
/** @deprecated Prefer `resolveInboundMentionDecision({ facts, policy })`. */
declare function resolveMentionGatingWithBypass(
  params: MentionGateWithBypassParams,
): MentionGateWithBypassResult;
//#endregion
export {
  MentionGateParams as a,
  MentionGateWithBypassResult as c,
  ResolveInboundMentionDecisionParams as d,
  implicitMentionKindWhen as f,
  resolveMentionGatingWithBypass as h,
  InboundMentionPolicy as i,
  ResolveInboundMentionDecisionFlatParams as l,
  resolveMentionGating as m,
  InboundMentionDecision as n,
  MentionGateResult as o,
  resolveInboundMentionDecision as p,
  InboundMentionFacts as r,
  MentionGateWithBypassParams as s,
  InboundImplicitMentionKind as t,
  ResolveInboundMentionDecisionNestedParams as u,
};
