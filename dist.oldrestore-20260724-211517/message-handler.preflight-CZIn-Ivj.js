...
import { o as resolveDefaultDiscordAccountId } from "./accounts-BNPpAWWI.js";
import {
...
import { i as matchesMentionWithExplicit, n as buildMentionRegexes } from "./mentions-BFTjjd4G.js";
import {
  a as resolveForwardedMediaList,
  d as resolveDiscordMessageChannelId,
  l as resolveDiscordMessageStickers,
  o as resolveMediaList,
  r as resolveDiscordMessageText,
  u as resolveDiscordChannelInfo,
} from "./message-utils-prcoeLfb.js";
import { l as mimeTypeFromFilePath } from "./mime-BSEMEb3s.js";
import {
  a as shouldIgnoreStaleDiscordRouteBinding,
  c as resolveDiscordTextCommandAccess,
...
} from "./sender-identity-dZhk6b7k.js";
import "./thread-bindings-DlQfHcQe.js";
...
import { d as isRecentlyUnboundThreadWebhookMessage } from "./thread-bindings.state-Da_kQ-2B.js";
import {
...
const loadConversationRuntime$1 = createLazyRuntimeModule(
  () => import("./plugin-sdk/conversation-binding-runtime.js"),
);
const loadDiscordSendRuntime = createLazyRuntimeModule(() => import("./send-CUIGrZnM.js"));
...
const loadPluralKitRuntime = createLazyRuntimeModule(() => import("./pluralkit-Cd7EikDJ.js"));
const loadPreflightAudioRuntime = createLazyRuntimeModule(
  () => import("./preflight-audio-BquWt5TI.js"),
);
const loadSystemEventsRuntime = createLazyRuntimeModule(
  () => import("./system-events-BmK65Ndf.js"),
);
const loadDiscordThreadingRuntime = createLazyRuntimeModule(
  () => import("./threading-DzGmuf4Q.js"),
);
...
function isDiscordImageAttachmentCandidate(attachment) {
  if (attachment.content_type?.split(";")[0]?.trim().toLowerCase()?.startsWith("image/"))
    return true;
  return Boolean(
...
async function preflightDiscordMessage(params) {
  ...
  if (botLoopProtection) {
    ...
    if (botLoopResult.suppressed) {
      logVerbose(
        `discord: bot-to-bot loop detected before media download, suppressing for ${Math.max(0, Math.ceil((botLoopResult.cooldownUntilMs - Date.now()) / 1e3))}s`,
      );
      return null;
    }
  }
