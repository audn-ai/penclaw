...
const WorkerInferenceContextSchema = workerInferenceObject({
  ...
  tools: Type.Optional(Type.Array(WorkerInferenceToolSchema, { maxItems: 256 })),
});
...
//#endregion
export {
  validateWorkerInferenceTerminalOutcome as A,
  WorkerInferenceTerminalFrameSchema as C,
  validateWorkerInferenceEventFrame as D,
  validateWorkerInferenceCancelParams as E,
  validateWorkerInferenceStartParams as O,
  WorkerInferenceStartResultSchema as S,
  WorkerInferenceTerminalParamsSchema as T,
  WorkerInferenceOptionsSchema as _,
  WORKER_INFERENCE_PROTOCOL_FEATURE as a,
  WorkerInferenceStartRequestFrameSchema as b,
  WorkerInferenceCancelRequestFrameSchema as c,
  WorkerInferenceContextSchema as d,
  WorkerInferenceErrorReasonSchema as f,
  WorkerInferenceModelRefSchema as g,
  WorkerInferenceEventParamsSchema as h,
  WORKER_INFERENCE_METHODS as i,
  validateWorkerInferenceTerminalFrame as k,
  WorkerInferenceCancelResponseFrameSchema as l,
  WorkerInferenceEventFrameSchema as m,
  WORKER_INFERENCE_MAX_OUTPUT_TOKENS as n,
  WORKER_PROTOCOL_MAX_INFERENCE_PAYLOAD_BYTES as o,
  WorkerInferenceErrorShapeSchema as p,
  WORKER_INFERENCE_MAX_TOOLS as r,
  WorkerInferenceCancelParamsSchema as s,
  WORKER_INFERENCE_MAX_CONTEXT_MESSAGES as t,
  WorkerInferenceCancelResultSchema as u,
  WorkerInferenceResolvedModelSchema as v,
  WorkerInferenceTerminalOutcomeSchema as w,
  WorkerInferenceStartResponseFrameSchema as x,
  WorkerInferenceStartParamsSchema as y,
};
