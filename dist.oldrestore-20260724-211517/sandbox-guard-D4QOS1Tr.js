...
const BLOCKED_DIRECT_METHOD_PREFIXES = ["command/", "fs/", "windowsSandbox/"];
const NODE_EXEC_BLOCKED_CONTROL_PLANE_METHODS = /* @__PURE__ */ new Set([
...
//#endregion
export {
  resolveCodexNodeExecToolOverrides as a,
  resolveCodexNativeExecutionPolicy as i,
  resolveCodexNativeExecutionBlock as n,
  resolveCodexNativeSandboxBlock as r,
  resolveCodexAppServerDirectSandboxBypassBlock as t,
};
