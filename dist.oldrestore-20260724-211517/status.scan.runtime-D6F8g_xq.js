...
import { t as hasConfiguredUnavailableCredentialStatus } from "./account-snapshot-fields-DYiq0cA9.js";
import { t as sanitizeForLog } from "./ansi-D4OHEz5F.js";
import { a as listExplicitConfiguredChannelIdsForConfig } from "./channel-presence-policy-5sGDOKpp.js";
import "./channel-plugin-ids-B1yGqL5H.js";
import { t as collectChannelStatusIssues } from "./channels-status-issues-DjgExlwq.js";
...
import { t as resolveMissingOfficialExternalChannelPluginRepairHint } from "./official-external-plugin-repair-hints-Beaxrb9C.js";
import {
  n as hasRuntimeCredentialAvailable,
  r as markConfiguredUnavailableCredentialStatusesAvailable,
  t as getRuntimeChannelAccounts,
} from "./read-model-BIGLvUmD.js";
import { r as resolveReadOnlyChannelPluginsForConfig } from "./read-only-D7WTn1n5.js";
...
async function buildChannelsTable(cfg, opts) {
  ...
  const loadFailuresByChannel = new Map(
    readOnlyPlugins.loadFailures.map((failure) => [failure.channelId, failure]),
  );
  ...
  const explicitConfiguredChannelIds = /* @__PURE__ */ new Set([
    ...listExplicitConfiguredChannelIdsForConfig(sourceConfig),
    ...listExplicitConfiguredChannelIdsForConfig(cfg),
  ]);
