import { a as f, i as _e, n as ve, r as ye } from "./dist-D9GsM5qA.js";
import { a as pe, i as me, n as d, r as he, t as ge } from "./dist-DcfhWyQe.js";
import {
  A as n,
  E as r,
  L as i,
...
var be,
  ...
  Ae = e(() => {
    (pe(),
      ...
      (R = new d(
        (e, t) => {
          let { next: n } = e;
          (n == E || n == -1 || t.context) && e.acceptToken(y);
        },
      ...
      (xe = new d(
        (e, t) => {
          let { next: n } = e,
            r;
          T.indexOf(n) > -1 ||
            (n == O && ((r = e.peek(1)) == O || r == k)) ||
            (n != E && n != D && n != -1 && !t.context && e.acceptToken(be));
        },
        { contextual: !0 },
      )),
      (Se = new d(
        (e, t) => {
          e.next == I && !t.context && e.acceptToken(m);
        },
        { contextual: !0 },
      )),
      (Ce = new d(
        (e, t) => {
          ...
          if (n == A || n == j) {
            ...
            n == P &&
              e.peek(1) == F &&
              (e.advance(), e.advance(), (e.next < 48 || e.next > 57) && e.acceptToken(_));
        },
        { contextual: !0 },
      )),
      (we = new d((e, t) => {
        if (e.next != M || !t.dialectEnabled(w) || (e.advance(), e.next == O)) return;
        let n = 0;
        for (; T.indexOf(e.next) > -1;) (e.advance(), n++);
        if (p(e.next, !0)) {
          for (e.advance(), n++; p(e.next, !1);) (e.advance(), n++);
          for (; T.indexOf(e.next) > -1;) (e.advance(), n++);
          if (e.next == N) return;
          for (let t = 0; ; t++) {
            if (t == 7) {
              if (!p(e.next, !0)) return;
              break;
            }
      ...
      (Te = n({
        ...
        "CallExpression/VariableName TaggedTemplateExpression/VariableName": l.function(
          l.variableName,
        ),
      ...
      (ke = he.deserialize({
        ...
        tokenizers: [
          ...
          new me(`j~RQYZXz{^~^O(Q~~aP!P!Qd~iO(R~~`, 25, 323),
        ],
        topRules: { Script: [0, 7], SingleExpression: [1, 276], SingleClassItem: [2, 277] },
        dialects: { jsx: 0, ts: 15175 },
        dynamicPrecedences: { 80: 1, 82: 1, 94: 1, 169: 1, 199: 1 },
        specialized: [
          { term: 327, get: (e) => Ee[e] || -1 },
          { term: 343, get: (e) => De[e] || -1 },
          { term: 95, get: (e) => Oe[e] || -1 },
        ],
        tokenPrec: 15201,
      })));
  }),
  je = t({
    autoCloseTags: () => $,
    javascript: () => Pe,
    javascriptLanguage: () => K,
    jsxLanguage: () => Y,
    localCompletionSource: () => Ne,
    snippets: () => B,
    tsxLanguage: () => X,
    typescriptLanguage: () => J,
    typescriptSnippets: () => V,
  });
function z(e) {
  return (t, n) => {
...
function Me(e, t) {
  ...
  return (
    t.cursor(s.IncludeAnonymous).iterate((t) => {
      if (i) i = !1;
      else if (t.name) {
        let e = Re[t.name];
        if ((e && e(t, a)) || U.has(t.name)) return !1;
      } else if (t.to - t.from > 8192) {
        for (let n of Me(e, t.node)) r.push(n);
        return !1;
      }
    }),
    H.set(t, r),
...
function Ne(e) {
  let t = r(e.state).resolveInner(e.pos, -1);
  if (G.indexOf(t.name) > -1) return null;
  let n =
    t.name == `VariableName` || (t.to - t.from < 20 && W.test(e.state.sliceDoc(t.from, t.to)));
  if (!n && !e.explicit) return null;
  let i = [];
  for (let n = t; n; n = n.parent) U.has(n.name) && (i = i.concat(Me(e.state.doc, n)));
  return { options: i, from: n ? t.from : e.pos, validFor: W };
}
function Pe(e = {}) {
  let t = e.jsx ? (e.typescript ? X : Y) : e.typescript ? J : K,
    n = e.typescript ? V.concat(ze) : B.concat(Q);
  return new o(t, [
    K.data.of({ autocomplete: ye(G, ve(n)) }),
    K.data.of({ autocomplete: Ne }),
    e.jsx ? $ : [],
  ]);
}
function Fe(e) {
  ...
  Ve = e(() => {
    (Ae(),
      ...
      (B = [
        ...
        f("for (let ${index} = 0; ${index} < ${bound}; ${index}++) {\n	${}\n}", {
          label: `for`,
          detail: `loop`,
          type: `keyword`,
        }),
        f("for (let ${name} of ${collection}) {\n	${}\n}", {
          label: `for`,
          detail: `of loop`,
          type: `keyword`,
        }),
	...
	\${}
          ...
          { label: `do`, detail: `loop`, type: `keyword` },
        ),
        f(
          `while (\${}) {
	\${}
	...
	constructor(\${params}) {
        ...
        f('import {${names}} from "${module}"\n${}', {
          label: `import`,
          detail: `named`,
          type: `keyword`,
        }),
        f('import ${name} from "${module}"\n${}', {
          label: `import`,
          detail: `default`,
          type: `keyword`,
        }),
	...
	\${}
        ...
        f("type ${name} = ${type}", { label: `type`, detail: `definition`, type: `keyword` }),
        f(
          `enum \${name} {
	\${}
}`,
      ...
      (Re = {
        ...
        VariableDefinition(e, t) {
          e.matchContext(Le) || t(e, `variable`);
        },
        TypeDefinition(e, t) {
          t(e, `type`);
        },
      ...
      (K = oe.define({
        ...
        parser: ke.configure({
          props: [
            ue.add({
              IfStatement: u({ except: /^\s*({|else\b)/ }),
              TryStatement: u({ except: /^\s*({|catch\b|finally\b)/ }),
              LabeledStatement: te,
              SwitchBody: (e) => {
                let t = e.textAfter,
                  n = /^\s*\}/.test(t),
            ...
            ae.add({
              "Block ClassBody SwitchBody EnumBody ObjectExpression ArrayExpression ObjectType": se,
              BlockComment(e) {
              ...
              JSXElement(e) {
                ...
                let n = e.lastChild;
                return { from: t.to, to: n.type.isError ? e.to : n.from };
              },
              "JSXSelfClosingTag JSXOpenTag"(e) {
                let t = e.firstChild?.nextSibling,
                  n = e.lastChild;
      ...
      (q = {
        ...
        facet: le({ commentTokens: { block: { open: `{/*`, close: `*/}` } } }),
      }),
      (J = K.configure({ dialect: `ts` }, `typescript`)),
      (Y = K.configure({ dialect: `jsx`, props: [de.add((e) => (e.isTop ? [q] : void 0))] })),
      (X = K.configure(
        { dialect: `jsx ts`, props: [de.add((e) => (e.isTop ? [q] : void 0))] },
        `typescript`,
      )),
      (Z = (e) => ({ label: e, type: `keyword` })),
      (Q =
        `break case const continue default delete export extends false finally in instanceof let new return static super switch this throw true typeof var yield`
          .split(` `)
          .map(Z)),
      (ze = Q.concat([`declare`, `implements`, `private`, `protected`, `public`].map(Z))),
      (Be = typeof navigator == `object` && /Android\b/.test(navigator.userAgent)),
      ($ = a.inputHandler.of((e, t, n, i, a) => {
        if (
          (Be ? e.composing : e.compositionStarted) ||
          e.state.readOnly ||
          t != n ||
          (i != `>` && i != `/`) ||
          !K.isActiveAt(e.state, t, -1)
        )
          return !1;
        let o = a(),
          { state: s } = o,
          c = s.changeByRange((e) => {
            let { head: t } = e,
              n = r(s).resolveInner(t - 1, -1),
              a;
            if (
              (n.name == `JSXStartTag` && (n = n.parent),
              !(s.doc.sliceString(t - 1, t) != i || (n.name == `JSXAttributeValue` && n.to > t)))
            ) {
              if (i == `>` && n.name == `JSXFragmentTag`)
                return { range: e, changes: { from: t, insert: `</>` } };
              if (i == `/` && n.name == `JSXStartCloseTag`) {
                let e = n.parent,
                  r = e.parent;
                if (
                  r &&
                  e.from == t - 2 &&
                  ((a = Ie(s.doc, r.firstChild, t)) || r.firstChild?.name == `JSXFragmentTag`)
                ) {
                  let e = `${a}>`;
                  return { range: ee.cursor(t + e.length, -1), changes: { from: t, insert: e } };
                }
              } else if (i == `>`) {
                let r = Fe(n);
                if (
                  r &&
                  r.name == `JSXOpenTag` &&
                  !/^\/?>|^<\//.test(s.doc.sliceString(t, t + 2)) &&
                  (a = Ie(s.doc, r, t))
                )
                  return { range: e, changes: { from: t, insert: `</${a}>` } };
              }
            }
            return { range: e };
          });
        return c.changes.empty
          ? !1
          : (e.dispatch([o, s.update(c, { userEvent: `input.complete`, scrollIntoView: !0 })]), !0);
      })));
  });
export { Y as a, K as i, Ve as n, X as o, Pe as r, J as s, je as t };
//# sourceMappingURL=dist-DYfdSfYL.js.map
