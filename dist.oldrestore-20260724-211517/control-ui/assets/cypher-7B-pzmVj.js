...
e(() => {
  ((t = function (e) {
    ...
    (n = function (e) {
      ...
      if (t === `'`) return (e.match(/^.*?'/), `string`);
      if (/[{}\(\),\.;\[\]]/.test(t)) return ((a = t), `punctuation`);
    ...
    (d = {
      ...
      token: function (e, t) {
        ...
        if (
          ...
          r(t, `)`, e.column());
        else if (a === `[`) r(t, `]`, e.column());
        else if (a === `{`) r(t, `}`, e.column());
        else if (/[\]\}\)]/.test(a)) {
          for (; t.context && t.context.type === `pattern`;) i(t);
          t.context && a === t.context.type && i(t);
        } else
          a === `.` && t.context && t.context.type === `pattern`
            ? i(t)
...
export { d as cypher };
//# sourceMappingURL=cypher-7B-pzmVj.js.map
