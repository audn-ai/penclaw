...
e(() => {
  t = {
    common: {
      ...
      colorModeOption: `Mode de couleur\xA0: {mode}`,
    ...
    mcpApp: { title: `Application MCP`, unavailable: `Application MCP indisponible : {error}` },
    githubPreview: {
    ...
    channels: {
      ...
      refreshingStaleSnapshot: `Actualisation du statut du canal en arrière-plan ; affichage du dernier instantané réussi.`,
      hub: {
        ...
        noneConnected: `Aucun canal n’est encore connecté. Choisissez-en un ci-dessous pour commencer.`,
        partialSnapshot: `Certaines vérifications de canaux ne se sont pas terminées dans le délai imparti par l’interface.`,
        ...
        browseAllSubtitle: `Parcourez tous les canaux disponibles, y compris les plugins installables.`,
        runSetup: `Lancer la configuration`,
        saveBeforeSetup: `Vous avez des modifications non enregistrées dans la configuration des canaux. Enregistrez-les ou rechargez-les avant de lancer la configuration guidée.`,
      },
      setup: {
        ...
        doneBody: `Configuration enregistrée. Le Gateway recharge automatiquement le canal ; consultez sa carte pour voir son statut en temps réel.`,
        doneNoChangesTitle: `Aucune modification apportée`,
        doneNoChangesBody: `La configuration s’est terminée sans configurer de canal. Rien n’a été enregistré.`,
        whatsappScanTitle: `Associez WhatsApp en scannant le code QR`,
        whatsappScanHelp: `Sur votre téléphone, ouvrez WhatsApp → Paramètres → Appareils connectés → Connecter un appareil, puis scannez ce code.`,
      ...
      generic: { subtitle: `État et configuration du canal.` },
      discord: { title: `Discord`, subtitle: `Statut du bot et configuration du canal.` },
      googleChat: {
        title: `Google Chat`,
        subtitle: `Statut du webhook de l'API Chat et configuration du canal.`,
      },
      imessage: { title: `iMessage`, subtitle: `Statut du pont macOS et configuration du canal.` },
      signal: { title: `Signal`, subtitle: `Statut de signal-cli et configuration du canal.` },
      slack: { title: `Slack`, subtitle: `Statut du mode socket et configuration du canal.` },
      telegram: { title: `Telegram`, subtitle: `Statut du bot et configuration du canal.` },
      whatsapp: {
        title: `WhatsApp`,
    ...
    lazyView: {
      ...
      staleSubtitle: `OpenClaw a été mis à jour en arrière-plan. Rechargez la page pour obtenir le panneau le plus récent.`,
      retry: `Réessayer`,
    },
    nodes: {
      pairing: {
        ...
        fullAccessHint: `Nœud avec toutes les commandes du Gateway, y compris les paramètres et les mises à niveau.`,
        ...
        transportLimitedHint: `Cette URL du Gateway utilise le protocole ws:// en texte clair. Utilisez wss:// ou Tailscale Serve, puis créez un nouveau code pour bénéficier d’un accès complet.`,
        ...
        review: `Révision`,
        waiting: `Les applications mobiles officielles OpenClaw se connectent automatiquement après la numérisation.`,
      ...
      inventory: {
        ...
        versionDriftTitle: `Node {nodeVersion} ; Gateway {gatewayVersion}. Mettez à jour le composant le plus ancien pour aligner le parc.`,
        manualWake: `réveil manuel requis`,
        manualWakeTitle: `Le Gateway ne peut pas réveiller un node Windows hors ligne. Démarrez la machine ou rétablissez sa connexion réseau.`,
        ...
        removePromptBody: `Cet appareil devra être appairé à nouveau avant de pouvoir se reconnecter.`,
        removeStalePromptTitle: `Supprimer {count} appairages obsolètes ?`,
        removeStalePromptTitleOne: `Supprimer 1 appairage obsolète ?`,
        removeStalePromptBody: `Les clients concernés se réappaireront silencieusement lors de leur prochaine connexion.`,
        gateway: `gateway`,
    ...
    worktrees: {
      ...
      cleanupSubtitle: `OpenClaw supprime périodiquement les anciens worktrees afin de libérer de l’espace disque. Ajustez le niveau d’agressivité du nettoyage.`,
      cleanupMaxCount: `Nombre maximal de worktrees`,
      cleanupMaxCountHelp: `Nombre maximal de worktrees gérés à conserver dans l’ensemble des dépôts. Les worktrees les plus anciens sont d’abord enregistrés sous forme d’instantanés, puis supprimés. Définissez cette valeur sur 0 pour désactiver la limite du nombre.`,
      cleanupMaxSize: `Taille totale maximale (Go)`,
      cleanupMaxSizeHelp: `Taille totale maximale en Go pour l’ensemble des worktrees gérés. Définissez cette valeur sur 0 pour désactiver la limite de taille.`,
      ...
      confirmForceDelete: `Échec de la création de l’instantané : {error}
...
Supprimer sans instantané ?`,
    ...
    agentScope: { label: `Portée de l’agent`, allAgents: `Tous les agents` },
    newSession: {
      ...
      worktreeNameInvalid: `Les noms de worktree utilisent des lettres minuscules, des chiffres et des tirets.`,
      ...
      createOutcomeUnknown: `Le Gateway a changé pendant le démarrage de cette session. Consultez les sessions récentes avant de relancer cette tâche.`,
      catalogUnavailable: `La cible de cette session est indisponible.`,
    },
    sessionsView: {
      deletePreservedWorktrees: `{count} worktree(s) de session avec des modifications non validées ou non envoyées ont été conservés ({branches}). Gérez-les dans Settings -> Worktrees.`,
      deletePreservedWorktreeConfirm: `Le worktree de la session contient des modifications non validées ou non envoyées, il a donc été conservé ({branch}). Supprimer quand même le checkout ?`,
      title: `Sessions`,
      ...
      transcriptSearchDescription: `Recherchez des mots ou expressions exacts dans les messages de l’utilisateur et de l’assistant des sessions de l’agent par défaut.`,
      ...
      transcriptSearchUnavailable: `La recherche dans les transcriptions nécessite une version plus récente de Gateway.`,
      transcriptSearchError: `Échec de la recherche dans les transcriptions`,
      transcriptSearchIndexing: `L’index des transcriptions est encore en cours de mise à jour. Réessayez pour inclure les messages récents.`,
      ...
      contextUsageApprox: `~{percent} % du contexte utilisé ({used} / {context} tokens, approximatif)`,
      ...
      deleteGroupConfirm: `Supprimer le groupe « {group} » ? Ses sessions seront déplacées vers Non groupé.`,
    ...
    agents: {
      ...
      identity: {
        ...
        imageUnusable: `Cette image ne peut pas être utilisée. Choisissez un fichier image de 2 Mo maximum.`,
        fileHint: `Les agents peuvent définir ces informations eux-mêmes en modifiant IDENTITY.md dans leur espace de travail.`,
      },
      overview: {
      ...
      skillsPanel: {
        ...
        allEnabled: `Tous les Skills sont activés. Désactiver un Skill créera une liste d'autorisation par agent.`,
        loadAgent: `Chargez les Skills de cet agent pour afficher les entrées propres à l'espace de travail.`,
        filter: `Filtrer`,
    ...
    configForm: {
      ...
      structuredSecretFile: `Valeur structurée (SecretRef) - modifiez directement le fichier de configuration`,
      defaultValue: `Par défaut : {value}`,
      ...
      sections: {
        ...
        agents: { label: `Agents`, description: `Configurations, modèles et identités des agents` },
        auth: {
        ...
        skills: { label: `Skills`, description: `Packs de Skills et capacités` },
        tools: {
          label: `Outils`,
        ...
        models: { label: `Modèles`, description: `Configurations et fournisseurs de modèles d'IA` },
        bindings: {
          label: `Raccourcis`,
        ...
        web: { label: `Web`, description: `Paramètres du serveur web et de l'API` },
        discovery: { label: `Découverte`, description: `Découverte de services et mise en réseau` },
        canvasHost: { label: `Hôte Canvas`, description: `Rendu et affichage Canvas` },
        talk: { label: `Talk`, description: `Paramètres de voix et de parole` },
        ...
        cli: { label: `CLI`, description: `Bannière CLI et comportement au démarrage` },
        secrets: { label: `Secrets`, description: `Configuration du fournisseur de secrets` },
        acp: {
          label: `ACP`,
          description: `Paramètres d'exécution et de streaming de l'Agent Communication Protocol`,
        },
        mcp: { label: `MCP`, description: `Définitions du serveur Model Context Protocol` },
      },
    },
    quickSettings: {
      language: `Langue`,
      model: {
        ...
        thinkingLevels: { off: `Désactivée`, low: `Faible`, medium: `Moyenne`, high: `Élevée` },
        fastModes: { auto: `Automatique`, fast: `Rapide`, standard: `Standard` },
      },
      channels: {
        title: `Canaux`,
      ...
      appearance: {
        ...
        import: `Importer`,
        themes: { claw: `Claw`, knot: `Knot`, dash: `Dash` },
        textSizes: { small: `S`, medium: `M`, large: `L`, xl: `XL`, xxl: `XXL` },
      ...
      personal: {
        ...
        overrideHint: `Enregistre un remplacement dans le Control UI. Effacez-le pour revenir à l'avatar configuré.`,
    ...
    configView: {
      ...
      themes: {
        claw: { label: `Claw`, description: `Famille Chroma` },
        knot: { label: `Knot`, description: `Noir et rouge` },
        dash: { label: `Dash`, description: `Plan chocolat` },
      },
      textSizes: { small: `Petit`, default: `Par défaut`, large: `Grande`, xl: `XL`, xxl: `XXL` },
      notifications: {
        ...
        blockedHint: `Les notifications sont bloquées. Mettez à jour les autorisations du site dans votre navigateur pour autoriser les notifications.`,
      },
      appearance: {
        theme: `Thème`,
        ...
        tweakcnInstructions: `Ouvrez tweakcn.com, choisissez ou créez un thème, cliquez sur Partager, puis collez ici le lien de thème copié. Les liens de partage, les URL d'éditeur, les URL de registre, les identifiants de thème et les noms de thème par défaut comme amethyst-haze sont acceptés.`,
        ...
        inlineHintAfter: `pour ajouter un thème tweakcn local au navigateur. Dans tweakcn, utilisez Partager et collez ici le lien copié.`,
        textSize: `Taille du texte`,
      },
      chatPrefs: { title: `Chat`, hint: `Préférences de chat locales au navigateur.` },
      connection: {
        title: `Connexion`,
        gateway: `Gateway`,
        status: `Statut`,
      ...
      rawDisabled: `Mode brut désactivé (l'instantané ne peut pas restituer le texte brut en toute sécurité).`,
      open: `Ouverte`,
      clear: `Effacer`,
      apply: `Appliquer`,
      applying: `Application…`,
      ...
      invalidConfig: `Votre configuration n'est pas valide. Certains paramètres pourraient ne pas fonctionner comme prévu.`,
      ...
      formUnsafe: `Votre configuration contient des champs que l'éditeur de formulaire ne peut pas représenter en toute sécurité. Utilisez le mode Raw pour modifier ces entrées.`,
      ...
      sensitiveHidden: `{count} valeur sensible masquée. Utilisez le bouton d'affichage ci-dessus pour modifier la configuration brute.`,
      sensitiveHiddenPlural: `{count} valeurs sensibles masquées. Utilisez le bouton d'affichage ci-dessus pour modifier la configuration brute.`,
    },
    execApproval: {
    ...
    approvalPage: {
      ...
      unavailableDescription: `This approval could not be found or this device is not authorized to review it.`,
      ...
      resolvedElsewhereDescription: `Another surface or an earlier attempt recorded the decision first.`,
      approved: `Approved`,
      denied: `Denied`,
      expired: `Expiré`,
      cancelled: `Annulé`,
    ...
    agentTools: {
      ...
      explicitAllowlist: `Cet agent utilise une liste d'autorisation explicite dans la configuration. Les surcharges d'outils sont gérées dans l'onglet Config.`,
      globalAllowlist: `tools.allow global est défini. Les surcharges d'agent ne peuvent pas activer des outils bloqués globalement.`,
      loadingCatalog: `Chargement du catalogue d'outils d'exécution…`,
      catalogFallback: `Impossible de charger le catalogue des outils d'exécution. Affichage de la liste de secours intégrée à la place.`,
      ...
      switchAgent: `Basculez la discussion vers cet agent pour voir ses outils d'exécution en direct.`,
      ...
      moreLiveTitle: `{count} outils en direct supplémentaires sont disponibles dans les groupes ci-dessous.`,
      ...
      inspectAgent: `Basculer la discussion vers cet agent pour inspecter la disponibilité en direct.`,
    ...
    browser: {
      ...
      annotatePrompt: {
        introTitled: `J’ai annoté la page à l’adresse {url} (titre indiqué par la page : "{title}") — la capture d’écran jointe montre mon annotation.`,
        introUntitled: `J’ai annoté la page à l’adresse {url} — la capture d’écran jointe montre mon annotation.`,
        region: `Région marquée {index} : centrée autour de {x}% horizontalement / {y}% verticalement, couvrant environ {width}% × {height}% de la vue.`,
        moreRegions: `…plus {count} autre(s) région(s) marquée(s), toutes visibles dans la capture d’écran.`,
        elementDetail: `Élément marqué (indiqué par la page) : {descriptor} — {width}×{height}px à ({x}, {y}).`,
    ...
    subtitles: {
      ...
      tasks: `Tâches en arrière-plan\xA0: sous-agents, exécutions cron, CLI.`,
      skills: `Skills et clés API.`,
      plugins: `Installez et gérez des fonctionnalités optionnelles.`,
      skillWorkshop: `Examinez, affinez et appliquez les propositions avant qu’elles ne deviennent des skills actives.`,
      ...
      memoryImport: `Importez la mémoire de Codex et de Claude Code dans l’espace de travail d’un agent.`,
    ...
    memoryImport: {
      ...
      confirmDescription: `Copier les {count} fichiers de mémoire sélectionnés dans l’espace de travail de cet agent.`,
      confirmReplace: `Les fichiers de destination existants seront sauvegardés dans le rapport de migration avant leur remplacement.`,
      confirmBackup: `OpenClaw crée une sauvegarde vérifiée avant l’importation, puis copie la mémoire.`,
      ...
      subtitle: `Examinez la mémoire consolidée de Codex et la mémoire automatique de Claude Code avant de les copier dans OpenClaw.`,
      agent: `Agent de destination`,
      replaceExisting: `Remplacer les importations existantes`,
      replaceHint: `Prévisualisez à nouveau les conflits et conservez les sauvegardes des éléments avant leur remplacement.`,
    },
    mcpPage: {
      ...
      operatorCommandsHint: `État, diagnostics, authentification, sondage et rechargement du runtime.`,
      runtimeHint: `Les modifications du runtime s'appliquent après l'enregistrement et la publication ; les agents actifs reconstruisent les runtimes MCP à la prochaine utilisation.`,
    ...
    pluginsPage: {
      ...
      connectorsHint: `Connecteurs MCP en un clic et recherches ClawHub soigneusement sélectionnées pour les services populaires.`,
      ...
      connectorAddedOauth: `{name} ajouté. Authentifiez-vous avec « {command} », puis redémarrez le gateway.`,
      connectorAddedEndpoint: `{name} ajouté. Mettez à jour le point de terminaison et les identifiants dans les paramètres MCP avant utilisation.`,
      connectorAddedReady: `{name} ajouté. Les nouvelles sessions d’agent peuvent l’utiliser immédiatement.`,
      connectorDescriptions: {
        notion: `Recherchez, créez et mettez à jour des pages et bases de données dans votre espace de travail Notion.`,
        linear: `Triez les problèmes, mettez à jour les cycles et signalez des bugs directement depuis le chat.`,
        ...
        googleCalendar: `Lisez, créez et recevez un récapitulatif des événements — votre agent gère votre emploi du temps.`,
        ...
        github: `Files d'attente de revue de PR, triage des issues et questions-réponses sur les dépôts via le MCP officiel de GitHub.`,
        sentry: `Alertes de plantage expliquées et triées dès leur déclenchement.`,
        context7: `Documentation de bibliothèque et exemples de code propres à une version pendant le codage. Aucune inscription requise.`,
        deepwiki: `Posez des questions sur n'importe quel dépôt GitHub public. Gratuit, sans compte requis.`,
        huggingFace: `Recherchez des modèles, jeux de données et articles ; exécutez des Spaces comme outils.`,
        grafana: `Savoir-faire Grafana et connecteurs communautaires pour tableaux de bord et alertes.`,
        kubernetes: `Opérations de cluster et dépannage depuis le chat.`,
        homeAssistant: `Contrôlez l'éclairage, la climatisation et les automatisations dans toute votre maison.`,
        spotify: `Recherchez, mettez en file d'attente et rythmez votre journée avec des playlists selon l'humeur.`,
        sonos: `Audio dans toute la maison : jouez, groupez les pièces et mettez en file d'attente par chat.`,
      ...
      noInstalledBody: `Découvrez un plugin mis en avant ou recherchez dans ClawHub pour étendre OpenClaw.`,
      ...
      mcpHint: `Connectez des serveurs Model Context Protocol pour doter votre agent d’outils supplémentaires. Les modifications s’appliquent aux nouvelles sessions d’agent.`,
      mcpAdd: `Ajouter un serveur`,
      mcpAdding: `Ajout…`,
      mcpEmpty: `Aucun serveur MCP n’est encore configuré. Ajoutez-en un ici ou choisissez un connecteur depuis Découvrir.`,
      mcpNameLabel: `Nom`,
      mcpTargetLabel: `URL ou commande`,
      mcpNameInvalid: `Les noms de serveur utilisent des lettres, des chiffres, des points, des tirets ou des traits de soulignement.`,
      ...
      cancel: `Annuler`,
      removedRestart: `{name} supprimé. Un redémarrage de Gateway est nécessaire pour appliquer la modification.`,
      ...
      adminRequired: `Consultation uniquement. Les modifications de plugins nécessitent l’accès operator.admin.`,
      changesDisabled: `Consultation uniquement. Ce gateway n’autorise pas les modifications de plugins.`,
      configRefreshFailed: `Impossible d’actualiser la configuration de Control UI : {error}`,
      installedSuccess: `{name} installé.`,
      installedRestart: `{name} installé. Un redémarrage de Gateway est nécessaire pour appliquer la modification.`,
      enabledSuccess: `{name} activé.`,
      enabledRestart: `{name} activé. Un redémarrage de Gateway est nécessaire pour appliquer la modification.`,
      disabledSuccess: `{name} désactivé.`,
      disabledRestart: `{name} désactivé. Un redémarrage de Gateway est nécessaire pour appliquer la modification.`,
    },
    aboutPage: {
      ...
      gatewayVersionHint: `Signalée par la connexion Gateway active\xA0; distincte de ce build du Control UI.`,
    },
    profilePage: {
      ...
      emptyBody: `Aucune activité de jetons pour le moment. Envoyez un message à votre agent et regardez le récif s’illuminer.`,
      ...
      heatmapSub: `Une année dans le récif — plus le rouge est profond, plus les pinces sont actives.`,
    ...
    tasksPage: {
      ...
      runtime: { subagent: `Sous-agent`, cron: `Cron`, acp: `ACP`, cli: `CLI`, unknown: `Tâche` },
    },
    skillWorkshop: {
      ...
      header: {
        ...
        useCurrentChatTooltip: `Envoyer les demandes de révision à la session de discussion actuelle plutôt qu'à la session d'atelier de la proposition.`,
        selfLearning: `Auto-apprentissage`,
        selfLearningAria: `Activer ou désactiver les propositions de Skills par auto-apprentissage`,
        selfLearningTooltip: `Capture les corrections et analyse les travaux substantiels terminés pour en faire des propositions de Skills en attente. Utilise des jetons supplémentaires en arrière-plan ; les brouillons apparaissent sur ce tableau comme propositions en attente.`,
      ...
      recency: { today: `Aujourd’hui`, yesterday: `Hier`, earlier: `Plus tôt cette semaine` },
      ...
      revision: {
        ...
        description: `Indiquez à l'agent ce qui doit changer. La proposition reste en attente et le workshop créera une version révisée.`,
        placeholder: `Exemple : Faire en sorte que cela utilise les libellés Gmail au lieu de la recherche de messages non lus, et ajouter une étape de simulation plus sûre.`,
      ...
      empty: {
        ...
        pendingBody: `Les nouveaux brouillons apparaîtront ici lorsqu'ils nécessiteront une révision.`,
        appliedTitle: `Rien d'appliqué pour le moment`,
        appliedBody: `Utilisez une proposition en attente et elle apparaîtra ici en tant que skill active.`,
        rejectedTitle: `Aucune proposition rejetée`,
        rejectedBody: `Les propositions ignorées resteront ici pour conserver un historique de révision clair.`,
        quarantinedTitle: `Rien en quarantaine`,
        quarantinedBody: `Les propositions bloquées par le scanner ou retenues pour raisons de sécurité apparaîtront ici.`,
        ...
        allBody: `Les propositions du Skill Workshop apparaîtront ici lorsque votre agent les rédigera.`,
      ...
      selfLearning: {
        ...
        pitchBody: `OpenClaw analyse les corrections et les exécutions substantielles terminées, puis rédige des propositions de Skills pour ce tableau. Il utilise des jetons supplémentaires en arrière-plan, et les brouillons apparaissent comme propositions en attente.`,
      ...
      today: {
        ...
        emptyBody: `Votre agent n'a rien rédigé de nouveau. Passez au Tableau pour parcourir l'historique.`,
        new: `NOUVEAU`,
        waiting: `EN ATTENTE`,
        reviewed: `EXAMINÉ`,
        agent: `agent`,
    ...
    activity: {
      ...
      status: { running: `En cours d’exécution`, done: `Terminé`, error: `Erreur` },
      duration: { ms: `{count} ms`, seconds: `{count} s`, minutes: `{minutes}m {seconds}s` },
    },
    logsView: {
      title: `Logs`,
      subtitle: `Gateway file logs (JSONL).`,
      exportButton: `Export {label}`,
      exportLabels: { filtered: `filtered`, visible: `visible` },
      filter: `Filter`,
    ...
    logbook: {
      duration: { minutes: `{minutes}m`, hours: `{hours}h {minutes}m` },
      nav: { previousDay: `Previous day`, nextDay: `Next day`, today: `Today` },
      status: {
        ...
        modelMissingHelp: `Set plugins.entries.logbook.config.visionModel (for example codex/gpt-5.6-sol) or configure tools.media models.`,
      },
      actions: { pause: `Pause`, resume: `Resume`, analyzeNow: `Analyze now` },
      empty: {
        title: `Nothing on the timeline yet.`,
        subtitle: `Logbook is collecting snapshots; cards appear after the first analysis batch completes.`,
      },
      card: { keyframeAlt: `Screen snapshot from this activity`, distractions: `Distractions` },
      stats: { title: `Day at a glance`, focus: `{pct}% focus`, tracked: `{duration} tracked` },
      standup: {
        title: `Daily standup`,
        generate: `Generate`,
        refresh: `Regenerate`,
    ...
    workspaces: {
      tabs: { label: `Workspaces`, hidden: `Hidden ({count})` },
      error: {
      ...
      header: { subtitle: `Arrange widgets and tabs for this workspace.` },
      onboarding: {
      ...
      empty: {
        ...
        onboardingSubtitle: `Ask your agent to build a workspace, or create one from the command line.`,
      ...
      widget: {
        ...
        approval: {
          ...
          approve: `Approve`,
          reject: `Reject`,
          unavailable: `This custom widget isn't available. Ask your agent to rebuild it, or remove it.`,
        },
        ...
        stat: { empty: `—` },
        table: { empty: `No rows to show.`, more: `+{count} more` },
        sessions: { empty: `No sessions yet.` },
        usage: { cost: `Cost`, tokens: `Tokens` },
        cron: { empty: `No scheduled jobs.`, next: `Next {time}`, noNext: `Not scheduled` },
        instances: { empty: `No connected instances.`, idle: `Idle for {duration}` },
    ...
    workboard: {
      ...
      agentFilterConfiguredDefaultHelp: `Cartes explicitement assignées à l'agent par défaut configuré.`,
...
Tests :`,
      ...
      emptyFilteredHint: `Modifiez la vue, la recherche, la priorité, l'agent ou le filtre d'archive.`,
    ...
    connection: {
      ...
      offlineHint: `Les mises à jour en direct et les actions sont en pause jusqu’au rétablissement de la connexion.`,
    ...
    palette: {
      ...
      categories: { search: `Recherche`, navigation: `Navigation`, skills: `Skills` },
      items: {
        sessions: `Sessions`,
        scheduled: `Planifié`,
        skills: `Skills`,
      ...
      footer: { navigate: `naviguer`, select: `sélectionner`, close: `fermer` },
    },
    dreaming: {
      tabs: { scene: `Scène`, diary: `Journal`, advanced: `Avancé` },
      header: {
        refresh: `Actualiser`,
        refreshing: `Actualisation…`,
        on: `Rêverie activée`,
      ...
      phase: { light: `Léger`, deep: `Profond`, rem: `REM`, off: `désactivé` },
      advanced: {
      ...
      wiki: {
        ...
        dreamsExplainer: `Il s'agit du journal de rêves brut que le système écrit pendant qu'il rejoue et consolide la mémoire ; utilisez-le pour inspecter ce que le système de mémoire remarque, et où cela semble encore bruité ou pauvre.`,
        insightsExplainer: `Ce sont des insights importés regroupés à partir d'un historique externe ; utilisez-les pour examiner ce que les imports ont fait ressortir avant que tout cela ne se transforme en mémoire durable.`,
        palaceExplainer: `Il s'agit de la surface wiki de mémoire compilée que le système peut consulter et exploiter ; utilisez-la pour inspecter les pages de mémoire réelles, les affirmations, les questions ouvertes et les contradictions plutôt que les conversations sources importées brutes.`,
        ...
        noInsightsHint: `Lancez un import ChatGPT avec application pour faire apparaître ici des insights importés regroupés.`,
        ...
        emptyPalaceHint: `Pour l'instant, le wiki contient surtout des imports de sources brutes et des rapports opérationnels. Cet onglet devient utile une fois que des synthèses, des entités ou des concepts commencent à être rédigés.`,
        claims: `Affirmations`,
        ...
        unavailablePluginPrefix: `Imported Insights et Memory Palace sont fournis par le plugin intégré`,
    ...
    modelProviders: {
      ...
      apiKey: {
        ...
        authModeBlocked: `Les modifications de la clé API sont indisponibles lorsque le mode d’authentification est « {mode} ».`,
      },
      probe: {
      ...
      logout: {
        ...
        confirm: `Se déconnecter de {provider} ? Les profils OAuth et de jeton enregistrés seront supprimés.`,
      ...
      defaults: {
        ...
        subtitle: `Choisissez le modèle principal, les modèles de secours par ordre de priorité et le modèle utilitaire.`,
      ...
      readOnly: {
        ...
        adminRequired: `Consultation uniquement. La modification des modèles nécessite l’accès operator.admin.`,
      },
      notes: {
    ...
    usage: {
      common: { emptyValue: `—`, unknown: `inconnu` },
      loading: { title: `Aperçu de l’utilisation`, badge: `Chargement` },
      metrics: { tokens: `Jetons`, cost: `Coût`, session: `session`, sessions: `sessions` },
      providerUsage: {
        title: `Forfaits et facturation des fournisseurs`,
        subtitle: `Données en temps réel sur les forfaits, quotas, soldes et budgets communiquées par les fournisseurs configurés.`,
        balance: `Solde`,
        spend: `Utilisation`,
        budget: `Budget`,
        today: `Aujourd’hui`,
      ...
      scope: {
        ...
        familyHint: `Regrouper les ids de session connus adossés à des transcriptions ayant fait l’objet d’une rotation.`,
      ...
      cacheStatus: {
        ...
        status: { refreshing: `actualisation`, stale: `obsolète`, partial: `partiel` },
      },
      empty: {
      ...
      daily: {
        ...
        compressedScaleHint: `L’échelle en racine carrée permet de garder visibles les jours de faible utilisation.`,
      },
      costWindows: {
    ...
    login: {
      ...
      failure: {
        ...
        authRequired: {
          ...
          summary: `Le Gateway est joignable, mais il lui faut un jeton ou un mot de passe correspondant avant que ce navigateur puisse se connecter.`,
          stepPaste: `Collez le jeton de openclaw dashboard --no-open ou saisissez le mot de passe configuré.`,
          stepGenerate: `Si aucun jeton n’est configuré, exécutez openclaw doctor --generate-gateway-token sur l’hôte Gateway.`,
        ...
        authFailed: {
          ...
          summary: `L’identifiant fourni a été refusé. La cause la plus courante est un jeton obsolète ou copié depuis une autre URL Gateway.`,
          stepDashboard: `Exécutez openclaw dashboard --no-open et ouvrez la nouvelle URL ou collez son jeton.`,
          stepReplace: `Remplacez les valeurs de jeton/mot de passe obsolètes ; ne réutilisez pas un jeton provenant d’une autre URL Gateway.`,
          stepMode: `Utilisez un seul mode d’authentification correspondant à la fois : jeton gateway pour le mode jeton, mot de passe pour le mode mot de passe.`,
        },
        rateLimited: {
          title: `Trop de tentatives échouées`,
          summary: `Le Gateway limite temporairement les tentatives d’authentification pour ce client.`,
          stepStop: `Arrêtez de réessayer depuis cet onglet pendant un moment.`,
          stepWait: `Attendez que le limiteur d’authentification se calme, puis reconnectez-vous avec l’identifiant corrigé.`,
          stepCheckClients: `Si cet hôte est partagé, vérifiez que d’autres clients ne répètent pas de mauvais essais.`,
        },
        pairing: {
          ...
          summary: `Ce navigateur nécessite une approbation unique de l’hôte Gateway avant de pouvoir utiliser Control UI.`,
          upgradeSummary: `Ce navigateur est déjà connu, mais l’accès demandé a changé et nécessite une nouvelle approbation.`,
        ...
        insecure: {
          ...
          summary: `Cette page s’exécute en HTTP simple, le navigateur ne peut donc pas créer l’identité d’appareil attendue par le Gateway.`,
          stepHttps: `Utilisez HTTPS/Tailscale Serve, ou ouvrez http://127.0.0.1:18789 sur l’hôte Gateway.`,
          stepLocalCompat: `Pour la compatibilité locale en mode jeton uniquement, définissez gateway.controlUi.allowInsecureAuth: true.`,
          stepAvoidDisable: `Évitez de désactiver l’authentification des appareils pour l’accès HTTP distant.`,
        },
        origin: {
          title: `Origine du navigateur non autorisée`,
          summary: `Le Gateway a rejeté l’origine de cette page avant d’accepter la connexion Control UI.`,
          stepAllowedOrigins: `Ajoutez cette origine de navigateur à gateway.controlUi.allowedOrigins.`,
          stepFullOrigin: `Utilisez des origines complètes comme http://localhost:5173, pas des motifs wildcard.`,
          stepRestart: `Redémarrez ou rechargez le Gateway après avoir modifié les origines autorisées.`,
        },
        protocol: {
          title: `Incompatibilité de protocole`,
          summary: `La Control UI servie et le Gateway en cours d’exécution ne sont pas d’accord sur le protocole de connexion pris en charge.`,
          stepDashboard: `Rouvrez le dashboard servi avec openclaw dashboard afin que l’UI et le Gateway viennent de la même installation.`,
          stepDevUi: `Si vous utilisez pnpm ui:dev, reconstruisez ou redémarrez l’UI de développement avec le checkout actuel.`,
          stepRestart: `Redémarrez le Gateway après la mise à jour d’OpenClaw afin qu’il serve le protocole actuel.`,
        },
        network: {
          title: `Connexion impossible`,
          summary: `Le navigateur n’a pas pu terminer la connexion au Gateway. Vérifiez la cible et le transport avant de réessayer les identifiants.`,
          stepGateway: `Confirmez que le Gateway fonctionne avec openclaw status ou openclaw gateway run.`,
          stepUrl: `Vérifiez l’URL WebSocket et utilisez wss:// lorsque le Gateway est derrière HTTPS/Tailscale Serve.`,
          stepDashboard: `Rouvrez le dashboard avec openclaw dashboard --no-open pour recopier l’URL actuelle et les détails d’authentification.`,
        },
      },
    },
    chat: {
      ...
      taskSuggestions: {
        ...
        adminRequired: `Un accès administrateur est requis pour créer un worktree à partir de ce projet.`,
      },
      pullRequests: {
        ...
        rateLimited: `Limite de débit de l’API GitHub atteinte. L’état de la pull request peut être obsolète jusqu’à la réinitialisation de la limite.`,
      },
      ...
      compaction: {
        ...
        description: `La transcription compactée est conservée comme point de contrôle. Ouvrez les points de contrôle de la session pour créer une branche ou restaurer à partir de cette vue compactée.`,
      ...
      commands: {
        ...
        categories: { session: `Session`, model: `Modèle`, agents: `Agents`, tools: `Outils` },
      },
      splitView: {
      ...
      modelControls: { default: `Par défaut`, reasoning: `Raisonnement`, speed: `Vitesse` },
      sideChat: {
      ...
      composer: {
        ...
        microphonePageInactive: `Les entrées microphone sont indisponibles lorsque cette page est inactive.`,
        microphonePermissionBlocked: `L’accès au microphone est bloqué. Autorisez-le dans les paramètres de site du navigateur pour lister les entrées.`,
        realtimeTalkRequiresMicrophone: `La saisie vocale en temps réel nécessite l'accès au microphone du navigateur.`,
        selectedMicrophoneUnavailable: `Le microphone sélectionné est indisponible. Choisissez une autre entrée ou l’option par défaut du système.`,
      ...
      toolCards: {
        ...
        group: {
          ...
          activityErrorOne: `Activité\xA0: {count} outil, contient des erreurs.`,
          activityErrorMany: `Activité\xA0: {count} outils, contient des erreurs.`,
        },
      },
      workRun: {
      ...
      workspaceFiles: {
        ...
        truncated: `Affichage des premiers fichiers correspondants. Affinez la recherche pour réduire les résultats.`,
        session: `Session`,
        missing: `Manquant`,
    ...
    cron: {
      ...
      suggestions: {
        ...
        ideas: {
          repoPulse: {
            ...
            prompt: `Passe en revue l'activité nocturne de mes dépôts : nouvelles issues, pull requests et échecs CI. Résume les trois points qui nécessitent le plus mon attention aujourd'hui, chacun avec un lien et une raison en une ligne.`,
          },
          standupGhostwriter: {
            name: `Nègre de standup`,
            tagline: `Ton compte-rendu de standup, rédigé à partir du travail d'hier.`,
            prompt: `Rédige mon compte-rendu de standup à partir des commits d'hier, des pull requests fusionnées et des fils de révision ouverts. Trois points maximum : fait, en cours, bloqué.`,
          },
          hackerNewsScout: {
            name: `Éclaireur Hacker News`,
            tagline: `Trois liens qui valent ton café, avec des avis tranchés.`,
            prompt: `Parcours la page d'accueil Hacker News du jour pour les articles sur les agents IA, les outils développeur et TypeScript. Envoie-moi les trois liens les plus intéressants, chacun avec un avis tranché en une ligne.`,
          },
          dependencyRadar: {
            name: `Radar de dépendances`,
            tagline: `Dépendances obsolètes ou vulnérables, avec notes de mise à jour.`,
            prompt: `Vérifie les dépendances obsolètes ou vulnérables de mon projet principal. Liste les mises à jour notables avec une note de risque en une ligne chacune, et rédige la commande de mise à jour.`,
          },
          watchdog: {
          ...
          polyglotMinute: {
            ...
            prompt: `Apprends-moi une expression utile en japonais : l'expression, sa prononciation, sa signification littérale et quand l'utiliser. En moins de cinq lignes.`,
          },
        },
      },
      stats: { tasks: `Tâches`, failing: `En échec`, nextWake: `Prochain réveil` },
      detail: {
      ...
      runNotStarted: {
        ...
        invalidSpec: `Cette automatisation comporte une planification ou une charge utile non valide.`,
      ...
      form: {
        ...
        onExitHelp: `S'exécute lorsqu'une commande surveillée se termine. La planification ne peut pas être modifiée ici.`,
        every: `Toutes les`,
        at: `À`,
        cronOption: `Cron`,
        runAt: `Exécuter à`,
        ...
        sessionKeyHelp: `Clé de routage facultative pour la livraison des tâches et le routage des réveils.`,
...
export { t as fr };
//# sourceMappingURL=fr-BwrsIo3m.js.map
