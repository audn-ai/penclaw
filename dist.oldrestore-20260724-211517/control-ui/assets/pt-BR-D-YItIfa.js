...
e(() => {
  t = {
    ...
    mcpApp: { title: `MCP App`, unavailable: `MCP App indisponível: {error}` },
    githubPreview: {
    ...
    channels: {
      ...
      refreshingStaleSnapshot: `Atualizando o status do canal em segundo plano; exibindo o último snapshot bem-sucedido.`,
      hub: {
        ...
        partialSnapshot: `Algumas verificações de canais não foram concluídas dentro do tempo limite da interface.`,
        ...
        saveBeforeSetup: `Há alterações não salvas na configuração do canal. Salve-as ou recarregue-as antes de executar a configuração guiada.`,
      },
      setup: {
        ...
        doneBody: `Configuração salva. O Gateway recarrega o canal automaticamente; verifique o cartão para acompanhar o status em tempo real.`,
        ...
        whatsappScanHelp: `No seu celular, abra o WhatsApp → Configurações → Dispositivos conectados → Conectar um dispositivo e escaneie este código.`,
      ...
      generic: { subtitle: `Status e configuração do canal.` },
      discord: { title: `Discord`, subtitle: `Status do bot e configuração do canal.` },
      googleChat: {
        title: `Google Chat`,
      ...
      signal: { title: `Signal`, subtitle: `Status do signal-cli e configuração do canal.` },
      slack: { title: `Slack`, subtitle: `Status do modo Socket e configuração de canais.` },
      telegram: { title: `Telegram`, subtitle: `Status do bot e configuração de canais.` },
      whatsapp: {
        title: `WhatsApp`,
    ...
    lazyView: {
      ...
      staleSubtitle: `O OpenClaw foi atualizado em segundo plano. Recarregue para obter o painel mais recente.`,
    ...
    nodes: {
      pairing: {
        ...
        fullAccessHint: `Nó e controles completos do Gateway, incluindo configurações e atualizações.`,
        ...
        transportLimitedHint: `Esta URL do Gateway usa ws:// sem criptografia. Use wss:// ou Tailscale Serve e crie um novo código para acesso completo.`,
      ...
      inventory: {
        ...
        versionDriftTitle: `Nó {nodeVersion}; Gateway {gatewayVersion}. Atualize o componente mais antigo para alinhar a frota.`,
        manualWake: `ativação manual necessária`,
        manualWakeTitle: `O Gateway não pode ativar um nó Windows offline. Inicie a máquina ou restaure sua conexão de rede.`,
        ...
        removePromptBody: `Este dispositivo deverá ser pareado novamente antes de poder se reconectar.`,
        removeStalePromptTitle: `Remover {count} pareamentos obsoletos?`,
        removeStalePromptTitleOne: `Remover 1 pareamento obsoleto?`,
        removeStalePromptBody: `Os clientes afetados serão pareados novamente de forma silenciosa na próxima conexão.`,
        gateway: `gateway`,
    ...
    worktrees: {
      ...
      cleanupSubtitle: `O OpenClaw remove periodicamente worktrees antigos para liberar espaço em disco. Ajuste o nível de agressividade da limpeza.`,
      cleanupMaxCount: `Máximo de worktrees`,
      cleanupMaxCountHelp: `Número máximo de worktrees gerenciados a serem mantidos em todos os repositórios. Os worktrees mais antigos são salvos como snapshots e removidos primeiro. Defina como 0 para desativar o limite de quantidade.`,
      cleanupMaxSize: `Tamanho total máximo (GB)`,
      cleanupMaxSizeHelp: `Tamanho total máximo em GB de todos os worktrees gerenciados. Defina como 0 para desativar o limite de tamanho.`,
...
Excluir sem um snapshot?`,
    ...
    agentScope: { label: `Escopo do agente`, allAgents: `Todos os agentes` },
    newSession: {
      title: `Nova sessão`,
      ...
      createOutcomeUnknown: `O Gateway foi alterado enquanto esta sessão estava sendo iniciada. Verifique as sessões recentes antes de iniciar esta tarefa novamente.`,
      catalogUnavailable: `O destino desta sessão está indisponível.`,
    },
    sessionsView: {
      deletePreservedWorktrees: `{count} worktree(s) de sessão com trabalho não commitado ou não enviado foram mantidas ({branches}). Gerencie-as em Configurações -> Worktrees.`,
      deletePreservedWorktreeConfirm: `A worktree da sessão tem trabalho não commitado ou não enviado, por isso foi mantida ({branch}). Excluir o checkout mesmo assim?`,
      title: `Sessões`,
      ...
      transcriptSearchDescription: `Encontre palavras ou frases exatas nas mensagens do usuário e do assistente nas sessões do agente padrão.`,
      ...
      transcriptSearchIndexing: `O índice de transcrições ainda está sendo atualizado. Tente novamente para incluir mensagens recentes.`,
    ...
    agents: {
      ...
      identity: {
        ...
        fileHint: `Os agentes podem definir isso por conta própria editando IDENTITY.md no workspace deles.`,
      },
      overview: {
        title: `Visão geral`,
      ...
      skillsPanel: {
        ...
        allEnabled: `Todas as Skills estão ativadas. Desativar qualquer Skill criará uma lista de permissões por agente.`,
    ...
    configForm: {
      ...
      structuredSecretFile: `Valor estruturado (SecretRef) - edite o arquivo de configuração diretamente`,
      defaultValue: `Padrão: {value}`,
      ...
      sections: {
        ...
        skills: { label: `Skills`, description: `Pacotes de Skills e recursos` },
        tools: {
          label: `Ferramentas`,
        ...
        logging: { label: `Registro`, description: `Níveis de log e configuração de saída` },
        ...
        bindings: { label: `Vinculações`, description: `Vinculações de teclas e atalhos` },
        broadcast: {
          label: `Transmissão`,
        ...
        web: { label: `Web`, description: `Configurações do servidor web e da API` },
        ...
        cli: { label: `CLI`, description: `Banner e comportamento de inicialização da CLI` },
        secrets: { label: `Segredos`, description: `Configuração do provedor de segredos` },
        acp: {
          label: `ACP`,
          description: `Configurações de runtime e streaming do Agent Communication Protocol`,
        },
        mcp: { label: `MCP`, description: `Definições de servidor do Model Context Protocol` },
      },
    },
    quickSettings: {
      language: `Idioma`,
      model: {
        ...
        thinkingLevels: { off: `Desativada`, low: `Baixa`, medium: `Média`, high: `Alta` },
        fastModes: { auto: `Automático`, fast: `Rápido`, standard: `Padrão` },
      },
      channels: {
        title: `Canais`,
      ...
      appearance: {
        ...
        textSizes: { small: `P`, medium: `M`, large: `G`, xl: `XL`, xxl: `XXL` },
      ...
      personal: {
        ...
        overrideHint: `Armazena uma substituição do Control UI. Limpe-a para voltar ao avatar configurado.`,
    ...
    configView: {
      ...
      themes: {
        claw: { label: `Claw`, description: `Família Chroma` },
        knot: { label: `Knot`, description: `Preto e vermelho` },
        dash: { label: `Dash`, description: `Planta em chocolate` },
      },
      textSizes: { small: `Pequeno`, default: `Padrão`, large: `Grande`, xl: `XL`, xxl: `XXL` },
      notifications: {
        ...
        blockedHint: `As notificações estão bloqueadas. Atualize as permissões do site no navegador para permitir notificações.`,
      },
      appearance: {
        theme: `Tema`,
        ...
        tweakcnInstructions: `Abra tweakcn.com, escolha ou crie um tema, clique em Share e cole o link do tema copiado aqui. São aceitos links de compartilhamento, URLs de editor, URLs de registro, IDs de tema e nomes de tema padrão como amethyst-haze.`,
        ...
        inlineHintAfter: `para adicionar um tema tweakcn local do navegador. No tweakcn, use Share e cole o link copiado aqui.`,
        textSize: `Tamanho do texto`,
      },
      chatPrefs: { title: `Chat`, hint: `Preferências de chat locais do navegador.` },
      connection: {
        title: `Conexão`,
        gateway: `Gateway`,
        status: `Status`,
      ...
      invalidConfig: `Sua configuração é inválida. Algumas configurações podem não funcionar como esperado.`,
      ...
      formUnsafe: `Sua configuração contém campos que o editor de formulário não consegue representar com segurança. Use o modo Raw para editar essas entradas.`,
      ...
      sensitiveHidden: `{count} valor sensível oculto. Use o botão de revelar acima para editar a configuração raw.`,
      sensitiveHiddenPlural: `{count} valores sensíveis ocultos. Use o botão de revelar acima para editar a configuração raw.`,
    },
    execApproval: {
    ...
    agentTools: {
      ...
      explicitAllowlist: `Este agente está usando uma allowlist explícita na configuração. As substituições de ferramentas são gerenciadas na aba Config.`,
      globalAllowlist: `tools.allow global está definido. As substituições do agente não podem ativar ferramentas que estão bloqueadas globalmente.`,
      loadingCatalog: `Carregando catálogo de ferramentas de runtime…`,
      catalogFallback: `Não foi possível carregar o catálogo de ferramentas de runtime. Exibindo a lista de fallback integrada.`,
    ...
    browser: {
      ...
      annotatePrompt: {
        introTitled: `Anotei a página em {url} (título informado pela página: "{title}") — a captura de tela anexada mostra minha marcação.`,
        introUntitled: `Anotei a página em {url} — a captura de tela anexada mostra minha marcação.`,
        region: `Região marcada {index}: centralizada em cerca de {x}% na horizontal / {y}% para baixo, abrangendo aproximadamente {width}% × {height}% da visualização.`,
        moreRegions: `…mais {count} região(ões) marcada(s), todas visíveis na captura de tela.`,
        elementDetail: `Elemento marcado (informado pela página): {descriptor} — {width}×{height}px em ({x}, {y}).`,
    ...
    subtitles: {
      ...
      memoryImport: `Traga a memória do Codex e do Claude Code para o espaço de trabalho de um agente.`,
    ...
    memoryImport: {
      ...
      confirmDescription: `Copie {count} arquivos de memória selecionados para o espaço de trabalho deste agente.`,
      confirmReplace: `Os arquivos de destino existentes serão incluídos em um backup no relatório de migração antes da substituição.`,
      confirmBackup: `O OpenClaw cria um backup verificado antes da importação e antes de copiar a memória.`,
      ...
      subtitle: `Revise a memória consolidada do Codex e a memória automática do Claude Code antes de copiá-las para o OpenClaw.`,
      agent: `Agente de destino`,
      replaceExisting: `Substituir importações existentes`,
      replaceHint: `Visualize os conflitos novamente e preserve os backups dos itens antes da substituição.`,
    },
    mcpPage: {
      ...
      operatorCommandsHint: `Status, diagnósticos, autenticação, sondagem e recarregamento em tempo de execução.`,
      runtimeHint: `Alterações em tempo de execução são aplicadas após salvar e publicar; agentes ativos reconstroem os runtimes MCP no próximo uso.`,
    ...
    pluginsPage: {
      ...
      connectorsHint: `Conectores MCP com um clique e buscas selecionadas no ClawHub para serviços populares.`,
      ...
      connectorAddedEndpoint: `{name} adicionado. Atualize o endpoint e as credenciais nas configurações do MCP antes de usar.`,
      ...
      connectorDescriptions: {
        ...
        github: `Filas de revisão de PRs, triagem de issues e perguntas sobre repositórios pelo MCP oficial do GitHub.`,
        sentry: `Alertas de falhas explicados e triados no momento em que ocorrem.`,
        context7: `Documentação de bibliotecas específicas por versão e exemplos de código durante a programação. Sem necessidade de cadastro.`,
        deepwiki: `Faça perguntas sobre qualquer repositório público do GitHub. Gratuito, sem necessidade de conta.`,
        ...
        spotify: `Pesquise, adicione à fila e crie a trilha sonora do seu dia com playlists baseadas no humor.`,
      ...
      noInstalledBody: `Descubra um plugin em destaque ou pesquise no ClawHub para expandir o OpenClaw.`,
      ...
      mcpHint: `Conecte servidores Model Context Protocol para fornecer ferramentas extras ao seu agente. As alterações se aplicam a novas sessões do agente.`,
      mcpAdd: `Adicionar servidor`,
      mcpAdding: `Adicionando…`,
      mcpEmpty: `Nenhum servidor MCP configurado ainda. Adicione um aqui ou escolha um conector em Discover.`,
      mcpNameLabel: `Nome`,
      ...
      installedRestart: `{name} instalado. É necessário reiniciar o Gateway para aplicar a alteração.`,
      ...
      disabledRestart: `{name} desativado. É necessário reiniciar o Gateway para aplicar a alteração.`,
    },
    aboutPage: {
      ...
      gatewayVersionHint: `Informada pela conexão ativa do Gateway; separada desta build da Control UI.`,
    },
    profilePage: {
      ...
      emptyBody: `Ainda não há atividade de tokens. Envie uma mensagem para seu agente e veja o recife se iluminar.`,
    ...
    tasksPage: {
      ...
      runtime: { subagent: `Subagente`, cron: `Cron`, acp: `ACP`, cli: `CLI`, unknown: `Tarefa` },
    },
    skillWorkshop: {
      ...
      header: {
        ...
        useCurrentChatTooltip: `Enviar solicitações de revisão para a sessão de conversa atual em vez da sessão de workshop da proposta.`,
        selfLearning: `Autoaprendizado`,
        selfLearningAria: `Ativar ou desativar propostas de Skills por autoaprendizado`,
        selfLearningTooltip: `Capture correções e revise trabalhos substanciais concluídos para criar propostas de skills pendentes. Consome tokens adicionais em segundo plano; os rascunhos chegam a este quadro como propostas pendentes.`,
      ...
      recency: { today: `Hoje`, yesterday: `Ontem`, earlier: `Anteriormente esta semana` },
      ...
      revision: {
        title: `{verb} proposta`,
        description: `Diga ao agente o que deve mudar. A proposta permanece pendente e o workshop criará uma versão revisada.`,
        placeholder: `Exemplo: Faça isso usar rótulos do Gmail em vez de busca por não lidos e adicione uma etapa de dry-run mais segura.`,
      ...
      empty: {
        ...
        quarantinedBody: `Propostas bloqueadas pelo scanner ou retidas por segurança aparecerão aqui.`,
      ...
      selfLearning: {
        ...
        pitchBody: `O OpenClaw revisa correções e execuções substanciais concluídas e, em seguida, cria rascunhos de propostas de skills para este quadro. Ele consome tokens adicionais em segundo plano, e os rascunhos chegam como propostas pendentes.`,
      ...
      today: {
        ...
        emptyBody: `Seu agente não elaborou nada novo. Mude para o Board para navegar pelo histórico.`,
        new: `NOVO`,
        waiting: `AGUARDANDO`,
        reviewed: `REVISADO`,
        agent: `agente`,
    ...
    activity: {
      ...
      status: { running: `Em execução`, done: `Concluída`, error: `Erro` },
    ...
    workboard: {
      ...
      agentFilterConfiguredDefaultHelp: `Cards atribuídos explicitamente ao agente padrão configurado.`,
...
Testes:`,
      ...
      emptyFilteredHint: `Altere a visualização, a busca, a prioridade, o agente ou o filtro de arquivamento.`,
    ...
    connection: {
      ...
      offlineHint: `Atualizações ao vivo e ações estão pausadas até que a conexão seja restabelecida.`,
    ...
    palette: {
      ...
      categories: { search: `Pesquisa`, navigation: `Navegação`, skills: `Skills` },
      items: {
        sessions: `Sessões`,
        scheduled: `Agendados`,
        skills: `Skills`,
      ...
      footer: { navigate: `navegar`, select: `selecionar`, close: `fechar` },
    },
    dreaming: {
      tabs: { scene: `Cena`, diary: `Diário`, advanced: `Avançado` },
      header: {
        refresh: `Atualizar`,
        refreshing: `Atualizando…`,
        on: `Dreaming ativado`,
      ...
      phase: { light: `Leve`, deep: `Profundo`, rem: `Rem`, off: `desligado` },
      advanced: {
        eyebrow: `Revisão`,
      ...
      wiki: {
        ...
        dreamsExplainer: `Este é o diário de sonhos bruto que o sistema escreve enquanto reproduz e consolida a memória; use-o para inspecionar o que o sistema de memória está percebendo e onde ainda parece ruidoso ou insuficiente.`,
        insightsExplainer: `Estes são insights importados agrupados a partir do histórico externo; use-os para revisar o que as importações revelaram antes que qualquer parte se transforme em memória duradoura.`,
        palaceExplainer: `Esta é a superfície da wiki de memória compilada que o sistema pode pesquisar e sobre a qual pode raciocinar; use-a para inspecionar páginas de memória reais, afirmações, questões em aberto e contradições, em vez de conversas de origem importadas brutas.`,
        ...
        noInsightsHint: `Execute uma importação do ChatGPT com aplicação para exibir insights importados agrupados aqui.`,
        ...
        emptyPalaceHint: `No momento, a wiki tem principalmente importações de fontes brutas e relatórios operacionais. Esta aba se torna útil quando sínteses, entidades ou conceitos começam a ser escritos.`,
        claims: `Afirmações`,
        ...
        unavailablePluginPrefix: `Imported Insights e Memory Palace são fornecidos pelo pacote incluído`,
    ...
    modelProviders: {
      ...
      apiKey: {
        ...
        authModeBlocked: `As alterações da chave de API não estão disponíveis enquanto o modo de autenticação for "{mode}".`,
      },
      probe: {
        test: `Testar conexão`,
        testing: `Testando…`,
      ...
      defaults: {
        ...
        subtitle: `Escolha o modelo principal, os modelos alternativos em ordem e o modelo utilitário.`,
    ...
    usage: {
      common: { emptyValue: `—`, unknown: `desconhecido` },
      loading: { title: `Visão geral de uso`, badge: `Carregando` },
      metrics: { tokens: `Tokens`, cost: `Custo`, session: `sessão`, sessions: `sessões` },
      providerUsage: {
        title: `Planos e faturamento dos provedores`,
        subtitle: `Dados em tempo real de plano, cota, saldo e orçamento informados pelos provedores configurados.`,
        balance: `Saldo`,
        spend: `Uso`,
        budget: `Orçamento`,
        today: `Hoje`,
      ...
      cacheStatus: {
        ...
        status: { refreshing: `atualizando`, stale: `desatualizado`, partial: `parcial` },
      },
      empty: {
    ...
    login: {
      ...
      failure: {
        ...
        authRequired: {
          ...
          summary: `O Gateway está acessível, mas precisa de um token ou senha correspondente antes que este navegador possa se conectar.`,
          stepPaste: `Cole o token de openclaw dashboard --no-open ou informe a senha configurada.`,
          stepGenerate: `Se nenhum token estiver configurado, execute openclaw doctor --generate-gateway-token no host do Gateway.`,
          stepConnect: `Clique em Connect novamente depois de atualizar a credencial.`,
        },
        authFailed: {
          title: `A autenticação não corresponde`,
          summary: `A credencial fornecida foi rejeitada. A causa mais comum é um token antigo ou copiado de outro URL de Gateway.`,
          stepDashboard: `Execute openclaw dashboard --no-open e abra o novo URL ou cole seu token.`,
          stepReplace: `Substitua valores antigos de token/senha; não reutilize um token de outro URL de Gateway.`,
          stepMode: `Use um único modo de autenticação correspondente por vez: token de gateway para modo token, senha para modo senha.`,
        },
        rateLimited: {
          title: `Muitas tentativas falharam`,
          summary: `O Gateway está limitando temporariamente as tentativas de autenticação deste cliente.`,
          stepStop: `Pare de tentar novamente desta aba por um momento.`,
          stepWait: `Aguarde o limitador de autenticação esfriar e reconecte com a credencial corrigida.`,
          stepCheckClients: `Se este for um host compartilhado, verifique outros clientes com tentativas incorretas repetidas.`,
        },
        pairing: {
          ...
          summary: `Este navegador precisa de uma aprovação única do host do Gateway antes de poder usar o Control UI.`,
          upgradeSummary: `Este navegador já é conhecido, mas o acesso solicitado mudou e precisa de uma nova aprovação.`,
        ...
        insecure: {
          ...
          summary: `Esta página está sendo executada sobre HTTP simples, então o navegador não consegue criar a identidade de dispositivo que o Gateway espera.`,
          stepHttps: `Use HTTPS/Tailscale Serve ou abra http://127.0.0.1:18789 no host do Gateway.`,
          stepLocalCompat: `Para compatibilidade local somente com token, defina gateway.controlUi.allowInsecureAuth: true.`,
        ...
        origin: {
          ...
          summary: `O Gateway rejeitou a origem desta página antes de aceitar a conexão do Control UI.`,
        ...
        protocol: {
          ...
          summary: `O Control UI servido e o Gateway em execução não concordam sobre o protocolo de conexão compatível.`,
          stepDashboard: `Reabra o dashboard servido com openclaw dashboard para que UI e Gateway venham da mesma instalação.`,
          stepDevUi: `Se estiver usando pnpm ui:dev, reconstrua ou reinicie a UI de desenvolvimento com o checkout atual.`,
          stepRestart: `Reinicie o Gateway depois de atualizar o OpenClaw para que ele sirva o protocolo atual.`,
        },
        network: {
          title: `Não foi possível conectar`,
          summary: `O navegador não conseguiu concluir a conexão ao Gateway. Verifique o destino e o transporte antes de tentar credenciais novamente.`,
          stepGateway: `Confirme que o Gateway está em execução com openclaw status ou openclaw gateway run.`,
          stepUrl: `Verifique o URL de WebSocket e use wss:// quando o Gateway estiver atrás de HTTPS/Tailscale Serve.`,
          stepDashboard: `Reabra o dashboard com openclaw dashboard --no-open para copiar novamente o URL atual e os detalhes de auth.`,
        },
      },
    },
    chat: {
      ...
      pullRequests: {
        ...
        rateLimited: `Limite de taxa da API do GitHub atingido. O status do pull request pode ficar desatualizado até que o limite seja redefinido.`,
      },
      ...
      compaction: {
        ...
        description: `A transcrição compactada é preservada como ponto de verificação. Abra os pontos de verificação da sessão para ramificar ou restaurar a partir dessa visualização compactada.`,
      ...
      commands: {
        ...
        categories: { session: `Sessão`, model: `Modelo`, agents: `Agentes`, tools: `Ferramentas` },
      },
      splitView: {
      ...
      modelControls: { default: `Padrão`, reasoning: `Raciocínio`, speed: `Velocidade` },
      sideChat: {
        title: `Chat lateral`,
      ...
      composer: {
        ...
        microphonePageInactive: `As entradas de microfone ficam indisponíveis enquanto esta página está inativa.`,
        microphonePermissionBlocked: `O acesso ao microfone está bloqueado. Permita-o nas configurações de site do navegador para listar as entradas.`,
        realtimeTalkRequiresMicrophone: `A entrada de voz em tempo real requer acesso ao microfone do navegador.`,
        selectedMicrophoneUnavailable: `O microfone selecionado está indisponível. Escolha outra entrada ou o padrão do sistema.`,
      ...
      workspaceFiles: {
        ...
        truncated: `Exibindo os primeiros arquivos correspondentes. Refine a pesquisa para restringir os resultados.`,
        session: `Sessão`,
        missing: `Ausente`,
    ...
    cron: {
      ...
      list: {
        ...
        emptyHint: `Descreva o que o OpenClaw deve fazer e quando — ele executa conforme a programação.`,
      ...
      suggestions: {
        ...
        ideas: {
          repoPulse: {
            ...
            prompt: `Revise a atividade noturna nos meus repositórios: novas issues, pull requests e falhas de CI. Resuma as três coisas que mais precisam da minha atenção hoje, cada uma com um link e um motivo em uma linha.`,
          },
          standupGhostwriter: {
            name: `Ghostwriter do standup`,
            tagline: `Sua atualização de standup, redigida a partir do trabalho de ontem.`,
            prompt: `Redija minha atualização de standup com base nos commits de ontem, pull requests mesclados e threads de revisão em aberto. Máximo de três tópicos: feito, fazendo, bloqueado.`,
          },
          hackerNewsScout: {
            name: `Explorador do Hacker News`,
            tagline: `Três links que valem seu café, com opiniões quentes.`,
            prompt: `Escaneie a página inicial do Hacker News de hoje em busca de posts sobre agentes de IA, ferramentas para desenvolvedores e TypeScript. Envie-me os três links mais interessantes, cada um com uma opinião direta em uma linha.`,
          },
          dependencyRadar: {
            name: `Radar de dependências`,
            tagline: `Dependências desatualizadas ou vulneráveis, com notas de atualização.`,
            prompt: `Verifique meu projeto principal em busca de dependências desatualizadas ou vulneráveis. Liste as atualizações relevantes com uma nota de risco em uma linha cada, e esboce o comando de atualização.`,
          },
          watchdog: {
            name: `Vigia noturno`,
            tagline: `Verificação de saúde a cada hora com um veredicto em uma linha.`,
            prompt: `Verifique se meus serviços e gateway estão saudáveis: analise logs recentes em busca de novos erros, reinicializações ou carga incomum. Responda com uma linha curta confirmando que tudo está bem quando estiver; se algo parecer quebrado, informe o que falhou e por onde começar a investigar.`,
          },
          polyglotMinute: {
            name: `Minuto poliglota`,
            tagline: `Uma frase estrangeira útil com seu café da manhã.`,
            prompt: `Me ensine uma frase útil em japonês: a frase, como pronunciá-la, seu significado literal e quando usá-la. Mantenha em até cinco linhas.`,
          },
        },
      },
      stats: { tasks: `Tarefas`, failing: `Com falha`, nextWake: `Próximo despertar` },
      detail: {
      ...
      form: {
        ...
        onExitHelp: `Executa quando um comando monitorado é encerrado. A programação não pode ser editada aqui.`,
        every: `A cada`,
        at: `Às`,
        cronOption: `Cron`,
        runAt: `Executar às`,
        ...
        sessionKeyHelp: `Chave de roteamento opcional para entrega de tarefas e roteamento de ativação.`,
...
export { t as pt_BR };
//# sourceMappingURL=pt-BR-D-YItIfa.js.map
