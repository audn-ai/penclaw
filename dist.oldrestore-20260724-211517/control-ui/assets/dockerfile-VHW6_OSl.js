...
import { n as t, t as n } from "./simple-mode-D3-eS7uP.js";
  ...
  (n(),
    ...
    (f = t({
      start: [
        ...
        { regex: u, token: [null, `keyword`, null, `error`], sol: !0 },
        { regex: o, token: [null, `keyword`, null], sol: !0, next: `array` },
        { regex: c, token: [null, `keyword`, null], sol: !0, next: `expose` },
        { regex: d, token: [null, `keyword`, null], sol: !0, next: `arguments` },
        { regex: /./, token: null },
      ],
      from: [
...
export { f as dockerFile };
//# sourceMappingURL=dockerfile-VHW6_OSl.js.map
