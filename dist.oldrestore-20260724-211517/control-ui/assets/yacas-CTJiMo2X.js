...
function n(e, t) {
  var n = e.next();
  if (n === `"`) return ((t.tokenize = r), t.tokenize(e, t));
  if (n === `/`) {
    if (e.eat(`*`)) return ((t.tokenize = i), t.tokenize(e, t));
    if (e.eat(`/`)) return (e.skipToEnd(), `comment`);
  }
  e.backUp(1);
  var s = e.match(/^(\w+)\s*\(/, !1);
  s !== null && o.hasOwnProperty(s[1]) && t.scopes.push(`bodied`);
  var c = a(t);
  if (
    (c === `bodied` && n === `[` && t.scopes.pop(),
    ...
    for (; c === `bodied`;) (t.scopes.pop(), (c = a(t)));
...
function r(e, t) {
  for (var r, i = !1, a = !1; (r = e.next()) != null;) {
    if (r === `"` && !a) {
      i = !0;
      break;
    }
  ...
  return (i && !a && (t.tokenize = n), `string`);
}
function i(e, t) {
  for (var r, i; (i = e.next()) != null;) {
    if (r === `*` && i === `/`) {
      t.tokenize = n;
      break;
    }
...
export { p as yacas };
//# sourceMappingURL=yacas-CTJiMo2X.js.map
