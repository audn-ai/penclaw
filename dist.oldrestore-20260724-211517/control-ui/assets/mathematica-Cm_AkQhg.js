...
function t(e, t) {
  var i = e.next();
  return i === `"`
    ? ((t.tokenize = n), t.tokenize(e, t))
    : i === `(` && e.eat(`*`)
      ? (t.commentLevel++, (t.tokenize = r), t.tokenize(e, t))
      : (e.backUp(1),
        e.match(l, !0, !1) || e.match(u, !0, !1)
          ? `number`
...
function n(e, n) {
  ...
  return (i && !a && (n.tokenize = t), `string`);
}
function r(e, n) {
  for (var r, i; n.commentLevel > 0 && (i = e.next()) != null;)
    (r === `(` && i === `*` && n.commentLevel++,
      r === `*` && i === `)` && n.commentLevel--,
      (r = i));
  return (n.commentLevel <= 0 && (n.tokenize = t), `comment`);
}
...
e(() => {
  ((i = `[a-zA-Z\\$][a-zA-Z0-9\\$]*`),
    ...
    (f = {
      name: `mathematica`,
      startState: function () {
        return { tokenize: t, commentLevel: 0 };
      },
      token: function (e, t) {
...
export { f as mathematica };
//# sourceMappingURL=mathematica-Cm_AkQhg.js.map
