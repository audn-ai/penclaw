...
function n(e, t) {
  ...
  return o.propertyIsEnumerable(l) ? `keyword` : s.propertyIsEnumerable(l) ? `atom` : `variable`;
}
function r(e) {
  return function (t, n) {
...
export { l as pascal };
//# sourceMappingURL=pascal-z1_3S7WH.js.map
