...
e(() => {
  t = {
    ...
    mcpApp: { title: `Aplikasi MCP`, unavailable: `Aplikasi MCP tidak tersedia: {error}` },
    githubPreview: {
    ...
    channels: {
      ...
      refreshingStaleSnapshot: `Menyegarkan status channel di latar belakang; menampilkan snapshot terakhir yang berhasil.`,
      hub: {
        ...
        browseAllSubtitle: `Jelajahi semua saluran yang tersedia, termasuk plugin yang dapat diinstal.`,
        runSetup: `Jalankan penyiapan`,
        saveBeforeSetup: `Anda memiliki perubahan konfigurasi saluran yang belum disimpan. Simpan atau muat ulang perubahan tersebut sebelum menjalankan penyiapan terpandu.`,
      },
      setup: {
        ...
        doneBody: `Konfigurasi disimpan. Gateway memuat ulang saluran secara otomatis; periksa kartunya untuk melihat status terkini.`,
        ...
        whatsappScanHelp: `Di ponsel Anda, buka WhatsApp → Pengaturan → Perangkat tertaut → Tautkan perangkat, lalu pindai kode ini.`,
      ...
      generic: { subtitle: `Status dan konfigurasi saluran.` },
      discord: { title: `Discord`, subtitle: `Status bot dan konfigurasi channel.` },
      googleChat: {
        title: `Google Chat`,
        subtitle: `Status webhook Chat API dan konfigurasi channel.`,
      },
      imessage: { title: `iMessage`, subtitle: `Status bridge macOS dan konfigurasi channel.` },
      signal: { title: `Signal`, subtitle: `Status signal-cli dan konfigurasi channel.` },
      slack: { title: `Slack`, subtitle: `Status socket mode dan konfigurasi channel.` },
      telegram: { title: `Telegram`, subtitle: `Status bot dan konfigurasi channel.` },
      whatsapp: {
        title: `WhatsApp`,
    ...
    lazyView: {
      ...
      staleSubtitle: `OpenClaw telah diperbarui di latar belakang. Muat ulang untuk mendapatkan panel terbaru.`,
      retry: `Coba lagi`,
    },
    nodes: {
      pairing: {
        ...
        transportLimitedHint: `URL Gateway ini menggunakan ws:// tanpa enkripsi. Gunakan wss:// atau Tailscale Serve, lalu buat kode baru untuk akses penuh.`,
      ...
      inventory: {
        ...
        versionDriftTitle: `Node {nodeVersion}; Gateway {gatewayVersion}. Perbarui komponen yang lebih lama untuk menyelaraskan armada.`,
        manualWake: `perlu pengaktifan manual`,
        manualWakeTitle: `Gateway tidak dapat mengaktifkan node Windows yang offline. Nyalakan mesin atau pulihkan koneksi jaringannya.`,
        ...
        removeStalePromptBody: `Klien yang terdampak akan dipasangkan kembali secara otomatis pada koneksi berikutnya.`,
        gateway: `gateway`,
    ...
    worktrees: {
      ...
      cleanupSubtitle: `OpenClaw secara berkala menghapus worktree lama untuk mengosongkan ruang disk. Atur seberapa agresif pembersihan dijalankan.`,
      cleanupMaxCount: `Worktree maksimum`,
      cleanupMaxCountHelp: `Jumlah maksimum worktree terkelola yang dipertahankan di seluruh repositori. Worktree yang lebih lama dibuatkan snapshot dan dihapus terlebih dahulu. Atur ke 0 untuk menonaktifkan batas jumlah.`,
      cleanupMaxSize: `Ukuran total maksimum (GB)`,
      cleanupMaxSizeHelp: `Ukuran total maksimum dalam GB di seluruh worktree terkelola. Atur ke 0 untuk menonaktifkan batas ukuran.`,
...
Hapus tanpa snapshot?`,
    ...
    agentScope: { label: `Cakupan agen`, allAgents: `Semua agen` },
    newSession: {
      title: `Sesi baru`,
      ...
      createOutcomeUnknown: `Gateway berubah saat sesi ini dimulai. Periksa sesi terbaru sebelum memulai tugas ini lagi.`,
      catalogUnavailable: `Target sesi ini tidak tersedia.`,
    },
    sessionsView: {
      deletePreservedWorktrees: `{count} worktree sesi dengan pekerjaan yang belum di-commit atau belum di-push tetap disimpan ({branches}). Kelola di Settings -> Worktrees.`,
      deletePreservedWorktreeConfirm: `Worktree sesi ini memiliki pekerjaan yang belum di-commit atau belum di-push, sehingga tetap disimpan ({branch}). Tetap hapus checkout?`,
      title: `Sesi`,
      ...
      transcriptSearchDescription: `Temukan kata atau frasa yang persis sama dalam pesan pengguna dan asisten di seluruh sesi agen default.`,
      ...
      transcriptSearchIndexing: `Indeks transkrip masih diperbarui. Coba lagi untuk menyertakan pesan terbaru.`,
      ...
      deleteGroupConfirm: `Hapus grup "{group}"? Sesi-sesinya akan dipindahkan ke Tidak dikelompokkan.`,
    ...
    agents: {
      ...
      identity: {
        ...
        imageUnusable: `Gambar tersebut tidak dapat digunakan. Pilih file gambar berukuran hingga 2 MB.`,
      ...
      toolCatalog: {
        ...
        profiles: { minimal: `Minimal`, coding: `Coding`, messaging: `Pesan`, full: `Penuh` },
      },
      skillsPanel: {
        title: `Skills`,
        ...
        allEnabled: `Semua skill diaktifkan. Menonaktifkan skill apa pun akan membuat daftar izin per-agen.`,
    ...
    configForm: {
      ...
      sections: {
        ...
        agents: { label: `Agen`, description: `Konfigurasi agen, model, dan identitas` },
        auth: { label: `Autentikasi`, description: `Kunci API dan profil autentikasi` },
        channels: {
          label: `Channels`,
          description: `Saluran pesan (Telegram, Discord, Slack, dll.)`,
        },
        messages: { label: `Pesan`, description: `Pengaturan penanganan dan perutean pesan` },
        commands: { label: `Perintah`, description: `Perintah slash khusus` },
        hooks: { label: `Hooks`, description: `Webhook dan hook peristiwa` },
        skills: { label: `Skills`, description: `Paket Skills dan kemampuan` },
        tools: { label: `Tools`, description: `Konfigurasi tool (browser, pencarian, dll.)` },
        gateway: {
          label: `Gateway`,
          description: `Pengaturan server Gateway (port, auth, binding)`,
        },
        wizard: { label: `Wizard Penyiapan`, description: `Status dan riwayat wizard penyiapan` },
        meta: { label: `Metadata`, description: `Metadata Gateway dan informasi versi` },
        logging: { label: `Logging`, description: `Level log dan konfigurasi keluaran` },
        browser: { label: `Browser`, description: `Pengaturan otomatisasi browser` },
        ui: { label: `UI`, description: `Preferensi antarmuka pengguna` },
        models: { label: `Model`, description: `Konfigurasi model AI dan penyedia` },
        bindings: { label: `Binding`, description: `Binding tombol dan pintasan` },
        broadcast: { label: `Broadcast`, description: `Pengaturan broadcast dan notifikasi` },
        audio: { label: `Audio`, description: `Pengaturan input/output audio` },
        session: { label: `Sesi`, description: `Manajemen dan persistensi sesi` },
        cron: { label: `Cron`, description: `Tugas terjadwal dan otomatisasi` },
        web: { label: `Web`, description: `Pengaturan server web dan API` },
        discovery: { label: `Discovery`, description: `Penemuan layanan dan jaringan` },
        canvasHost: { label: `Canvas Host`, description: `Rendering dan tampilan canvas` },
        talk: { label: `Talk`, description: `Pengaturan suara dan ucapan` },
        plugins: { label: `Plugin`, description: `Manajemen plugin dan ekstensi` },
        diagnostics: {
          label: `Diagnostik`,
          description: `Pengaturan instrumentasi, OpenTelemetry, dan cache-trace`,
        },
        cli: { label: `CLI`, description: `Banner CLI dan perilaku startup` },
        secrets: { label: `Secrets`, description: `Konfigurasi penyedia secret` },
        acp: {
          label: `ACP`,
          description: `Pengaturan runtime dan streaming Agent Communication Protocol`,
        },
        mcp: { label: `MCP`, description: `Definisi server Model Context Protocol` },
      },
    },
    quickSettings: {
      language: `Bahasa`,
      model: {
        ...
        thinking: `Thinking`,
        fastMode: `Mode cepat`,
        thinkingLevels: { off: `Nonaktif`, low: `Rendah`, medium: `Sedang`, high: `Tinggi` },
        fastModes: { auto: `Otomatis`, fast: `Cepat`, standard: `Standar` },
      },
      channels: {
        title: `Saluran`,
      ...
      personal: {
        ...
        overrideHint: `Menyimpan penggantian Control UI. Hapus untuk kembali ke avatar yang dikonfigurasi.`,
    ...
    configView: {
      ...
      themes: {
        claw: { label: `Claw`, description: `Keluarga Chroma` },
        knot: { label: `Knot`, description: `Hitam & merah` },
        dash: { label: `Dash`, description: `Blueprint cokelat` },
      },
      textSizes: { small: `Kecil`, default: `Default`, large: `Besar`, xl: `XL`, xxl: `XXL` },
      notifications: {
        ...
        blockedHint: `Notifikasi diblokir. Perbarui izin situs browser Anda untuk mengizinkan notifikasi.`,
      },
      appearance: {
        theme: `Tema`,
        ...
        tweakcnInstructions: `Buka tweakcn.com, pilih atau buat tema, klik Share, lalu tempel tautan tema yang disalin di sini. Tautan share, URL editor, URL registry, ID tema, dan nama tema default seperti amethyst-haze diterima.`,
        ...
        inlineHintAfter: `untuk menambahkan satu tema tweakcn lokal browser. Di tweakcn, gunakan Share dan tempel tautan yang disalin di sini.`,
        textSize: `Ukuran teks`,
      },
      chatPrefs: { title: `Chat`, hint: `Preferensi chat lokal di browser.` },
      connection: { title: `Koneksi`, gateway: `Gateway`, status: `Status`, assistant: `Asisten` },
      root: `<root>`,
      itemCount: `[{count} item]`,
      ...
      rawDisabled: `Mode mentah dinonaktifkan (snapshot tidak dapat melakukan round-trip teks mentah dengan aman).`,
      open: `Terbuka`,
      clear: `Hapus`,
      apply: `Terapkan`,
      applying: `Menerapkan…`,
      ...
      invalidConfig: `Konfigurasi Anda tidak valid. Beberapa pengaturan mungkin tidak berfungsi seperti yang diharapkan.`,
      ...
      formUnsafe: `Konfigurasi Anda berisi bidang yang tidak dapat diwakili dengan aman oleh editor formulir. Gunakan mode Raw untuk mengedit entri tersebut.`,
      ...
      sensitiveHidden: `{count} nilai sensitif disembunyikan. Gunakan tombol tampilkan di atas untuk menyunting konfigurasi mentah.`,
      sensitiveHiddenPlural: `{count} nilai sensitif disembunyikan. Gunakan tombol tampilkan di atas untuk menyunting konfigurasi mentah.`,
    },
    execApproval: {
    ...
    agentTools: {
      ...
      explicitAllowlist: `Agen ini menggunakan allowlist eksplisit dalam konfigurasi. Penggantian alat dikelola di tab Config.`,
      globalAllowlist: `tools.allow global telah disetel. Penggantian agen tidak dapat mengaktifkan alat yang diblokir secara global.`,
      loadingCatalog: `Memuat katalog alat runtime…`,
      catalogFallback: `Tidak dapat memuat katalog alat runtime. Menampilkan daftar fallback bawaan sebagai gantinya.`,
    ...
    browser: {
      ...
      annotatePrompt: {
        introTitled: `Saya menganotasi halaman di {url} (judul yang dilaporkan halaman: "{title}") — tangkapan layar terlampir menunjukkan markup saya.`,
        introUntitled: `Saya menganotasi halaman di {url} — tangkapan layar terlampir menunjukkan markup saya.`,
        region: `Wilayah yang ditandai {index}: berpusat sekitar {x}% ke samping / {y}% ke bawah, mencakup sekitar {width}% × {height}% dari tampilan.`,
        moreRegions: `…ditambah {count} wilayah lain yang ditandai, semuanya terlihat di tangkapan layar.`,
        elementDetail: `Elemen yang ditandai (dilaporkan halaman): {descriptor} — {width}×{height}px pada ({x}, {y}).`,
    ...
    memoryImport: {
      ...
      confirmBackup: `OpenClaw membuat cadangan pra-impor yang terverifikasi sebelum menyalin memori.`,
      confirmImport: `Impor memori`,
      disconnected: `Hubungkan ke Gateway untuk mengimpor memori.`,
      title: `Impor memori asisten`,
      subtitle: `Tinjau memori gabungan Codex dan memori otomatis Claude Code sebelum menyalinnya ke OpenClaw.`,
      agent: `Agen tujuan`,
    ...
    mcpPage: {
      ...
      operatorCommandsHint: `Status, diagnostik, autentikasi, pemeriksaan, dan pemuatan ulang runtime.`,
      runtimeHint: `Perubahan runtime berlaku setelah simpan dan publikasi; agen aktif membangun ulang runtime MCP saat digunakan berikutnya.`,
    ...
    pluginsPage: {
      ...
      connectorAddedOauth: `{name} ditambahkan. Autentikasi dengan “{command}”, lalu mulai ulang gateway.`,
      connectorAddedEndpoint: `{name} ditambahkan. Perbarui endpoint dan kredensial di pengaturan MCP sebelum digunakan.`,
      ...
      connectorDescriptions: {
        ...
        context7: `Dokumen pustaka dan contoh kode spesifik versi saat coding. Tanpa perlu mendaftar.`,
      ...
      mcpHint: `Hubungkan server Model Context Protocol untuk memberi agen Anda alat tambahan. Perubahan berlaku untuk sesi agen baru.`,
      mcpAdd: `Tambahkan server`,
      mcpAdding: `Menambahkan…`,
      mcpEmpty: `Belum ada server MCP yang dikonfigurasi. Tambahkan satu di sini atau pilih konektor dari Discover.`,
      mcpNameLabel: `Nama`,
      ...
      installedRestart: `{name} telah diinstal. Restart Gateway diperlukan untuk menerapkan perubahan.`,
      enabledSuccess: `{name} telah diaktifkan.`,
      enabledRestart: `{name} telah diaktifkan. Restart Gateway diperlukan untuk menerapkan perubahan.`,
      disabledSuccess: `{name} telah dinonaktifkan.`,
      disabledRestart: `{name} telah dinonaktifkan. Restart Gateway diperlukan untuk menerapkan perubahan.`,
    },
    aboutPage: {
      ...
      gatewayVersionHint: `Dilaporkan oleh koneksi Gateway aktif; terpisah dari build Control UI ini.`,
    },
    profilePage: {
    ...
    tasksPage: {
      ...
      runtime: { subagent: `Subagent`, cron: `Cron`, acp: `ACP`, cli: `CLI`, unknown: `Tugas` },
    },
    skillWorkshop: {
      ...
      header: {
        ...
        useCurrentChatTooltip: `Kirim permintaan revisi ke sesi obrolan saat ini alih-alih sesi workshop proposal.`,
        selfLearning: `Pembelajaran mandiri`,
        selfLearningAria: `Aktifkan atau nonaktifkan usulan Skills dari pembelajaran mandiri`,
        selfLearningTooltip: `Catat koreksi dan tinjau pekerjaan penting yang telah diselesaikan untuk dijadikan proposal skill yang tertunda. Menggunakan token latar belakang tambahan; draf muncul di papan ini sebagai proposal tertunda.`,
      ...
      recency: { today: `Hari ini`, yesterday: `Kemarin`, earlier: `Awal minggu ini` },
      ...
      revision: {
        title: `{verb} proposal`,
        description: `Beri tahu agen apa yang harus diubah. Proposal tetap menunggu dan workshop akan membuat versi revisi.`,
        placeholder: `Contoh: Buat ini menggunakan label Gmail alih-alih pencarian belum dibaca, dan tambahkan langkah dry-run yang lebih aman.`,
      ...
      empty: {
        ...
        appliedBody: `Gunakan proposal tertunda dan proposal itu akan muncul di sini sebagai skill aktif.`,
        ...
        quarantinedBody: `Proposal yang diblokir pemindai atau ditahan demi keamanan akan muncul di sini.`,
      ...
      selfLearning: {
        ...
        pitchBody: `OpenClaw meninjau koreksi dan proses penting yang telah diselesaikan, lalu menyusun draf proposal skill untuk papan ini. Fitur ini menggunakan token latar belakang tambahan dan draf akan muncul sebagai proposal tertunda.`,
      ...
      today: {
        ...
        emptyBody: `Agen Anda belum membuat draf apa pun yang baru. Beralih ke Board untuk menjelajahi riwayat.`,
        new: `BARU`,
        waiting: `MENUNGGU`,
        reviewed: `DITINJAU`,
        agent: `agen`,
    ...
    activity: {
      ...
      status: { running: `Berjalan`, done: `Selesai`, error: `Kesalahan` },
      duration: { ms: `{count} ms`, seconds: `{count} dtk`, minutes: `{minutes}m {seconds}dtk` },
    },
    logsView: {
      title: `Logs`,
    ...
    workboard: {
      ...
      agentFilterConfiguredDefaultHelp: `Kartu yang secara eksplisit ditetapkan ke agen default yang dikonfigurasi.`,
...
Pengujian:`,
    ...
    palette: {
      ...
      categories: { search: `Pencarian`, navigation: `Navigasi`, skills: `Skills` },
      items: {
        sessions: `Sesi`,
        scheduled: `Terjadwal`,
        skills: `Skills`,
      ...
      footer: { navigate: `navigasi`, select: `pilih`, close: `tutup` },
    },
    dreaming: {
      tabs: { scene: `Scene`, diary: `Diary`, advanced: `Lanjutan` },
      header: {
        refresh: `Muat ulang`,
        refreshing: `Menyegarkan…`,
        on: `Dreaming Aktif`,
      ...
      phase: { light: `Ringan`, deep: `Dalam`, rem: `Rem`, off: `nonaktif` },
      advanced: {
        eyebrow: `Tinjau`,
      ...
      wiki: {
        ...
        dreamsExplainer: `Ini adalah diary mimpi mentah yang ditulis sistem saat memutar ulang dan mengonsolidasikan memori; gunakan untuk memeriksa apa yang diperhatikan sistem memori, dan di mana ia masih tampak berisik atau tipis.`,
        insightsExplainer: `Ini adalah wawasan yang diimpor yang dikelompokkan dari riwayat eksternal; gunakan untuk meninjau apa yang muncul dari impor sebelum ada yang berkembang menjadi memori yang tahan lama.`,
        palaceExplainer: `Ini adalah permukaan wiki memori terkompilasi yang dapat dicari dan dinalar oleh sistem; gunakan untuk memeriksa halaman memori aktual, klaim, pertanyaan terbuka, dan kontradiksi alih-alih obrolan sumber yang diimpor mentah.`,
        copyArchivePath: `Salin path arsip`,
        loadingInsights: `Memuat wawasan yang diimpor…`,
        noInsights: `Belum ada wawasan yang diimpor`,
        noInsightsHint: `Jalankan impor ChatGPT dengan apply untuk memunculkan wawasan yang diimpor dan dikelompokkan di sini.`,
        ...
        emptyPalaceHint: `Saat ini wiki sebagian besar berisi impor sumber mentah dan laporan operasional. Tab ini menjadi berguna setelah sintesis, entitas, atau konsep mulai ditulis.`,
        claims: `Klaim`,
    ...
    usage: {
      common: { emptyValue: `—`, unknown: `tidak diketahui` },
      loading: { title: `Ikhtisar Penggunaan`, badge: `Memuat` },
      metrics: { tokens: `Token`, cost: `Biaya`, session: `sesi`, sessions: `sesi` },
      providerUsage: {
        title: `Paket & penagihan penyedia`,
        subtitle: `Data paket, kuota, saldo, dan anggaran langsung yang dilaporkan oleh penyedia yang dikonfigurasi.`,
        balance: `Saldo`,
        spend: `Penggunaan`,
        budget: `Anggaran`,
        today: `Hari ini`,
      ...
      export: { label: `Ekspor`, sessionsCsv: `CSV Sesi`, dailyCsv: `CSV Harian`, json: `JSON` },
      cacheStatus: {
        ...
        status: { refreshing: `menyegarkan`, stale: `kedaluwarsa`, partial: `sebagian` },
      },
      empty: {
      ...
      daily: {
        ...
        compressedScaleHint: `Skala akar kuadrat menjaga hari dengan penggunaan rendah tetap terlihat.`,
      },
      costWindows: {
        title: `Rentang biaya`,
    ...
    login: {
      ...
      failure: {
        ...
        authRequired: {
          ...
          summary: `Gateway dapat dijangkau, tetapi memerlukan token atau kata sandi yang cocok sebelum browser ini dapat terhubung.`,
          stepPaste: `Tempel token dari openclaw dashboard --no-open atau masukkan kata sandi yang dikonfigurasi.`,
          stepGenerate: `Jika belum ada token yang dikonfigurasi, jalankan openclaw doctor --generate-gateway-token di host Gateway.`,
          stepConnect: `Klik Connect lagi setelah memperbarui kredensial.`,
        },
        authFailed: {
          title: `Auth tidak cocok`,
          summary: `Kredensial yang diberikan ditolak. Penyebab paling umum adalah token kedaluwarsa atau token yang disalin dari URL Gateway lain.`,
          stepDashboard: `Jalankan openclaw dashboard --no-open lalu buka URL baru atau tempel tokennya.`,
          stepReplace: `Ganti nilai token/kata sandi yang lama; jangan gunakan ulang token dari URL Gateway lain.`,
          stepMode: `Gunakan satu mode auth yang cocok pada satu waktu: token gateway untuk mode token, kata sandi untuk mode kata sandi.`,
        },
        rateLimited: {
          ...
          stepWait: `Tunggu pembatas auth mereda, lalu hubungkan ulang dengan kredensial yang sudah diperbaiki.`,
          stepCheckClients: `Jika ini host bersama, periksa klien lain yang terus mencoba dengan kredensial salah.`,
        },
        pairing: {
          ...
          summary: `Browser ini memerlukan persetujuan satu kali dari host Gateway sebelum dapat menggunakan Control UI.`,
          upgradeSummary: `Browser ini sudah dikenal, tetapi akses yang diminta berubah dan memerlukan persetujuan baru.`,
        ...
        insecure: {
          ...
          summary: `Halaman ini berjalan melalui HTTP biasa, sehingga browser tidak dapat membuat identitas perangkat yang diharapkan Gateway.`,
          stepHttps: `Gunakan HTTPS/Tailscale Serve, atau buka http://127.0.0.1:18789 di host Gateway.`,
          stepLocalCompat: `Untuk kompatibilitas lokal hanya-token, setel gateway.controlUi.allowInsecureAuth: true.`,
        ...
        origin: {
          ...
          stepFullOrigin: `Gunakan origin lengkap seperti http://localhost:5173, bukan pola wildcard.`,
          stepRestart: `Mulai ulang atau muat ulang Gateway setelah mengubah origin yang diizinkan.`,
        },
        protocol: {
          title: `Protokol tidak cocok`,
          summary: `Control UI yang disajikan dan Gateway yang berjalan tidak sepakat tentang protokol koneksi yang didukung.`,
          stepDashboard: `Buka kembali dashboard yang disajikan dengan openclaw dashboard agar UI dan Gateway berasal dari instalasi yang sama.`,
          stepDevUi: `Jika menggunakan pnpm ui:dev, bangun ulang atau mulai ulang UI dev terhadap checkout saat ini.`,
          stepRestart: `Mulai ulang Gateway setelah memperbarui OpenClaw agar menyajikan protokol saat ini.`,
        },
        network: {
          title: `Tidak dapat terhubung`,
          summary: `Browser tidak dapat menyelesaikan koneksi Gateway. Periksa target dan transport sebelum mencoba ulang kredensial.`,
          stepGateway: `Pastikan Gateway berjalan dengan openclaw status atau openclaw gateway run.`,
          stepUrl: `Periksa URL WebSocket dan gunakan wss:// saat Gateway berada di belakang HTTPS/Tailscale Serve.`,
          stepDashboard: `Buka kembali dashboard dengan openclaw dashboard --no-open untuk menyalin ulang URL dan detail auth saat ini.`,
        },
      },
    },
    chat: {
      ...
      pullRequests: {
        ...
        rateLimited: `Batas laju GitHub API tercapai. Status pull request mungkin tidak terbaru hingga batas direset.`,
      },
      ...
      compaction: {
        ...
        description: `Transkrip yang dipadatkan disimpan sebagai checkpoint. Buka checkpoint sesi untuk membuat cabang atau memulihkan dari tampilan yang dipadatkan tersebut.`,
      ...
      commands: {
        ...
        categories: { session: `Sesi`, model: `Model`, agents: `Agen`, tools: `Alat` },
      },
      splitView: {
      ...
      modelControls: { default: `Default`, reasoning: `Penalaran`, speed: `Kecepatan` },
      sideChat: {
      ...
      composer: {
        ...
        microphonePermissionBlocked: `Akses mikrofon diblokir. Izinkan di pengaturan situs browser untuk menampilkan daftar input.`,
        realtimeTalkRequiresMicrophone: `Input suara realtime memerlukan akses mikrofon browser.`,
        selectedMicrophoneUnavailable: `Mikrofon yang dipilih tidak tersedia. Pilih input lain atau default Sistem.`,
      ...
      workspaceFiles: {
        ...
        truncated: `Menampilkan file pertama yang cocok. Perbaiki pencarian untuk mempersempit hasil.`,
        session: `Sesi`,
        missing: `Hilang`,
    ...
    cron: {
      tabs: { filterLabel: `Status otomatisasi`, all: `Semua`, active: `Aktif`, paused: `Dijeda` },
      list: {
        ...
        emptyHint: `Jelaskan apa yang harus dilakukan OpenClaw dan kapan — ia berjalan sesuai jadwal.`,
      ...
      suggestions: {
        ...
        ideas: {
          repoPulse: {
            ...
            prompt: `Tinjau aktivitas semalam di repositori saya: isu baru, pull request, dan kegagalan CI. Rangkum tiga hal yang paling membutuhkan perhatian saya hari ini, masing-masing dengan tautan dan alasan satu baris.`,
          },
          standupGhostwriter: {
            name: `Ghostwriter standup`,
            tagline: `Update standup Anda, disusun dari pekerjaan kemarin.`,
            prompt: `Buat update standup saya dari commit kemarin, pull request yang telah digabung, dan thread ulasan yang masih terbuka. Maksimal tiga poin: selesai, sedang dikerjakan, terblokir.`,
          },
          hackerNewsScout: {
            name: `Penjelajah Hacker News`,
            tagline: `Tiga tautan layak dibaca sambil ngopi, lengkap dengan opini singkat.`,
            prompt: `Pindai halaman depan Hacker News hari ini untuk postingan tentang AI agents, developer tooling, dan TypeScript. Kirimkan tiga tautan paling menarik, masing-masing dengan opini singkat satu baris.`,
          },
          dependencyRadar: {
            name: `Radar dependensi`,
            tagline: `Dependensi usang atau rentan, dengan catatan peningkatan.`,
            prompt: `Periksa proyek utama saya untuk dependensi yang usang atau rentan. Daftarkan pembaruan penting dengan catatan risiko satu baris masing-masing, dan buat perintah peningkatannya.`,
          },
          watchdog: {
            name: `Penjaga malam`,
          ...
          polyglotMinute: {
            ...
            prompt: `Ajarkan saya satu frasa berguna dalam bahasa Jepang: frasanya, cara pengucapannya, arti harfiahnya, dan kapan menggunakannya. Jaga agar tidak lebih dari lima baris.`,
          },
        },
      },
      stats: { tasks: `Tugas`, failing: `Gagal`, nextWake: `Bangun berikutnya` },
      detail: {
...
export { t as id };
//# sourceMappingURL=id-DM6ZG402.js.map
