...
function r(e, t) {
  ...
  if (l.propertyIsEnumerable(o))
    return (m.propertyIsEnumerable(o) && (v = `newstatement`), `keyword`);
  if (u.propertyIsEnumerable(o))
    return (m.propertyIsEnumerable(o) && (v = `newstatement`), `variable`);
  if (d.propertyIsEnumerable(o))
    return (m.propertyIsEnumerable(o) && (v = `newstatement`), `modifier`);
  if (f.propertyIsEnumerable(o)) return (m.propertyIsEnumerable(o) && (v = `newstatement`), `type`);
  if (p.propertyIsEnumerable(o))
    return (m.propertyIsEnumerable(o) && (v = `newstatement`), `builtin`);
  for (var s = o.length - 1; s >= 0 && (!isNaN(o[s]) || o[s] == `_`);) --s;
  if (s > 0) {
    var c = o.substr(0, s + 1);
    if (f.propertyIsEnumerable(c))
      return (m.propertyIsEnumerable(c) && (v = `newstatement`), `type`);
  }
  return h.propertyIsEnumerable(o) ? `atom` : null;
}
function i(e) {
  return function (t, n) {
    for (var i = !1, a, o = !1; (a = t.next()) != null;) {
      if (a == e && !i) {
        o = !0;
        break;
      }
    ...
    return ((o || !i) && (n.tokenize = r), `string`);
  };
}
function a(e, t) {
  ...
  ((l = t(
    ...
    (y = {
      ...
      startState: function (e) {
        return { tokenize: null, context: new o(-e, 0, `top`, !1), indented: 0, startOfLine: !0 };
      },
      token: function (e, t) {
        var n = t.context;
        if (
        ...
        if (((n.align ??= !0), (v == `;` || v == `:`) && n.type == `statement`)) c(t);
        else if (v == `{`) s(t, e.column(), `}`);
        else if (v == `[`) s(t, e.column(), `]`);
        else if (v == `(`) s(t, e.column(), `)`);
        else if (v == `}`) {
          ...
          v == n.type
            ...
            : (n.type == `}` ||
                n.type == `top` ||
                (n.type == `statement` && v == `newstatement`)) &&
              s(t, e.column(), `statement`);
        return ((t.startOfLine = !1), i);
      },
      indent: function (e, t, n) {
        if (e.tokenize != r && e.tokenize != null) return 0;
        var i = e.context,
          a = t && t.charAt(0);
        i.type == `statement` && a == `}` && (i = i.prev);
        var o = a == i.type;
        return i.type == `statement`
          ? i.indented + (a == `{` ? 0 : n.unit)
          : i.align
            ? i.column + +!o
            : i.indented + (o ? 0 : n.unit);
      },
      languageData: { indentOnInput: /^\s*[{}]$/ },
    }));
})();
export { y as ecl };
//# sourceMappingURL=ecl-S_h57pHg.js.map
