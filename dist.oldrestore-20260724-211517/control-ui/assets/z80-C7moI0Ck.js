...
function t(e) {
  ...
  e
    ? ((t =
      ...
      (n = /^(((call|j[pr]|rst|ret[in]?)(\.([sl]?i)?[sl])?)|(rs|st)mix)\b/i))
    : ((t =
  ...
  var r = /^(af?|bc?|c|de?|e|hl?|l|i[xy]?|r|sp)\b/i,
    i = /^(n?[zc]|p[oe]?|m)\b/i,
  ...
  return {
    ...
    token: function (s, c) {
      ...
      var l;
      if (s.eatWhile(/\w/))
        if ((e && s.eat(`.`) && s.eatWhile(/\w/), (l = s.current()), s.indentation())) {
          ...
          if (t.test(l)) return ((c.context = 1), `keyword`);
          if (n.test(l)) return ((c.context = 2), `keyword`);
...
export { n as z80 };
//# sourceMappingURL=z80-C7moI0Ck.js.map
