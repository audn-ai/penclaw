...
function t(e, t) {
  ...
  if (e.match(h)) return [null, `number`];
  if (e.match(g)) return [null, `string.special`];
  if (e.eat(/^"/)) return (t.tokenize = n)(e, t);
...
e(() => {
  ((o = [`false`, `nil`, `true`]),
    ...
    (v = {
      name: `clojure`,
      startState: function () {
        return { ctx: { prev: null, start: 0, indentTo: 0 }, lastToken: null, tokenize: t };
      },
      token: function (e, t) {
        ...
        return (
          ...
          r === `open`
            ...
            : r === `close` && (t.ctx = t.ctx.prev || t.ctx),
          i
        );
      },
      indent: function (e) {
      ...
      languageData: {
        ...
        commentTokens: { line: `;;` },
        autocomplete: [].concat(o, s, c),
      },
    }));
})();
export { v as clojure };
//# sourceMappingURL=clojure-CxJvrtAf.js.map
