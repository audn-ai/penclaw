...
e(() => {
  t = {
    ...
    mcpApp: { title: `MCP App`, unavailable: `MCP App no disponible: {error}` },
    githubPreview: {
    ...
    channels: {
      ...
      refreshingStaleSnapshot: `Actualizando el estado del canal en segundo plano; se muestra la última instantánea correcta.`,
      hub: {
        ...
        partialSnapshot: `Algunas comprobaciones de canales no finalizaron antes de agotarse el tiempo asignado a la interfaz.`,
        ...
        browseAllSubtitle: `Explora todos los canales disponibles, incluidos los plugins instalables.`,
        runSetup: `Iniciar configuración`,
        saveBeforeSetup: `Tienes cambios sin guardar en la configuración del canal. Guárdalos o vuelve a cargarlos antes de iniciar la configuración guiada.`,
      },
      setup: {
        ...
        doneBody: `Configuración guardada. El gateway recarga el canal automáticamente; consulta su tarjeta para ver el estado en tiempo real.`,
        doneNoChangesTitle: `No se realizaron cambios`,
        doneNoChangesBody: `La configuración finalizó sin configurar ningún canal. No se guardó nada.`,
        whatsappScanTitle: `Vincula WhatsApp escaneando el código QR`,
        whatsappScanHelp: `En tu teléfono, abre WhatsApp → Configuración → Dispositivos vinculados → Vincular un dispositivo y, a continuación, escanea este código.`,
      ...
      generic: { subtitle: `Estado y configuración del canal.` },
      discord: { title: `Discord`, subtitle: `Estado del bot y configuración del canal.` },
      googleChat: {
        title: `Google Chat`,
      ...
      signal: { title: `Signal`, subtitle: `Estado de signal-cli y configuración del canal.` },
      slack: { title: `Slack`, subtitle: `Estado del modo Socket y configuración del canal.` },
      telegram: { title: `Telegram`, subtitle: `Estado del bot y configuración del canal.` },
      whatsapp: {
        title: `WhatsApp`,
    ...
    lazyView: {
      ...
      staleSubtitle: `OpenClaw se actualizó en segundo plano. Recarga para obtener el panel más reciente.`,
      retry: `Reintentar`,
    },
    nodes: {
      pairing: {
        ...
        fullAccessHint: `Nodo y controles completos del Gateway, incluidos los ajustes y las actualizaciones.`,
        ...
        transportLimitedHint: `Esta URL del Gateway usa texto sin cifrar mediante ws://. Usa wss:// o Tailscale Serve y, a continuación, crea un código nuevo para obtener acceso completo.`,
        ...
        review: `Revisión`,
        waiting: `Las apps móviles oficiales de OpenClaw se conectan automáticamente después de escanear.`,
      ...
      inventory: {
        ...
        versionDriftTitle: `Nodo {nodeVersion}; Gateway {gatewayVersion}. Actualiza el componente más antiguo para alinear la flota.`,
        manualWake: `activación manual requerida`,
        manualWakeTitle: `El Gateway no puede activar un nodo de Windows sin conexión. Inicia la máquina o restaura su conexión de red.`,
        ...
        removeStalePromptBody: `Los clientes afectados volverán a emparejarse automáticamente en su próxima conexión.`,
        gateway: `gateway`,
    ...
    worktrees: {
      ...
      cleanupSubtitle: `OpenClaw elimina periódicamente los worktrees antiguos para liberar espacio en disco. Ajusta la intensidad de la limpieza.`,
      cleanupMaxCount: `Máximo de worktrees`,
      cleanupMaxCountHelp: `Número máximo de worktrees administrados que se conservarán en todos los repositorios. Primero se crean instantáneas de los worktrees más antiguos y luego se eliminan. Establécelo en 0 para desactivar el límite de cantidad.`,
      cleanupMaxSize: `Tamaño total máximo (GB)`,
      cleanupMaxSizeHelp: `Tamaño total máximo en GB de todos los worktrees administrados. Establécelo en 0 para desactivar el límite de tamaño.`,
...
¿Eliminar sin snapshot?`,
    ...
    agentScope: { label: `Ámbito del agente`, allAgents: `Todos los agentes` },
    newSession: {
      title: `Nueva sesión`,
      ...
      createOutcomeUnknown: `El Gateway cambió mientras se iniciaba esta sesión. Comprueba las sesiones recientes antes de volver a iniciar esta tarea.`,
      catalogUnavailable: `El destino de esta sesión no está disponible.`,
    },
    sessionsView: {
      deletePreservedWorktrees: `Se conservaron {count} worktree(s) de sesión con trabajo sin confirmar o sin enviar ({branches}). Gestiónalos en Settings -> Worktrees.`,
      deletePreservedWorktreeConfirm: `El worktree de la sesión tiene trabajo sin confirmar o sin enviar, por lo que se conservó ({branch}). ¿Eliminar el checkout de todos modos?`,
      title: `Sesiones`,
      ...
      transcriptSearchDescription: `Encuentra palabras o frases exactas en los mensajes del usuario y del asistente de las sesiones del agente predeterminado.`,
      ...
      transcriptSearchUnavailable: `La búsqueda de transcripciones requiere una versión más reciente de Gateway.`,
      transcriptSearchError: `Error al buscar transcripciones`,
      transcriptSearchIndexing: `El índice de transcripciones aún se está actualizando. Vuelve a intentarlo para incluir mensajes recientes.`,
    ...
    agents: {
      ...
      identity: {
        ...
        fileHint: `Los agentes pueden configurar esto por sí mismos editando IDENTITY.md en su espacio de trabajo.`,
      },
      overview: {
        title: `Resumen`,
      ...
      skillsPanel: {
        ...
        allEnabled: `Todas las Skills están habilitadas. Deshabilitar cualquier Skill creará una lista de permitidos por agente.`,
        loadAgent: `Carga las Skills de este agente para ver las entradas específicas del área de trabajo.`,
        filter: `Filtrar`,
    ...
    configForm: {
      ...
      structuredSecretFile: `Valor estructurado (SecretRef): edita el archivo de configuración directamente`,
      defaultValue: `Predeterminado: {value}`,
      ...
      sections: {
        ...
        auth: { label: `Autenticación`, description: `Claves de API y perfiles de autenticación` },
        channels: {
          label: `Canales`,
        ...
        hooks: { label: `Hooks`, description: `Webhooks y hooks de eventos` },
        skills: { label: `Skills`, description: `Paquetes de Skills y capacidades` },
        tools: {
          label: `Herramientas`,
        ...
        meta: { label: `Metadatos`, description: `Metadatos del Gateway e información de versión` },
        logging: {
          label: `Registro`,
        ...
        ui: { label: `UI`, description: `Preferencias de la interfaz de usuario` },
        models: { label: `Modelos`, description: `Configuraciones y proveedores de modelos de IA` },
        bindings: { label: `Atajos`, description: `Combinaciones de teclas y atajos` },
        broadcast: { label: `Difusión`, description: `Configuración de difusión y notificaciones` },
        audio: { label: `Audio`, description: `Configuración de entrada/salida de audio` },
        session: { label: `Sesión`, description: `Gestión y persistencia de sesiones` },
        cron: { label: `Cron`, description: `Tareas programadas y automatización` },
        web: { label: `Web`, description: `Configuración del servidor web y la API` },
        discovery: { label: `Descubrimiento`, description: `Descubrimiento de servicios y redes` },
        canvasHost: { label: `Canvas Host`, description: `Renderizado y visualización del lienzo` },
        talk: { label: `Talk`, description: `Configuración de voz y habla` },
        plugins: { label: `Plugins`, description: `Gestión de plugins y extensiones` },
        diagnostics: {
          label: `Diagnósticos`,
          description: `Configuración de instrumentación, OpenTelemetry y cache-trace`,
        },
        cli: { label: `CLI`, description: `Comportamiento del banner y arranque de CLI` },
        secrets: { label: `Secrets`, description: `Configuración del proveedor de secretos` },
        acp: {
          label: `ACP`,
          description: `Configuración de tiempo de ejecución y streaming del Agent Communication Protocol`,
        },
        mcp: { label: `MCP`, description: `Definiciones del servidor Model Context Protocol` },
      },
    },
    quickSettings: {
      language: `Idioma`,
      model: {
        ...
        thinkingLevels: { off: `Desactivada`, low: `Baja`, medium: `Media`, high: `Alta` },
        fastModes: { auto: `Automático`, fast: `Rápido`, standard: `Estándar` },
      },
      channels: {
        title: `Canales`,
      ...
      personal: {
        ...
        overrideHint: `Almacena una anulación de Control UI. Bórrala para volver al avatar configurado.`,
        ...
        avatarIssues: {
          remoteBlocked: `Las URLs remotas están bloqueadas por la política de imágenes de Control UI`,
    ...
    configView: {
      ...
      themes: {
        claw: { label: `Claw`, description: `Familia Chroma` },
        knot: { label: `Knot`, description: `Negro y rojo` },
        dash: { label: `Dash`, description: `Plano de chocolate` },
      },
      textSizes: {
        small: `Pequeño`,
      ...
      notifications: {
        ...
        blockedHint: `Las notificaciones están bloqueadas. Actualiza los permisos del sitio en tu navegador para permitir las notificaciones.`,
      },
      appearance: {
        theme: `Tema`,
        ...
        tweakcnInstructions: `Abre tweakcn.com, elige o crea un tema, haz clic en Compartir y luego pega aquí el enlace del tema copiado. Se aceptan enlaces para compartir, URLs del editor, URLs del registro, IDs de tema y nombres de temas predeterminados como amethyst-haze.`,
        ...
        inlineHintAfter: `para agregar un tema de tweakcn local del navegador. En tweakcn, usa Compartir y pega aquí el enlace copiado.`,
        textSize: `Tamaño del texto`,
      },
      chatPrefs: { title: `Chat`, hint: `Preferencias de chat locales del navegador.` },
      connection: {
        title: `Conexión`,
        gateway: `Gateway`,
        status: `Estado`,
      ...
      rawDisabled: `Modo sin procesar deshabilitado (la instantánea no puede procesar de forma segura el texto sin procesar).`,
      open: `Abierto`,
      clear: `Borrar`,
      apply: `Aplicar`,
      applying: `Aplicando…`,
      ...
      invalidConfig: `Tu configuración no es válida. Es posible que algunos ajustes no funcionen como se espera.`,
      ...
      formUnsafe: `Tu configuración contiene campos que el editor de formularios no puede representar de forma segura. Usa el modo Raw para editar esas entradas.`,
      ...
      sensitiveHidden: `{count} valor sensible oculto. Usa el botón de mostrar de arriba para editar la configuración en bruto.`,
      sensitiveHiddenPlural: `{count} valores sensibles ocultos. Usa el botón de mostrar de arriba para editar la configuración en bruto.`,
    },
    execApproval: {
    ...
    agentTools: {
      ...
      explicitAllowlist: `Este agente está usando una lista de permitidos explícita en la configuración. Las anulaciones de herramientas se gestionan en la pestaña Config.`,
      globalAllowlist: `tools.allow global está configurado. Las anulaciones del agente no pueden habilitar herramientas bloqueadas globalmente.`,
      loadingCatalog: `Cargando catálogo de herramientas en tiempo de ejecución…`,
      catalogFallback: `No se pudo cargar el catálogo de herramientas en tiempo de ejecución. Mostrando la lista de reserva integrada en su lugar.`,
      ...
      switchAgent: `Cambia el chat a este agente para ver sus herramientas de tiempo de ejecución en vivo.`,
    ...
    browser: {
      ...
      inspectUnavailable: `La inspección de elementos está deshabilitada (browser.evaluateEnabled=false).`,
      annotationSent: `Anotación añadida al compositor del chat.`,
      annotatePrompt: {
        introTitled: `He anotado la página en {url} (título indicado por la página: "{title}") — la captura de pantalla adjunta muestra mi marcado.`,
        introUntitled: `He anotado la página en {url} — la captura de pantalla adjunta muestra mi marcado.`,
        region: `Región marcada {index}: centrada alrededor de {x}% en horizontal / {y}% hacia abajo, abarca aproximadamente el {width}% × {height}% de la vista.`,
        moreRegions: `…más {count} región(es) marcada(s), todas visibles en la captura de pantalla.`,
        elementDetail: `Elemento marcado (indicado por la página): {descriptor} — {width}×{height}px en ({x}, {y}).`,
    ...
    subtitles: {
      ...
      skillWorkshop: `Revisa, perfecciona y aplica propuestas antes de que se conviertan en Skills activas.`,
    ...
    memoryImport: {
      ...
      confirmDescription: `Copia {count} archivos de memoria seleccionados en el espacio de trabajo de este agente.`,
      confirmReplace: `Antes de reemplazarlos, se realizará una copia de seguridad de los archivos de destino existentes en el informe de migración.`,
      confirmBackup: `OpenClaw crea una copia de seguridad verificada previa a la importación antes de copiar la memoria.`,
      ...
      subtitle: `Revisa la memoria consolidada de Codex y la memoria automática de Claude Code antes de copiarlas en OpenClaw.`,
      agent: `Agente de destino`,
      replaceExisting: `Reemplazar importaciones existentes`,
      replaceHint: `Previsualiza de nuevo los conflictos y conserva copias de seguridad de los elementos antes de reemplazarlos.`,
    },
    mcpPage: {
      ...
      operatorCommandsHint: `Estado, diagnósticos, autenticación, sondeo y recarga en tiempo de ejecución.`,
      runtimeHint: `Los cambios en tiempo de ejecución se aplican tras guardar y publicar; los agentes activos reconstruyen los runtimes de MCP en el próximo uso.`,
    ...
    pluginsPage: {
      ...
      connectorsHint: `Conectores MCP con un clic y búsquedas seleccionadas de ClawHub para servicios populares.`,
      ...
      connectorAddedOauth: `Se añadió {name}. Autentícate con “{command}” y luego reinicia el gateway.`,
      connectorAddedEndpoint: `Se añadió {name}. Actualiza el endpoint y las credenciales en la configuración de MCP antes de usarlo.`,
      connectorAddedReady: `{name} añadido. Las nuevas sesiones de agente pueden usarlo de inmediato.`,
      connectorDescriptions: {
        notion: `Busca, crea y actualiza páginas y bases de datos en tu espacio de trabajo de Notion.`,
        linear: `Clasifica incidencias, actualiza ciclos y registra errores directamente desde el chat.`,
        ...
        email: `Clasificación de la bandeja de entrada, resúmenes y borradores con envío tras aprobación.`,
        ...
        github: `Colas de revisión de PR, clasificación de incidencias y preguntas sobre repositorios a través del MCP oficial de GitHub.`,
        sentry: `Alertas de fallos explicadas y clasificadas en el momento en que se disparan.`,
        context7: `Documentación de bibliotecas y ejemplos de código específicos por versión mientras programas. No requiere registro.`,
        deepwiki: `Haz preguntas sobre cualquier repositorio público de GitHub. Gratis, sin necesidad de cuenta.`,
        huggingFace: `Busca modelos, conjuntos de datos y artículos; ejecuta Spaces como herramientas.`,
        ...
        spotify: `Busca, pon en cola y musicaliza tu día con listas de reproducción según el estado de ánimo.`,
        sonos: `Audio para todo el hogar: reproduce, agrupa habitaciones y pon en cola desde el chat.`,
      ...
      mcpHint: `Conecta servidores Model Context Protocol para dar herramientas adicionales a tu agente. Los cambios se aplican a las nuevas sesiones del agente.`,
      mcpAdd: `Añadir servidor`,
      mcpAdding: `Añadiendo…`,
      mcpEmpty: `Aún no hay servidores MCP configurados. Añade uno aquí o elige un conector en Discover.`,
      mcpNameLabel: `Nombre`,
      mcpTargetLabel: `URL o comando`,
      mcpNameInvalid: `Los nombres de servidor usan letras, números, puntos, guiones o guiones bajos.`,
      ...
      disabledRestart: `{name} deshabilitado. Se requiere reiniciar el Gateway para aplicar el cambio.`,
    },
    aboutPage: {
      ...
      gatewayVersionHint: `Informado por la conexión activa de Gateway; independiente de esta compilación de Control UI.`,
    },
    profilePage: {
      ...
      emptyBody: `Aún no hay actividad de tokens. Envía un mensaje a tu agente y mira cómo se ilumina el arrecife.`,
    ...
    tasksPage: {
      ...
      runtime: { subagent: `Subagente`, cron: `Cron`, acp: `ACP`, cli: `CLI`, unknown: `Tarea` },
    },
    skillWorkshop: {
      ...
      header: {
        ...
        useCurrentChatTooltip: `Enviar las solicitudes de revisión a la sesión de chat actual en lugar de la sesión de workshop de la propuesta.`,
        selfLearning: `Autoaprendizaje`,
        selfLearningAria: `Activar o desactivar las propuestas de Skills de autoaprendizaje`,
        selfLearningTooltip: `Recopila correcciones y revisa trabajos sustanciales completados para convertirlos en propuestas de Skills pendientes. Consume tokens adicionales en segundo plano; los borradores aparecen en este tablero como propuestas pendientes.`,
      ...
      recency: { today: `Hoy`, yesterday: `Ayer`, earlier: `Antes esta semana` },
      ...
      revision: {
        ...
        description: `Indica al agente qué debe cambiar. La propuesta queda pendiente y el workshop creará una versión revisada.`,
        placeholder: `Ejemplo: Haz que use etiquetas de Gmail en lugar de la búsqueda de no leídos y añade un paso de prueba en seco más seguro.`,
      ...
      empty: {
        ...
        rejectedBody: `Las propuestas omitidas se quedarán aquí para un historial de revisión limpio.`,
        quarantinedTitle: `Nada en cuarentena`,
        quarantinedBody: `Las propuestas bloqueadas por el escáner o retenidas por seguridad aparecerán aquí.`,
      ...
      selfLearning: {
        ...
        pitchBody: `OpenClaw revisa las correcciones y las ejecuciones sustanciales completadas y, a continuación, redacta propuestas de Skills para este tablero. Consume tokens adicionales en segundo plano y los borradores aparecen como propuestas pendientes.`,
    ...
    activity: {
      ...
      status: { running: `En ejecución`, done: `Completado`, error: `Error` },
    ...
    workboard: {
      ...
      agentFilterConfiguredDefaultHelp: `Tarjetas asignadas explícitamente al agente predeterminado configurado.`,
...
Pruebas:`,
      ...
      emptyFilteredHint: `Cambia la vista, la búsqueda, la prioridad, el agente o el filtro de archivo.`,
    ...
    connection: {
      ...
      offlineHint: `Las actualizaciones en vivo y las acciones están pausadas hasta que se restablezca la conexión.`,
    ...
    palette: {
      ...
      categories: { search: `Buscar`, navigation: `Navegación`, skills: `Skills` },
      items: {
        sessions: `Sesiones`,
        scheduled: `Programado`,
        skills: `Skills`,
      ...
      footer: { navigate: `navegar`, select: `seleccionar`, close: `cerrar` },
    },
    dreaming: {
      tabs: { scene: `Escena`, diary: `Diario`, advanced: `Avanzado` },
      header: {
        refresh: `Actualizar`,
        refreshing: `Actualizando…`,
        on: `Sueño activado`,
      ...
      phase: { light: `Ligero`, deep: `Profundo`, rem: `Rem`, off: `apagado` },
      advanced: {
        eyebrow: `Revisión`,
      ...
      wiki: {
        ...
        dreamsExplainer: `Este es el diario de sueños sin procesar que el sistema escribe mientras reproduce y consolida la memoria; úsalo para inspeccionar qué está detectando el sistema de memoria y dónde aún parece ruidoso o insuficiente.`,
        insightsExplainer: `Estas son perspectivas importadas agrupadas a partir del historial externo; úsalas para revisar lo que surgió de las importaciones antes de que nada se convierta en memoria duradera.`,
        palaceExplainer: `Esta es la superficie del wiki de memoria compilada que el sistema puede buscar y razonar; úsala para inspeccionar las páginas de memoria reales, afirmaciones, preguntas abiertas y contradicciones en lugar de los chats de origen importados sin procesar.`,
        ...
        noInsightsHint: `Ejecuta una importación de ChatGPT con aplicación para mostrar aquí la información importada agrupada.`,
        ...
        emptyPalaceHint: `Ahora mismo la wiki tiene principalmente importaciones de origen sin procesar e informes operativos. Esta pestaña resulta útil una vez que empiezan a escribirse síntesis, entidades o conceptos.`,
        claims: `Afirmaciones`,
        ...
        unavailablePluginPrefix: `Imported Insights y Memory Palace se proporcionan mediante el complemento incluido`,
    ...
    modelProviders: {
      ...
      apiKey: {
        ...
        authModeBlocked: `Los cambios en la clave de API no están disponibles mientras el modo de autenticación sea "{mode}".`,
      },
      probe: {
      ...
      logout: {
        ...
        confirm: `¿Cerrar sesión en {provider}? Se eliminarán los perfiles de OAuth y de tokens guardados.`,
      ...
      defaults: {
        ...
        subtitle: `Elige el modelo principal, los modelos alternativos ordenados y el modelo de utilidad.`,
    ...
    usage: {
      common: { emptyValue: `—`, unknown: `desconocido` },
      loading: { title: `Resumen de uso`, badge: `Cargando` },
      metrics: { tokens: `Tokens`, cost: `Costo`, session: `sesión`, sessions: `sesiones` },
      providerUsage: {
        title: `Planes y facturación de proveedores`,
        subtitle: `Datos en tiempo real de planes, cuotas, saldos y presupuestos proporcionados por los proveedores configurados.`,
        balance: `Saldo`,
        spend: `Uso`,
        budget: `Presupuesto`,
        today: `Hoy`,
      ...
      cacheStatus: {
        ...
        status: { refreshing: `actualizando`, stale: `desactualizada`, partial: `parcial` },
      },
      empty: {
    ...
    login: {
      ...
      failure: {
        ...
        authRequired: {
          ...
          summary: `Se puede acceder al Gateway, pero necesita un token o una contraseña coincidente antes de que este navegador pueda conectarse.`,
          stepPaste: `Pega el token de openclaw dashboard --no-open o introduce la contraseña configurada.`,
          stepGenerate: `Si no hay token configurado, ejecuta openclaw doctor --generate-gateway-token en el host del Gateway.`,
          stepConnect: `Haz clic en Connect de nuevo después de actualizar la credencial.`,
        },
        authFailed: {
          title: `La autenticación no coincide`,
          summary: `La credencial proporcionada fue rechazada. La causa más común es un token obsoleto o copiado desde otra URL de Gateway.`,
          stepDashboard: `Ejecuta openclaw dashboard --no-open y abre la URL nueva o pega su token.`,
          stepReplace: `Reemplaza valores obsoletos de token/contraseña; no reutilices un token de otra URL de Gateway.`,
          stepMode: `Usa un solo modo de autenticación coincidente a la vez: token de gateway para modo token, contraseña para modo contraseña.`,
        },
        rateLimited: {
          title: `Demasiados intentos fallidos`,
          summary: `El Gateway está limitando temporalmente los intentos de autenticación de este cliente.`,
          stepStop: `Deja de reintentar desde esta pestaña por un momento.`,
          stepWait: `Espera a que el limitador de autenticación se enfríe y vuelve a conectar con la credencial corregida.`,
          stepCheckClients: `Si este es un host compartido, revisa otros clientes por reintentos incorrectos repetidos.`,
        },
        pairing: {
          ...
          summary: `Este navegador necesita una aprobación única del host del Gateway antes de poder usar Control UI.`,
          upgradeSummary: `Este navegador ya es conocido, pero el acceso solicitado cambió y necesita una aprobación nueva.`,
        ...
        insecure: {
          ...
          summary: `Esta página se está ejecutando sobre HTTP simple, por lo que el navegador no puede crear la identidad de dispositivo que espera el Gateway.`,
          stepHttps: `Usa HTTPS/Tailscale Serve, o abre http://127.0.0.1:18789 en el host del Gateway.`,
          stepLocalCompat: `Para compatibilidad local solo con token, establece gateway.controlUi.allowInsecureAuth: true.`,
          stepAvoidDisable: `Evita desactivar la autenticación de dispositivo para acceso HTTP remoto.`,
        },
        origin: {
          title: `Origen del navegador no permitido`,
          summary: `El Gateway rechazó el origen de esta página antes de aceptar la conexión de Control UI.`,
        ...
        protocol: {
          ...
          summary: `La Control UI servida y el Gateway en ejecución no coinciden en el protocolo de conexión admitido.`,
          stepDashboard: `Vuelve a abrir el dashboard servido con openclaw dashboard para que UI y Gateway provengan de la misma instalación.`,
          stepDevUi: `Si usas pnpm ui:dev, reconstruye o reinicia la UI de desarrollo contra el checkout actual.`,
          stepRestart: `Reinicia el Gateway después de actualizar OpenClaw para que sirva el protocolo actual.`,
        },
        network: {
          title: `No se pudo conectar`,
          summary: `El navegador no pudo completar la conexión al Gateway. Revisa el destino y el transporte antes de reintentar credenciales.`,
          stepGateway: `Confirma que el Gateway esté en ejecución con openclaw status u openclaw gateway run.`,
          stepUrl: `Revisa la URL de WebSocket y usa wss:// cuando el Gateway esté detrás de HTTPS/Tailscale Serve.`,
          stepDashboard: `Vuelve a abrir el dashboard con openclaw dashboard --no-open para copiar la URL y los detalles de autenticación actuales.`,
        },
      },
    },
    chat: {
      ...
      taskSuggestions: {
        ...
        adminRequired: `Se requiere acceso de administrador para crear un worktree para este proyecto.`,
      },
      pullRequests: {
        ...
        rateLimited: `Se alcanzó el límite de tasa de la API de GitHub. El estado del pull request puede estar desactualizado hasta que se restablezca el límite.`,
      },
      ...
      compaction: {
        ...
        description: `La transcripción compactada se conserva como punto de control. Abre los puntos de control de la sesión para ramificar o restaurar desde esa vista compactada.`,
      ...
      modelControls: { default: `Predeterminado`, reasoning: `Razonamiento`, speed: `Velocidad` },
      sideChat: {
        title: `Chat lateral`,
      ...
      composer: {
        ...
        microphoneBusy: `Las entradas de micrófono están ocupadas o no están disponibles para el navegador.`,
        ...
        microphonePageInactive: `Las entradas de micrófono no están disponibles mientras esta página está inactiva.`,
        microphonePermissionBlocked: `El acceso al micrófono está bloqueado. Permítelo en la configuración del sitio del navegador para listar las entradas.`,
        realtimeTalkRequiresMicrophone: `La entrada de voz en tiempo real requiere acceso al micrófono del navegador.`,
        selectedMicrophoneUnavailable: `El micrófono seleccionado no está disponible. Elige otra entrada o la opción predeterminada del sistema.`,
      ...
      workspaceFiles: {
        ...
        truncated: `Mostrando los primeros archivos coincidentes. Refina la búsqueda para acotar los resultados.`,
        session: `Sesión`,
        missing: `Faltante`,
    ...
    cron: {
      ...
      suggestions: {
        ...
        ideas: {
          repoPulse: {
            ...
            prompt: `Revisa la actividad nocturna en mis repositorios: nuevos issues, pull requests y fallos de CI. Resume las tres cosas que más necesitan mi atención hoy, cada una con un enlace y una razón en una línea.`,
          },
          standupGhostwriter: {
            name: `Redactor de standup`,
            tagline: `Tu actualización de standup, redactada a partir del trabajo de ayer.`,
            prompt: `Redacta mi actualización de standup a partir de los commits de ayer, los pull requests fusionados y los hilos de revisión abiertos. Máximo tres puntos: hecho, en curso, bloqueado.`,
          },
          hackerNewsScout: {
            name: `Explorador de Hacker News`,
            tagline: `Tres enlaces que valen tu café, con opiniones fuertes.`,
            prompt: `Escanea la portada de Hacker News de hoy en busca de publicaciones sobre agentes de IA, herramientas para desarrolladores y TypeScript. Envíame los tres enlaces más interesantes, cada uno con una opinión directa en una línea.`,
          },
          dependencyRadar: {
            name: `Radar de dependencias`,
            tagline: `Dependencias desactualizadas o vulnerables, con notas de actualización.`,
            prompt: `Revisa mi proyecto principal en busca de dependencias desactualizadas o vulnerables. Lista las actualizaciones destacadas con una nota de riesgo en una línea cada una, y redacta el comando de actualización.`,
          },
          watchdog: {
            name: `Guardia nocturna`,
            tagline: `Verificación de salud cada hora con un veredicto en una línea.`,
            prompt: `Comprueba que mis servicios y Gateway estén en buen estado: analiza los registros recientes en busca de nuevos errores, reinicios o carga inusual. Responde con una sola línea breve de confirmación cuando todo esté bien; si algo parece roto, informa qué falló y por dónde empezar a buscar.`,
          },
          polyglotMinute: {
            name: `Minuto políglota`,
            tagline: `Una frase extranjera útil con tu café de la mañana.`,
            prompt: `Enséñame una frase útil en japonés: la frase, cómo pronunciarla, su significado literal y cuándo usarla. Mantenlo en menos de cinco líneas.`,
          },
        },
      },
      stats: { tasks: `Tareas`, failing: `Con errores`, nextWake: `Próxima activación` },
      detail: {
      ...
      form: {
        ...
        onExitHelp: `Se ejecuta cuando un comando supervisado finaliza. La programación no se puede editar aquí.`,
        every: `Cada`,
        at: `A las`,
        cronOption: `Cron`,
        ...
        sessionKeyHelp: `Clave de enrutamiento opcional para la entrega de trabajos y el enrutamiento de activación.`,
...
export { t as es };
//# sourceMappingURL=es-DZThqMrQ.js.map
