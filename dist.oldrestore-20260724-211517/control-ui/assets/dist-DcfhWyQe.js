  ...
  scan: for (; (s & e[o]) != 0;) {
    ...
    for (let r = o + 3; r < n; r += 2)
      if ((e[r + 1] & s) > 0) {
        ...
        if (
          c.allows(n) &&
          (t.token.value == -1 || t.token.value == n || f(n, t.token.value, i, a))
        ) {
          t.acceptToken(n);
          break;
        }
...
function f(e, t, n, r) {
  let i = d(n, r, t);
  return i < 0 || d(n, r, e) < i;
}
function p(e, n, r) {
  let i = e.cursor(t.IncludeAnonymous);
  for (i.moveTo(n); ;)
    if (!(r < 0 ? i.childBefore(n) : i.childAfter(n)))
      for (;;) {
        if ((r < 0 ? i.to < n : i.from > n) && !i.type.isError)
          return r < 0
            ? Math.max(0, Math.min(i.to - 1, n - 25))
            : Math.min(e.length, Math.max(i.from + 1, n + 25));
    ...
    (i(),
      (v = class e {
        ...
        static start(t, n, r = 0) {
          ...
          return new e(t, [], n, r, r, 0, [], 0, i ? new y(i, i.start) : null, 0, null);
        }
        get context() {
        ...
        reduce(e) {
          ...
          if ((a && (this.score += a), t == 0)) {
            (n < r.minRepeatTerm && this.reducePos < this.pos && (this.reducePos = this.pos),
              ...
              n < r.minRepeatTerm &&
                this.storeNode(n, this.reducePos, this.reducePos, i ? 8 : 4, !0),
        ...
        updateContext(e) {
          if (e != this.curContext.context) {
            let t = new y(this.curContext.tracker, e);
      ...
      (w = class {
        ...
        peek(e) {
          ...
          if (t >= 0 && t < this.chunk.length) ((n = this.pos + e), (r = this.chunk.charCodeAt(t)));
            ...
            if (t == null) return -1;
            if (((n = t), n >= this.chunk2Pos && n < this.chunk2Pos + this.chunk2.length))
      ...
      (T = class {
        ...
        token(e, t) {
          let { parser: n } = t.p;
          u(this.data, e, t, this.id, n.data, n.tokenPrecTable);
        }
      }),
      (T.prototype.contextual = T.prototype.fallback = T.prototype.extend = !1),
      (E = class {
        constructor(e, t, n) {
          ((this.precTable = t),
            (this.elseToken = n),
            (this.data = typeof e == `string` ? l(e) : e));
        }
        token(e, t) {
          let n = e.pos,
            r = 0;
          for (;;) {
            ...
            if ((u(this.data, e, t, 0, this.data, this.precTable), e.token.value > -1)) break;
      ...
      (E.prototype.contextual = T.prototype.fallback = T.prototype.extend = !1),
      (D = class {
        constructor(e, t = {}) {
          ((this.token = e),
      ...
      (O = typeof process < `u` && /\bparse\b/.test({}.LOG)),
      (k = null),
      (A = class {
        constructor(e, t) {
          ((this.fragments = e),
        ...
        nextFragment() {
          ...
          if (e) {
            for (
              this.safeFrom = e.openStart ? p(e.tree, e.from + e.offset, 1) - e.offset : e.from,
                this.safeTo = e.openEnd ? p(e.tree, e.to + e.offset, -1) - e.offset : e.to;
              this.trees.length;
            )
        ...
        nodeAt(e) {
          ...
          for (;;) {
            ...
            if (a instanceof r) {
              ...
              (this.index[t]++,
                s + a.length >= Math.max(this.safeFrom, e) &&
      ...
      (j = class {
        constructor(e, t) {
          ((this.stream = t),
            ...
            (this.mainToken = null),
            (this.actions = []),
            (this.tokens = e.tokenizers.map((e) => new S())));
        }
        getActions(e) {
          let t = 0,
            n = null,
          ...
          for (let r = 0; r < i.length; r++) {
            ...
            if (
              !(n && !c.fallback) &&
              ((c.contextual || l.start != e.pos || l.mask != a || l.context != o) &&
                (this.updateCachedToken(l, c, e), (l.mask = a), (l.context = o)),
              l.lookAhead > l.end + 25 && (s = Math.max(l.lookAhead, s)),
              l.value != 0)
            ) {
              let r = t;
              if (
                (l.extended > -1 && (t = this.addActions(e, l.extended, l.end, t)),
        ...
        addActions(e, t, n, r) {
          ...
          for (let e = 0; e < 2; e++)
            for (let s = a.stateSlot(i, e ? 2 : 1); ; s += 3) {
              if (o[s] == 65535)
                if (o[s + 1] == 1) s = h(o, s + 2);
                else {
                  r == 0 && o[s + 1] == 2 && (r = this.putAction(h(o, s + 2), t, n, r));
                  break;
                }
              o[s] == t && (r = this.putAction(h(o, s + 1), t, n, r));
            }
          return r;
        }
      }),
      (M = class {
        constructor(e, t, n, r) {
          ((this.parser = e),
            ...
            (this.stream = new w(t, r)),
            (this.tokens = new j(e, this.stream)),
            (this.topTerm = e.top[1]));
          let { from: i } = r[0];
          ((this.stacks = [v.start(this, e.top[0], i)]),
            (this.fragments =
              n.length && this.stream.end - i > e.bufferLength * 4 ? new A(n, e.nodeSet) : null));
        }
        get parsedPos() {
        ...
        advance() {
          ...
          if (!n.length) {
            let e = r && g(r);
            if (e) return (O && console.log(`Finish with ` + this.stackID(e)), this.stackToTree(e));
          ...
          if (this.recovering && r) {
            ...
            if (e)
              return (
                O && console.log(`Force-finish ` + this.stackID(e)), this.stackToTree(e.forceAll())
              );
          }
          if (this.recovering) {
        ...
        advanceStack(e, t, n) {
          ...
          if (this.fragments) {
            ...
            for (let c = this.fragments.nodeAt(i); c;) {
              let i =
                this.parser.nodeSet.types[c.type.id] == c.type ? a.getGoto(e.state, c.type.id) : -1;
              if (i > -1 && c.length && (!t || (c.prop(o.contextHash) || 0) == n))
                return (
                  e.useNode(c, i),
                  O && console.log(s + this.stackID(e) + ` (via reuse of ${a.getName(c.type.id)})`),
                  !0
                );
          ...
          if (c > 0)
            return (
              e.reduce(c),
              O &&
                console.log(s + this.stackID(e) + ` (via always-reduce ${a.getName(c & 65535)})`),
              !0
            );
          ...
          for (let r = 0; r < l.length;) {
            ...
            if (
              (f.apply(o, c, p ? p.start : f.pos, u),
              O &&
                console.log(
                  s +
                    this.stackID(f) +
                    ` (via ${o & 65536 ? `reduce of ${a.getName(o & 65535)}` : `shift`} for ${a.getName(c)} @ ${i}${f == e ? `` : `, split`})`,
                ),
              d)
            )
              return !0;
          ...
          for (let a = 0; a < e.length; a++) {
            ...
            if (
              ...
              (i ||
                ((i = !0),
                o.restart(),
                O && console.log(l + this.stackID(o) + ` (restarted)`),
            ...
            for (
              ...
              e < 10 &&
              u.forceReduce() &&
              (O && console.log(d + this.stackID(u) + ` (via force-reduce)`),
              !this.advanceFully(u, n));
              e++
            )
              O && (d = this.stackID(u) + ` -> `);
            for (let e of o.recoverByInsert(s))
              (O && console.log(l + this.stackID(e) + ` (via recover-insert)`),
            ...
            this.stream.end > o.pos
              ? (c == o.pos && (c++, (s = 0)),
                ...
                O &&
                  console.log(
                    l + this.stackID(o) + ` (via recover-delete ${this.parser.getName(s)})`,
                  ),
                m(o, n))
        ...
        stackID(e) {
          let t = (k ||= new WeakMap()).get(e);
          return (t || k.set(e, (t = String.fromCodePoint(this.nextStackID++))), t + e);
        }
      }),
      (N = class {
        constructor(e, t, n) {
      ...
      (I = class e extends c {
        constructor(e) {
          ...
          ((this.specializers = this.specializerSpecs.map(_)),
            (this.states = l(e.states, Uint32Array)),
            (this.data = l(e.stateData)),
            (this.goto = l(e.goto)),
            (this.maxTerm = e.maxTerm),
            (this.tokenizers = e.tokenizers.map((e) => (typeof e == `number` ? new T(u, e) : e))),
        ...
        hasAction(e, t) {
          ...
          for (let r = 0; r < 2; r++)
            for (let i = this.stateSlot(e, r ? 2 : 1), a; ; i += 3) {
              if ((a = n[i]) == 65535)
                if (n[i + 1] == 1) a = n[(i = h(n, i + 2))];
                else if (n[i + 1] == 2) return h(n, i + 2);
                else break;
              if (a == t || a == 0) return h(n, i + 1);
            }
          return 0;
        }
        stateSlot(e, t) {
        ...
        allActions(e, t) {
          ...
          for (let n = this.stateSlot(e, 1); r == null; n += 3) {
            if (this.data[n] == 65535)
              if (this.data[n + 1] == 1) n = h(this.data, n + 2);
              else break;
            r = t(h(this.data, n + 1));
          }
          return r;
...
export { L as a, E as i, D as n, I as r, F as t };
//# sourceMappingURL=dist-DcfhWyQe.js.map
