import { i as re, n as ie, r as ae } from "./dist-D9GsM5qA.js";
import { a as ee, n as te, r as ne } from "./dist-DcfhWyQe.js";
import {
  A as t,
  E as n,
  a as r,
...
function de(e, t, n) {
  ...
  ((r.true = r.false = j), (r.null = r.unknown = M));
  for (let t of e.split(` `)) t && (r[t] = U);
  for (let e of t.split(` `)) e && (r[e] = W);
  for (let e of (n || ``).split(` `)) e && (r[e] = Oe);
  return r;
}
function fe(e, t, n, r) {
  let i = {};
  for (let t in q) i[t] = (e.hasOwnProperty(t) ? e : q)[t];
  return (t && (i.words = de(t, n || ``, r)), i);
}
function pe(e) {
  return new te((t) => {
    let { next: n } = t;
    if ((t.advance(), g(n, K))) {
      for (; g(t.next, K);) t.advance();
      t.acceptToken(E);
    } else if (n == 36 && e.doubleDollarQuotedStrings) {
      let e = p(t, ``);
      t.next == 36 && (t.advance(), se(t, e), t.acceptToken(k));
    } else if (n == 39 || (n == 34 && e.doubleQuotedStrings))
      (f(t, n, e.backslashEscapes), t.acceptToken(k));
      ...
      t.acceptToken(O);
    } else if ((n == 101 || n == 69) && t.next == 39) (t.advance(), f(t, 39, !0), t.acceptToken(k));
    else if ((n == 110 || n == 78) && t.next == 39 && e.charSetCasts)
      (t.advance(), f(t, 39, e.backslashEscapes), t.acceptToken(k));
      ...
      let e = t.peek(1);
      (t.advance(2), ce(t, e), t.acceptToken(k));
    } else if (g(n, e.identifierQuotes)) (f(t, n == 91 ? 93 : n, !1), t.acceptToken(Ee));
    else if (n == 40) t.acceptToken(N);
    else if (n == 41) t.acceptToken(P);
    else if (n == 123) t.acceptToken(F);
    else if (n == 125) t.acceptToken(I);
    else if (n == 91) t.acceptToken(we);
    else if (n == 93) t.acceptToken(L);
    else if (n == 59) t.acceptToken(R);
    else if (e.unquotedBitLiterals && n == 48 && t.next == 98)
      (t.advance(), ue(t), t.acceptToken(G));
    else if ((n == 98 || n == 66) && (t.next == 39 || t.next == 34)) {
      let n = t.next;
      (t.advance(),
        e.treatBitsAsBytes
          ? (f(t, n, e.backslashEscapes), t.acceptToken(De))
          : (ue(t, n), t.acceptToken(G)));
    } else if (
      (n == 48 && (t.next == 120 || t.next == 88)) ||
      ((n == 120 || n == 88) && t.next == 39)
    ) {
      let e = t.next == 39;
      for (t.advance(); oe(t.next);) t.advance();
      (e && t.next == 39 && t.advance(), t.acceptToken(A));
    } else if (n == 46 && t.next >= 48 && t.next <= 57) (m(t, !0), t.acceptToken(A));
    else if (n == 46) t.acceptToken(z);
    else if (n >= 48 && n <= 57) (m(t, !1), t.acceptToken(A));
    else if (g(n, e.operatorChars)) {
      for (; g(t.next, e.operatorChars);) t.advance();
      t.acceptToken(B);
    } else if (g(n, e.specialVar)) (t.next == n && t.advance(), le(t), t.acceptToken(Te));
    else if (n == 58 || n == 44) t.acceptToken(V);
    else if (d(n)) {
      let r = p(t, String.fromCharCode(n));
      t.acceptToken(
        t.next == 46 || t.peek(-r.length - 1) == 46 ? H : (e.words[r.toLowerCase()] ?? H),
      );
    }
  });
}
...
function me(e, t) {
  if (t.name == `CompositeIdentifier`) {
    let n = [];
    for (let r = t.firstChild; r; r = r.nextSibling) y(r) && n.push(v(e, r));
    return n;
  }
  return [v(e, t)];
}
...
function he(e, t) {
  ...
  return r.name == `Identifier` || r.name == `QuotedIdentifier` || r.name == `Keyword`
    ...
    : r.name == `.`
      ? { from: t, quoted: null, parents: b(e.doc, r), aliases: i }
      : { from: t, quoted: null, parents: [], empty: !0, aliases: i };
}
function ge(e, t) {
  let n;
  ...
  for (let t = n.firstChild, i = !1, a = null; t; t = t.nextSibling) {
    let n = t.name == `Keyword` ? e.sliceString(t.from, t.to).toLowerCase() : null,
      o = null;
    if (!i) i = n == `from`;
    else if (n == `as` && a && y(t.nextSibling)) o = v(e, t.nextSibling);
    else if (n && Ae.has(n)) break;
    else a && y(t) && (o = v(e, t));
    (o && ((r ||= Object.create(null)), (r[o] = me(e, a))),
...
function S(e, t, n, r) {
  return RegExp(`^[a-z_][a-z_\\d]*$`, r ? `i` : ``).test(e)
    ? { label: e, type: t }
    : { label: e, type: t, apply: n + e + C(n) };
}
function C(e) {
  return e === `[` ? `]` : e;
}
function ve(e, t, n, r, i, a) {
  let o = a?.spec.identifierQuotes?.[0] || `"`,
    s = new Ne(o, !!a?.spec.caseInsensitiveIdentifiers),
    c = i ? s.child(i) : null;
  return (
    s.addNamespace(e),
    t && (c || s).addCompletions(t),
    n && s.addCompletions(n),
    c && s.addCompletions(c.list),
    r && s.addCompletions((c || s).child(r).list),
    (e) => {
      let { parents: t, from: n, quoted: i, empty: a, aliases: o } = he(e.state, e.pos);
      if (a && !e.explicit) return null;
      o && t.length == 1 && (t = o[t[0]] || t);
      let l = s;
      for (let e of t) {
        for (; !l.children || !l.children[e];)
          if (l == s && c) l = c;
          else if (l == c && r) l = l.child(r);
          else return null;
      ...
      let u = l.list;
      if (
        (l == s && o && (u = u.concat(Object.keys(o).map((e) => ({ label: e, type: `constant` })))),
        i)
      ) {
        let t = i[0],
          r = C(t);
      ...
      } else return { from: n, options: u, validFor: je };
    }
  );
}
function ye(e) {
  return e == W ? `type` : e == U ? `keyword` : `variable`;
}
function be(e, t, n) {
  return ae(
    [`QuotedIdentifier`, `String`, `LineComment`, `BlockComment`, `.`],
    ie(Object.keys(e).map((r) => n(t ? r.toUpperCase() : r, ye(e[r])))),
  );
}
function xe(e, t) {
...
function w(e, t = !1, n) {
  return be(e.dialect.words, t, n || xe);
}
function T(e) {
  return e.schema
    ? ve(e.schema, e.tables, e.schemas, e.defaultTable, e.defaultSchema, e.dialect || X)
    : () => null;
}
function Se(e) {
  return e.schema ? (e.dialect || X).language.data.of({ autocomplete: T(e) }) : [];
}
function Ce(e = {}) {
  let t = e.dialect || X;
  return new r(t.language, [
    Se(e),
    t.language.data.of({ autocomplete: w(t, e.upperCaseKeywords, e.keywordCompletion) }),
  ]);
}
var E,
  D,
...
`),
    ...
    (Ne = class e {
      ...
      child(t) {
        ...
        return (
          ...
          (t &&
            ...
            this.list.push(S(t, `type`, this.idQuote, this.idCaseInsensitive)),
      ...
      addCompletions(e) {
        for (let t of e)
          this.addCompletion(
            typeof t == `string` ? S(t, `property`, this.idQuote, this.idCaseInsensitive) : t,
          );
      }
      addNamespace(e) {
        Array.isArray(e)
    ...
    (Y = class e {
      ...
      static define(t) {
        let n = fe(t, t.keywords, t.types, t.builtin),
          r = c.define({
            name: `sql`,
            parser: Pe.configure({ tokenizers: [{ from: J, to: pe(n) }] }),
            languageData: {
...
export {
  ...
  ze as SQLite,
  X as StandardSQL,
  w as keywordCompletionSource,
  T as schemaCompletionSource,
  Ce as sql,
};
//# sourceMappingURL=dist-m6z9h5Xu.js.map
