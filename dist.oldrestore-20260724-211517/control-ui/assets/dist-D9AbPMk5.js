import { a as p, r as m } from "./dist-DcfhWyQe.js";
import {
  A as t,
  a as n,
  d as r,
  ...
  v = e(() => {
    (p(),
      ...
      (_ = m.deserialize({
        ...
        specialized: [{ term: 231, get: (e) => g[e] || -1 }],
        tokenPrec: 7144,
      })));
  });
function y() {
  ...
  (v(),
    ...
    (b = l.define({
      ...
      parser: _.configure({
        props: [
          d.add({
            IfStatement: s({ except: /^\s*({|else\b)/ }),
            TryStatement: s({ except: /^\s*({|catch|finally)\b/ }),
            LabeledStatement: i,
            SwitchBlock: (e) => {
              let t = e.textAfter,
                n = /^\s*\}/.test(t),
...
export { y as java };
//# sourceMappingURL=dist-D9AbPMk5.js.map
