  ...
  t = {
    ...
    token: function (e, t) {
      ...
      if (
        ((t.afterSection = !1),
        n &&
          (t.nextMultiline ? ((t.inMultiline = !0), (t.nextMultiline = !1)) : (t.position = `def`)),
      ...
      return n && (i === `#` || i === `!` || i === `;`)
        ...
        : n && i === `[`
          ...
          : i === `=` || i === `:`
            ...
            : (i === `\\` && t.position === `quote` && e.eol() && (t.nextMultiline = !0),
              t.position);
    },
    startState: function () {
...
export { t as properties };
//# sourceMappingURL=properties-EB1YgqDp.js.map
