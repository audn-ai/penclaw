    ...
    token: function (e, t) {
      if (
        (e.sol() &&
          ...
          t.inMultilineTable &&
            ((t.tableHeaderLine = !1),
            e.match(/\s*\|/, !1) || ((t.allowMultilineArgument = !1), (t.inMultilineTable = !1)))),
        e.eatSpace(),
        ...
        if (t.inMultilineString)
          return (
            e.match(`"""`)
              ? ((t.inMultilineString = !1), (t.allowMultilineArgument = !1))
              : e.match(/.*/),
            `string`
          );
...
export { t as gherkin };
//# sourceMappingURL=gherkin-Dc3YANZC.js.map
