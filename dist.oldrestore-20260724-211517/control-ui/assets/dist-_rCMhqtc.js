import { a as m, r as h } from "./dist--Ncd3Hap.js";
import { a as d, n as f, r as p } from "./dist-DcfhWyQe.js";
import {
  A as t,
  a as n,
  j as r,
...
function v() {
  return new n(A, A.data.of({ autocomplete: j }));
}
var y, b, x, S, C, w, T, E, D, O, k, A, j;
e(() => {
  (u(),
    m(),
    d(),
    ...
    (C = new f((e, t) => {
      if (e.next == 40) {
        let t = e.peek(-1);
        (g(t) || _(t) || t == 95 || t == 45) && e.acceptToken(x, 1);
      }
    })),
    (w = new f((e) => {
      if (S.indexOf(e.peek(-1)) > -1) {
        let { next: t } = e;
        (g(t) || t == 95 || t == 35 || t == 46 || t == 91 || t == 58 || t == 45) &&
          e.acceptToken(y);
      }
    })),
    (T = new f((e) => {
      if (S.indexOf(e.peek(-1)) < 0) {
        let { next: t } = e;
        if ((t == 37 && (e.advance(), e.acceptToken(b)), g(t))) {
          do e.advance();
          while (g(e.next));
          e.acceptToken(b);
        }
    ...
    (E = t({
      "import charset namespace keyframes media supports when": r.definitionKeyword,
      ...
      IdName: r.labelName,
      "FeatureName PropertyName PropertyVariable": r.propertyName,
      ...
      "AtKeyword Interpolation": r.special(r.variableName),
    ...
    (k = p.deserialize({
      ...
      tokenizers: [w, T, C, 0, 1, 2, 3, 4],
      topRules: { StyleSheet: [0, 5] },
      specialized: [
        { term: 116, get: (e) => D[e] || -1 },
        { term: 23, get: (e) => O[e] || -1 },
      ],
      tokenPrec: 2180,
    })),
    (A = s.define({
      name: `less`,
      parser: k.configure({ props: [l.add({ Declaration: a() }), o.add({ Block: c })] }),
      languageData: {
    ...
    (j = h((e) => e.name == `VariableName` || e.name == `AtKeyword`)));
})();
export { v as less };
//# sourceMappingURL=dist-_rCMhqtc.js.map
