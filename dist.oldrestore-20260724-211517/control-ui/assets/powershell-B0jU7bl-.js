...
function t(e, t) {
  t ||= {};
  for (
    var n = t.prefix === void 0 ? `^` : t.prefix, r = t.suffix === void 0 ? `\\b` : t.suffix, i = 0;
    i < e.length;
    i++
  )
...
function n(e, t) {
  ...
  for (var a in h) if (e.match(h[a])) return a;
  var o = e.next();
  if (o === `'`) return r(e, t);
  if (o === `$`) return u(e, t);
  if (o === `"`) return i(e, t);
  ...
  if (o === `@`) {
    var s = e.eat(/["']/);
    if (s && e.eol()) return ((t.tokenize = f), (t.startQuote = s[0]), f(e, t));
    if (e.eol()) return `error`;
    if (e.peek().match(/[({]/)) return `punctuation`;
    if (e.peek().match(m)) return u(e, t);
  }
  return `error`;
}
function r(e, t) {
  for (var r; (r = e.peek()) != null;)
    if ((e.next(), r === `'` && !e.eat(`'`))) return ((t.tokenize = n), `string`);
  return `error`;
}
function i(e, t) {
  for (var r; (r = e.peek()) != null;) {
    if (r === `$`) return ((t.tokenize = a), `string`);
    if ((e.next(), r === "`")) {
      e.next();
      continue;
    }
    if (r === `"` && !e.eat(`"`)) return ((t.tokenize = n), `string`);
  }
  return `error`;
}
function a(e, t) {
...
function u(e, t) {
  ...
  return e.eat(`{`)
    ? ((t.tokenize = d), d(e, t))
    : r != null && r.match(m)
      ? (e.eatWhile(m), (t.tokenize = n), `variable`)
      : ((t.tokenize = n), `error`);
}
function d(e, t) {
...
function f(e, t) {
  var r = t.startQuote;
  if (e.sol() && e.match(RegExp(r + `@`))) t.tokenize = n;
  else if (r === `"`)
    for (; !e.eol();) {
      var i = e.peek();
...
e(() => {
  ((p = `(?=[^A-Za-z\\d\\-_]|$)`),
    ...
    (g = {
      name: `powershell`,
      startState: function () {
        return { returnStack: [], bracketNesting: 0, tokenize: n };
      },
      token: function (e, t) {
...
export { g as powerShell };
//# sourceMappingURL=powershell-B0jU7bl-.js.map
