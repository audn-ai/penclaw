    ...
    (l = {
      ...
      token: function (e, t) {
        ...
        if (
          ...
          i(t, `)`, e.column());
        else if (o == `[`) i(t, `]`, e.column());
        else if (o == `{`) i(t, `}`, e.column());
        else if (/[\]\}\)]/.test(o)) {
          for (; t.context && t.context.type == `pattern`;) a(t);
          t.context && o == t.context.type && a(t);
        } else
          o == `.` && t.context && t.context.type == `pattern`
            ? a(t)
...
export { l as turtle };
//# sourceMappingURL=turtle-DIfR7Oeq.js.map
