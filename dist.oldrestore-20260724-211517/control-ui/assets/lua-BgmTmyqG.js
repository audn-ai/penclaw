...
function i(e, t) {
  ...
  return n == `-` && e.eat(`-`)
    ? e.eat(`[`) && /[\[=]/.test(e.peek())
      ? (t.cur = a(r(e), `comment`))(e, t)
      : (e.skipToEnd(), `comment`)
    : n == `"` || n == `'`
      ? (t.cur = o(n))(e, t)
      : n == `[` && /[\[=]/.test(e.peek())
        ? (t.cur = a(r(e), `string`))(e, t)
        : /\d/.test(n)
          ? (e.eatWhile(/[\w.%]/), `number`)
          : /[\w_]/.test(n)
...
function a(e, t) {
  return function (n, r) {
    for (var a = null, o; (o = n.next()) != null;)
      if (a == null) o == `]` && (a = 0);
      else if (o == `=`) ++a;
      else if (o == `]` && a == e) {
        r.cur = i;
...
function o(e) {
  return function (t, n) {
    for (var r = !1, a; (a = t.next()) != null && !(a == e && !r);) r = !r && a == `\\`;
    return (r || (n.cur = i), `string`);
  };
}
var s, c, l, u, d, f;
e(() => {
  ((s = n(
    ...
    (l = n([`function`, `if`, `repeat`, `do`, `\\(`, `{`])),
    (u = n([`end`, `until`, `\\)`, `}`])),
    (d = t([`end`, `until`, `\\)`, `}`, `else`, `elseif`])),
    (f = {
      name: `lua`,
      startState: function () {
        return { basecol: 0, indentDepth: 0, cur: i };
      },
      token: function (e, t) {
        ...
        var n = t.cur(e, t),
          r = e.current();
        return (
          n == `variable` && (c.test(r) ? (n = `keyword`) : s.test(r) && (n = `builtin`)),
          n != `comment` &&
            n != `string` &&
            (l.test(r) ? ++t.indentDepth : u.test(r) && --t.indentDepth),
          n
        );
      },
      indent: function (e, t, n) {
        var r = d.test(t);
        return e.basecol + n.unit * (e.indentDepth - +!!r);
      },
      languageData: {
...
export { f as lua };
//# sourceMappingURL=lua-BgmTmyqG.js.map
