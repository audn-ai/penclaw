...
function n(e) {
  if (e) for (var t in e) e.hasOwnProperty(t) && u.push(t);
}
function r(e, t) {
  var n = e.next();
  if (n == `"` || n == `'`) return ((t.tokenize = i(n)), t.tokenize(e, t));
  if (/[\[\]{}\(\),;\\:\?\.]/.test(n)) return ((O = n), `punctuation`);
  ...
  return d.propertyIsEnumerable(r)
    ...
    : f.propertyIsEnumerable(r)
      ...
      : p.propertyIsEnumerable(r) ||
        ...
        ? `def`
        : y.propertyIsEnumerable(r) || b.propertyIsEnumerable(r) || x.propertyIsEnumerable(r)
          ? `string`
...
function i(e) {
  return function (t, n) {
    ...
    return ((a || !(r || T)) && (n.tokenize = null), `string`);
  };
}
function a(e, t) {
...
var l, u, d, f, p, m, h, g, _, v, y, b, x, S, C, w, T, E, D, O, k;
e(() => {
  ((l = {
    name: `ttcn`,
    keywords: t(
    ...
    portOps: t(`call catch check clear getcall getreply halt raise receive reply send trigger`),
    ...
    (k = {
      ...
      token: function (e, t) {
        ...
        if (((n.align ??= !0), (O == `;` || O == `:` || O == `,`) && n.type == `statement`)) c(t);
        else if (O == `{`) s(t, e.column(), `}`);
        else if (O == `[`) s(t, e.column(), `]`);
        else if (O == `(`) s(t, e.column(), `)`);
        else if (O == `}`) {
...
export { k as ttcn };
//# sourceMappingURL=ttcn-B2NyoKzY.js.map
