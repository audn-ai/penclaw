...
import { i as getOrCreateClientManager, n as stripMarkdownForTwitch } from "./markdown-B-q8m0CR.js";
...
function mentionsBot(message, botUsername) {
  ...
  while ((match = mentionRegex.exec(message)) !== null)
    if ((match[1] ? normalizeLowercaseStringOrEmpty(match[1]) : "") === expected) return true;
  return false;
}
//#endregion
