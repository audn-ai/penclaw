...
import { t as shouldHandleDiscordApprovalRequest } from "./approval-shared-h5X--B8k.js";
import "./error-runtime-BIAwr399.js";
import "./runtime-env-D0V-7Gqz.js";
import "./string-coerce-runtime-BUe4iD0r.js";
import { r as resolveRequiredDiscordChannelPermissions } from "./audit-core-yppuxs_r.js";
import "./channel-core-Z_rV5hXh.js";
import { t as discordMessageActions$1 } from "./channel-actions-CRUXYs02.js";
...
import { n as resolveDiscordCurrentConversationIdentity } from "./conversation-identity-B8ctpwXe.js";
import { i as createChatChannelPlugin } from "./core-V3U0lOIj.js";
...
import { n as resolveApprovalRequestSessionConversation } from "./exec-approval-session-target-GSisVfGX.js";
import {
...
import { n as discordOutbound } from "./outbound-adapter-Y0vWRo-E.js";
import { t as resolveDiscordOutboundSessionRoute } from "./outbound-session-route-CtKNfzdZ.js";
import "./channel-api-D8WPShfA.js";
...
import { d as withAbortTimeout } from "./timeouts-Bj-qI9VL.js";
...
function createDiscordApprovalCapability(configOverride) {
  return createApproverRestrictedNativeApprovalCapability({
    ...
    nativeRuntime: createLazyChannelApprovalNativeRuntimeAdapter({
      ...
      load: async () =>
        (await import("./approval-handler.runtime-E9zhbqHy.js")).discordApprovalNativeRuntime,
    }),
  });
}
...
const loadDiscordDirectoryConfigModule = createLazyRuntimeModule(
  () => import("./directory-config-Bc0qUwGP.js"),
);
const loadDiscordResolveChannelsModule = createLazyRuntimeModule(
  () => import("./resolve-channels-BQmHW3Ys.js"),
);
const loadDiscordResolveUsersModule = createLazyRuntimeModule(
  () => import("./resolve-users-DcTIjYfO.js"),
);
const loadDiscordThreadBindingsManagerModule = createLazyRuntimeModule(
  () => import("./thread-bindings.manager-DtgV8T83.js"),
);
const loadDiscordTargetResolverModule = createLazyRuntimeModule(
  () => import("./target-resolver-D6EhiwGC.js"),
);
const loadDiscordProviderRuntime = createLazyRuntimeModule(() => import("./provider.runtime.js"));
const loadDiscordProbeRuntime = createLazyRuntimeModule(
  () => import("./probe.runtime-Dl6_m-jE.js"),
);
const loadDiscordAuditModule = createLazyRuntimeModule(() => import("./audit-CNvtla5K.js"));
const loadDiscordSendModule = createLazyRuntimeModule(() => import("./send-CUIGrZnM.js"));
const loadDiscordDirectoryLiveModule = createLazyRuntimeModule(
  () => import("./directory-live-hC19WMcb.js"),
);
//#endregion
...
const channelScopeKey = (guildKey, channelKey) =>
...
function resolveDiscordChannelKey(channelEntries, params) {
  ...
  return normalizedGroupChannel !== void 0 && channelEntries[normalizedGroupChannel]
...
function resolveDiscordPolicyScope(params) {
  ...
  return {
    ...
    path: [
      ...
      ...(channelKey !== void 0 ? [channelScopeKey(guildKey, channelKey)] : []),
    ],
  };
}
...
function resolveDiscordStartupDelayMs(cfg, accountId) {
  const startupIndex = resolveDiscordStartupAccountIds(cfg).findIndex(
      ...
      buildCapabilitiesDiagnostics: async ({ account, target, timeoutMs }) => {
        ...
        try {
          ...
          const perms = await withAbortTimeout({
            timeoutMs,
            createTimeoutError: () =>
              /* @__PURE__ */ new Error(`Capabilities diagnostic timed out after ${timeoutMs}ms`),
            run: async (signal) =>
