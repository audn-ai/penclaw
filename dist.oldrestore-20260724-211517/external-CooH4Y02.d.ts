import {
  ...
  o as inferFlattenedErrors,
  r as ZodIssueCode,
  s as inferFormattedError,
  t as BRAND,
} from "./compat-Cv0f0P7B.js";
import {
  $ as ZodPipe,
  $i as $ZodTypes,
  $n as stringbool,
  ...
  Ai as config,
  An as meta,
  Ar as safeEncodeAsync,
  At as _ZodType,
  B as ZodLiteral,
  Bi as treeifyError,
  Bn as optional,
  Br as $ZodBigIntParams,
  Bt as array,
  C as ZodEnum,
  Ci as _trim,
  Cn as ksuid,
  ...
  Ft as _instanceof,
  G as ZodNever,
  Gi as $ZodISODateTimeInternals,
  Gn as promise,
  Gr as $ZodISODurationParams,
  Gt as check,
  H as ZodMap,
  Hi as $ZodBooleanInternals,
  Hn as pipe,
  Hr as $ZodDateParams,
  Ht as base64url,
  I as ZodJSONSchemaInternals,
  In as nullable,
  Ir as ZodRealError,
  It as _null,
  J as ZodNullable,
  Ji as $ZodNumberInternals,
  Jn as refine,
  Jr as $ZodStringParams,
  Jt as codec,
  K as ZodNonOptional,
  Ki as $ZodISODurationInternals,
  Kn as readonly,
  Kr as $ZodISOTimeParams,
  Kt as cidrv4,
  L as ZodJWT,
  Li as flattenError,
  Ln as nullish,
  Lr as index_d_exports,
  Lt as _undefined,
  M as ZodInt,
  Mi as output,
  Mn as nanoid,
  Mr as safeParseAsync,
  Mt as _default,
  N as ZodInt32,
  Ni as $ZodErrorMap,
  Nn as nativeEnum,
  ...
  Oi as $constructor,
  On as mac,
  Or as safeDecodeAsync,
  Ot as _ZodNumber,
  P as ZodIntersection,
  ...
  St as ZodVoid,
  T as ZodFile,
  Ti as index_d_exports$1,
  Tn as literal,
  Tr as parse,
  Tt as _ZodBigInt,
  U as ZodNaN,
  Ui as $ZodDateInternals,
  Un as prefault,
  Ur as $ZodISODateParams,
  Ut as bigint$1,
  V as ZodMAC,
  Vi as $ZodBigIntInternals,
  Vn as partialRecord,
  Vr as $ZodBooleanParams,
  Vt as base64,
  W as ZodNanoID,
  Wi as $ZodISODateInternals,
  Wn as preprocess,
  Wr as $ZodISODateTimeParams,
  Wt as boolean$1,
  X as ZodNumberFormat,
  Xi as $ZodStringInternals,
  Xn as strictObject,
  Xr as _endsWith,
  Xt as cuid2,
  Y as ZodNumber,
  ...
  cn as guid,
  cr as ulid,
  ct as ZodStringFormat,
  d as ZodCUID,
  da as globalRegistry,
  di as _nonnegative,
  dn as hostname,
  dr as url,
  dt as ZodTemplateLiteral,
  ei as _length,
  en as discriminatedUnion,
  er as success,
  et as ZodPrefault,
  f as ZodCUID2,
  fa as registry,
  ...
  nt as ZodPromise,
  o as ZodBigInt,
  oa as util_d_exports,
  oi as _mime,
  on as float32,
  or as uint32,
  ot as ZodStandardSchemaWithJSON,
  p as ZodCatch,
  pa as JSONSchema,
  pi as _normalize,
  pn as int,
  ...
  pt as ZodTuple,
  q as ZodNull,
  qi as $ZodISOTimeInternals,
  qn as record,
  qr as $ZodNumberParams,
  qt as cidrv6,
  r as ZodArray,
  ri as _lte,
  rn as emoji,
  rr as templateLiteral,
  rt as ZodReadonly,
  s as ZodBigIntFormat,
  sa as $ZodRegistry,
  si as _minLength,
  sn as float64,
  sr as uint64,
  st as ZodString,
  t as SafeExtendShape,
  ti as _lowercase,
  tn as e164,
  tr as superRefine,
  tt as ZodPreprocess,
  ...
  vi as _size,
  vn as ipv4,
  vr as ZodSafeParseError,
  vt as ZodUUID,
  w as ZodExactOptional,
  wi as _uppercase,
  wn as lazy,
  wr as encodeAsync,
  wt as ZodXor,
...
//#region node_modules/zod/v4/classic/from-json-schema.d.cts
...
declare function fromJSONSchema(
...
declare namespace external_d_exports {
  export {
    ...
    JSONType,
    NEVER,
    $RefinementCtx as RefinementCtx,
    SafeExtendShape,
    ZodType as Schema,
    TimePrecision,
    output as TypeOf,
    ...
    clone,
    codec,
    coerce_d_exports as coerce,
    config,
    index_d_exports as core,
    cuid,
    cuid2,
    custom,
    date$2 as date,
...
//#endregion
export {
  ZodCoercedNumber as a,
  ZodISODate as c,
  ZodISOTime as d,
  iso_d_exports as f,
  ZodCoercedDate as i,
  ZodISODateTime as l,
  ZodCoercedBigInt as n,
  ZodCoercedString as o,
  fromJSONSchema as p,
  ZodCoercedBoolean as r,
  coerce_d_exports as s,
  external_d_exports as t,
  ZodISODuration as u,
};
