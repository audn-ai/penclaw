    ...
    ThreadItem: {
      oneOf: [
        ...
        },
        {
          properties: {
            appContext: {
              anyOf: [{ $ref: "#/definitions/McpToolCallAppContext" }, { type: "null" }],
            },
            arguments: true,
            durationMs: {
...
function applySchemaDefaults(
  ...
  if (schemaTypeIncludes(schema, "object") && isRecord(nextValue) && isRecord(schema.properties)) {
    for (const [key, propertySchema] of Object.entries(schema.properties)) {
      ...
      if (defaultedValue !== void 0 && defaultedValue !== currentValue)
...
function readCodexDynamicToolCallParams(value) {
  return readCodexShape(
    ...
    normalizeWithDefaults(DynamicToolCallParams_default, value),
  );
}
...
function readCodexErrorNotification(value) {
  return readCodexShape(
    ...
    normalizeWithDefaults(ErrorNotification_default, value),
  );
}
...
function readCodexModelListResponse(value) {
  return readCodexShape(
    ...
    normalizeWithDefaults(ModelListResponse_default, value),
  );
}
...
function readCodexTurn(value) {
  return readCodexShape(
    ...
    normalizeWithDefaults(TurnStartResponse_default, { turn: normalizeTurn(value) }),
  )?.turn;
}
...
function readCodexTurnCompletedNotification(value) {
  return readCodexShape(
    ...
    normalizeWithDefaults(
      TurnCompletedNotification_default,
...
//#endregion
export {
  readCodexDynamicToolCallParams as a,
  readCodexTurn as c,
  assertCodexTurnStartResponse as i,
  readCodexTurnCompletedNotification as l,
  assertCodexThreadResumeResponse as n,
  readCodexErrorNotification as o,
  assertCodexThreadStartResponse as r,
  readCodexModelListResponse as s,
  assertCodexThreadForkResponse as t,
};
