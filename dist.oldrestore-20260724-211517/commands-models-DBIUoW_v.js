...
import { n as listCliRuntimeModelBackendBindings } from "./cli-backends-D2v5ATPw.js";
import { r as resolveDefaultModelForAgent } from "./codex-plugin-diagnostics-DxsLhCf5.js";
import { r as rejectUnauthorizedCommand } from "./command-gates-D1W2Ogk9.js";
...
import { n as loadModelCatalogSnapshotForBrowse } from "./model-catalog-browse-D-Xu_sqI.js";
...
import { n as isRetiredModelPickerProvider } from "./model-picker-visibility-CK4psYGX.js";
...
import {
  ...
  p as openAIModelCatalogRoutePolicy,
...
async function buildModelsProviderData(cfg, agentId, options = {}) {
  ...
  for (const binding of runtimeBindings) {
    ...
    const defaultModelId =
      provider === normalizeProviderId(resolvedDefault.provider) ? resolvedDefault.model : void 0;
