...
function buildMemoryPressureEvidence(options) {
  ...
  return {
    memoryPressure: {
      ...
      ...(options.pressure.thresholdBytes !== void 0
        ? { thresholdBytes: options.pressure.thresholdBytes }
        : {}),
      ...(options.pressure.rssGrowthBytes !== void 0
...
//#endregion
export {
  readLatestDiagnosticStabilityBundleSync as a,
  writeDiagnosticMemoryPressureBundleSync as c,
  readDiagnosticStabilityBundleFileSync as i,
  writeDiagnosticStabilityBundleForFailureSync as l,
  MAX_DIAGNOSTIC_STABILITY_BUNDLE_BYTES as n,
  resetDiagnosticStabilityBundleForTest as o,
  installDiagnosticStabilityFatalHook as r,
  uninstallDiagnosticStabilityFatalHook as s,
  DIAGNOSTIC_STABILITY_BUNDLE_VERSION as t,
  writeDiagnosticStabilityBundleSync as u,
};
