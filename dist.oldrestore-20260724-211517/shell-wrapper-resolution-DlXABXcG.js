...
const ENV_SPLIT_STRING_OPTIONS = /* @__PURE__ */ new Set(["-S", "-s", "--split-string"]);
...
const DOAS_OPTIONS_WITH_VALUE = /* @__PURE__ */ new Set(["-a", "-C", "-u"]);
const DOAS_STANDALONE_OPTIONS = /* @__PURE__ */ new Set(["-L", "-n", "-s"]);
...
const NICE_OPTIONS_WITH_VALUE = /* @__PURE__ */ new Set(["-n", "--adjustment", "--priority"]);
...
const FLOCK_SHORT_FLAG_OPTIONS = /* @__PURE__ */ new Set(["-e", "-F", "-n", "-o", "-s", "-x"]);
...
const TIME_OPTIONS_WITH_VALUE = /* @__PURE__ */ new Set(["-f", "--format", "-o", "--output"]);
const BSD_SCRIPT_FLAG_OPTIONS = /* @__PURE__ */ new Set(["-a", "-d", "-k", "-p", "-q", "-r"]);
const BSD_SCRIPT_OPTIONS_WITH_VALUE = /* @__PURE__ */ new Set(["-F", "-t"]);
const SANDBOX_EXEC_OPTIONS_WITH_VALUE = /* @__PURE__ */ new Set(["-f", "-p", "-d"]);
...
const POSIX_INLINE_COMMAND_FLAGS = /* @__PURE__ */ new Set(["-lc", "-c", "--command"]);
...
//#endregion
export {
  resolveCarrierCommandArgv as A,
  resolveDispatchWrapperTrustPlan as C,
  SOURCE_EXECUTABLES as D,
  COMMAND_CARRIER_EXECUTABLES as E,
  hasTopLevelShellControlOperator as M,
  splitShellArgs as N,
  isEnvAssignmentToken as O,
  isDispatchWrapperExecutable as S,
  unwrapKnownDispatchWrapperInvocation as T,
  isPowerShellInlineFileCommandFlag as _,
  extractShellWrapperInlineCommand as a,
  resolvePowerShellInlineCommandMatch as b,
  isShellWrapperExecutable as c,
  unwrapKnownShellMultiplexerInvocation as d,
  POSIX_INLINE_COMMAND_FLAGS as f,
  isDirectShellPositionalCarrierCommand as g,
  hasPosixLoginStartupBeforeInlineCommand as h,
  extractShellWrapperCommand as i,
  normalizeExecutableToken as j,
  parseEnvInvocationPrelude as k,
  isShellWrapperInvocation as l,
  hasPosixInteractiveStartupBeforeInlineCommand as m,
  POWERSHELL_WRAPPERS as n,
  hasEnvManipulationBeforeShellWrapper as o,
  advancePosixInlineOptionScan as p,
  ...
  isPowerShellInlineRestCommandFlag as v,
  unwrapDispatchWrappersForResolution as w,
  extractEnvAssignmentKeysFromDispatchWrappers as x,
  resolveInlineCommandMatch as y,
};
