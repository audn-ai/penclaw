    ...
    subscribe: (connId, sessionKey, opts) => {
      ...
      if (opts?.includeApprovals) {
        const approvalConnIds =
          approvalSessionToConnIds.get(normalizedSessionKey) ?? /* @__PURE__ */ new Set();
        ...
        const approvalSessionKeys =
          connToApprovalSessionKeys.get(normalizedConnId) ?? /* @__PURE__ */ new Set();
      ...
      return () => {
        ...
        registry.subscribe(
          ...
          hadApprovals ? { includeApprovals: true } : void 0,
        );
      };
    },
...
//#endregion
export {
  createChatRunState as a,
  createToolEventRecipientRegistry as c,
  createChatRunRegistry as i,
  isChatAbortMarkerCurrent as l,
  createChatAbortMarker as n,
  createSessionEventSubscriberRegistry as o,
  createChatRunEntry as r,
  createSessionMessageSubscriberRegistry as s,
  chatAbortMarkerTimestampMs as t,
};
