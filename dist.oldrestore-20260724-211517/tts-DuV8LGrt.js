...
import { i as assertOkOrThrowProviderError } from "./provider-http-errors-DLMRBkZU.js";
  ...
  try {
    ...
    return await readResponseWithLimit(response, maxBytes, {
      onOverflow: ({ maxBytes: maxBytesLocal }) =>
        /* @__PURE__ */ new Error(`OpenAI TTS audio response exceeds ${maxBytesLocal} bytes`),
    });
  } finally {
    await release();
  }
