...
function resolveExplicitEnvBundledPluginsDir(env) {
  ...
  return sameExistingPath(resolveUserPath(envOverride, env), bundledPluginsDir)
    ? bundledPluginsDir
    : void 0;
}
...
//#endregion
export {
  resolvePluginRootPublicSurfacePath as a,
  resolveBundledPluginSourcePublicSurfacePath as i,
  normalizeBundledPluginArtifactSubpath as n,
  resolveBundledPluginPublicSurfacePath as r,
