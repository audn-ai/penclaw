...
declare function resolveToolsBySender(
  params: {
    toolsBySender?: GroupToolPolicyBySenderConfig;
...
declare function resolveChannelGroupToolsPolicy(
  params: {
    cfg: OpenClawConfig;
    channel: GroupPolicyChannel;
    groupId?: string | null;
...
//#endregion
export {
  resolveToolsBySender as a,
  resolveChannelGroupToolsPolicy as i,
  resolveChannelGroupPolicy as n,
  resolveChannelGroupRequireMention as r,
  ChannelGroupPolicy as t,
};
