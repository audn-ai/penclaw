...
declare function isPluginOwnedSessionBindingRecord(
  record:
    | {
...
declare function toPluginConversationBinding(
  record:
    | {
        bindingId: string;
...
declare function buildPluginBindingApprovalCustomId(
  approvalId: string,
  decision: PluginBindingApprovalDecision,
): string;
declare function parsePluginBindingApprovalCustomId(
  value: string,
