...
} from "./channel-core-Z_rV5hXh.js";
import { w as createAllowlistProviderRouteAllowlistWarningCollector } from "./channel-policy-DXOn_tKS.js";
...
} from "./doctor-contract-Cqmr_y0V.js";
...
import { t as detectTelegramLegacyStateMigrations } from "./state-migrations-DBp483zC.js";
import {
  ...
  uiHints: {
    ...
    ...createChannelConfigUiHints({
      ...
      mentionPatterns: {
        ...
        policyNote:
          "Native Telegram bot mentions still trigger even when regex patterns are denied.",
...
async function maybeRepairTelegramAllowFromUsernames(cfg) {
  ...
  const { getChannelsCommandSecretTargetIds, resolveCommandSecretRefsViaGateway } =
    await import("./plugin-sdk/runtime.js");
