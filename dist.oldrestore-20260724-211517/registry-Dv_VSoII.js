...
import "./core-descriptors-CxB_dkaR.js";
...
function normalizeDescriptor(input) {
  ...
  const normalizedScope =
    input.scope === "node" || input.scope === "dynamic"
      ? input.scope
...
//#endregion
export {
  createPluginGatewayMethodDescriptors as i,
  createGatewayMethodRegistry as n,
  createPluginGatewayMethodDescriptor as r,
  createGatewayMethodDescriptorsFromHandlers as t,
};
