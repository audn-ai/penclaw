...
StateInline.prototype.scanDelims = function (start, canSplitWord) {
  ...
  if (start === 0) lastChar = 32;
    ...
    if ((lastChar & 64512) === 56320) {
      ...
      lastChar =
        (highSurr & 64512) === 55296
          ? 65536 + ((highSurr - 55296) << 10) + (lastChar - 56320)
          : 65533;
  ...
  if ((nextChar & 64512) === 55296) {
    ...
    nextChar =
      (lowSurr & 64512) === 56320 ? 65536 + ((nextChar - 55296) << 10) + (lowSurr - 56320) : 65533;
...
function re_default(opts) {
  ...
  re.src_path =
    `(?:[/?#](?:(?!${re.src_ZCc}|${text_separators}|[()[\\]{}.,"'?!\\-;]).|\\[(?:(?!${re.src_ZCc}|\\]).)*\\]|\\((?:(?!${re.src_ZCc}|[)]).)*\\)|\\{(?:(?!${re.src_ZCc}|[}]).)*\\}|\\"(?:(?!${re.src_ZCc}|["]).)+\\"|\\'(?:(?!${re.src_ZCc}|[']).)+\\'|\\'(?=${re.src_pseudo_letter}|[-])|\\.{2,}[a-zA-Z0-9%/&]|\\.(?!${re.src_ZCc}|[.]|$)|` +
    (opts["---"] ? "\\-(?!--(?:[^-]|$))(?:-*)|" : "\\-+|") +
  ...
  re.src_domain =
    "(?:" +
    re.src_xn +
    `|(?:${re.src_pseudo_letter})|(?:${re.src_pseudo_letter}(?:-|${re.src_pseudo_letter}){0,61}${re.src_pseudo_letter}))`;
...
LinkifyIt.prototype.test = function test(text) {
  ...
  if (this.__opts__.fuzzyLink && this.__compiled__["http:"]) {
    if (text.search(this.re.host_fuzzy_test) >= 0) {
      if (
        text.match(this.__opts__.fuzzyIP ? this.re.link_fuzzy : this.re.link_no_ip_fuzzy) !== null
      )
        return true;
    }
  }
...
var import_punycode = /* @__PURE__ */ __toESM(
