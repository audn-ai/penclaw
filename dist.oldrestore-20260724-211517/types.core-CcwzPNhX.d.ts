...
import { n as GatewayClientName, t as GatewayClientMode } from "./client-info-Dd-clGC_.js";
import { t as OutboundMediaAccess } from "./load-options-CQixiFLj.js";
import { c as MessagePresentation } from "./payload-DYmvszuK.js";
import { n as PollInput } from "./polls-CfHkU59X.js";
import { n as ReplyDeliveryContext, r as ReplyPayload } from "./reply-payload-DPFdJynw.js";
import { _ as InboundEventKind, i as MsgContext } from "./templating-h3OQefFR.js";
import { f as AgentToolResult, l as AgentTool } from "./types-JQFrjdua.js";
 ...
 */
declare const CHANNEL_MESSAGE_ACTION_NAMES: readonly [
  "send",
  "broadcast",
  "poll",
  "poll-vote",
...
type ChannelThreadingAdapter = {
  ...
  resolveReplyTransport?: (params: {
    ...
    replyToId?:
      | string
      | null /** True when replyToId came from an explicit payload target or reply tag. */;
...
type ChannelThreadingContext = {
  ...
  TransportThreadId?:
    | string
    | number /** Platform-native channel/conversation id (e.g. Slack DM channel "D…" id). */;
...
type ChannelMessageActionContext = {
  ...
  requesterSenderId?:
    | string
    | null /** Trusted owner identity bit from command/channel-action auth. */;
  senderIsOwner?: boolean;
  /**
...
type ChannelToolSend = {
  ...
  threadId?:
    | string
    | null /** True when the native provider send may inherit the active conversation thread. */;
...
type ChannelMessagePreparedSendPayloadContext = {
  ...
  replyToId?:
    | string
    | null /** Preserve caller intent when plugins translate reply ids into durable payloads. */;
...
//#endregion
export {
  ChannelReplyTransport as A,
  ChannelToolSend as B,
  ChannelMessageToolSchemaContribution as C,
  ChannelOutboundTargetMode as D,
  ChannelOutboundSessionRoute as E,
  ChannelStreamingAdapter as F,
  CHANNEL_MESSAGE_ACTION_NAMES as G,
  PreferredAudioFileFormat as H,
  ChannelStructuredComponents as I,
  ChannelMessageActionName$1 as K,
  ChannelThreadingAdapter as L,
  ChannelSecurityDmPolicy as M,
  ChannelSetupInput as N,
  ChannelPollContext as O,
  ChannelStatusIssue as P,
  ChannelThreadingContext as R,
  ChannelMessageToolDiscovery as S,
  ChannelMeta as T,
  ChannelLegacyStateMigrationPlan as U,
  ChannelTtsVoiceDeliveryCapabilities as V,
  ChannelMessageCapability as W,
  ChannelMentionAdapter as _,
  ChannelAgentPromptAdapter as a,
  ChannelMessageActionDiscoveryContext as b,
  ChannelCapabilities as c,
  ChannelDirectoryEntryKind as d,
  ChannelExposure as f,
  ChannelLogSink as g,
  ChannelHeartbeatDeps as h,
  ChannelAccountState as i,
  ChannelSecurityContext as j,
  ChannelPollResult as k,
  ChannelCrossContextPresentationFactory as l,
  ChannelGroupContext as m,
  BaseTokenResolution as n,
  ChannelAgentTool as o,
  ChannelFocusedBindingContext as p,
  ConversationReadInvocationOrigin as q,
  ChannelAccountSnapshot as r,
  ChannelAgentToolFactory as s,
  BaseProbeResult as t,
  ChannelDirectoryEntry as u,
  ChannelMessageActionAdapter as v,
  ChannelMessagingAdapter as w,
  ChannelMessagePreparedSendPayloadContext as x,
  ChannelMessageActionContext as y,
  ChannelThreadingToolContext as z,
};
