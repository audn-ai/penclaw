...
function readDeepgramTranscript(payload) {
  ...
  if (alternative.transcript !== void 0 && typeof alternative.transcript !== "string")
    throw new Error("Audio transcription failed: malformed JSON response");
  ...
  try {
    ...
    return {
      text: requireTranscriptionText(
        readDeepgramTranscript(
          await readProviderJsonObjectResponse(res, "Audio transcription failed"),
        ),
