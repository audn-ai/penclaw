...
import { t as normalizeManifestCommandAliases } from "./manifest-command-aliases-DrFybOtt.js";
...
import { n as ENV_SECRET_REF_ID_RE } from "./types.secrets-BV0ywRAy.js";
...
const MEDIA_UNDERSTANDING_CAPABILITIES = /* @__PURE__ */ new Set(["image", "audio", "video"]);
...
function normalizeManifestCatalog(value) {
  ...
  const order =
    typeof value.order === "number" && Number.isFinite(value.order) ? value.order : void 0;
...
function loadPluginManifest(rootDir, rejectHardlinks = true, rootRealPath) {
  ...
  const modelCatalog = normalizeModelCatalog(raw.modelCatalog, {
    ownedProviders: /* @__PURE__ */ new Set([...providers, ...cliBackends]),
  });
...
function resolvePackageExtensionEntries(manifest) {
  ...
  if (rawOpenClaw === void 0 || rawOpenClaw === null)
    return {
      status: "missing",
      entries: [],
    };
...
//#endregion
export {
  normalizeManifestActivation as a,
  loadPluginManifest as i,
  PLUGIN_MANIFEST_FILENAME as n,
  normalizeManifestChannelCommandDefaults as o,
  getPackageManifestMetadata as r,
  resolvePackageExtensionEntries as s,
  DEFAULT_PLUGIN_ENTRY_CANDIDATES as t,
};
