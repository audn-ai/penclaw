...
declare function withTrustedExplicitProxyGuardedFetchMode(
  params: GuardedFetchPresetOptions,
): GuardedFetchOptions;
declare function retainSafeHeadersForCrossOriginRedirectHeaders(
  headers?: HeadersInit,
): Record<string, string> | undefined;
declare function fetchWithSsrFGuard(params: GuardedFetchOptions): Promise<GuardedFetchResult>;
//#endregion
export {
  fetchWithSsrFGuard as a,
  withTrustedEnvProxyGuardedFetchMode as c,
  GuardedFetchResult as i,
  withTrustedExplicitProxyGuardedFetchMode as l,
  GuardedFetchMode as n,
  retainSafeHeadersForCrossOriginRedirectHeaders as o,
  GuardedFetchOptions as r,
  withStrictGuardedFetchMode as s,
