    ...
    return await retryAsync(
      async () => {
        ...
        if (fulfilledRateLimit !== void 0)
          throw Object.assign(
            /* @__PURE__ */ new Error(
              `Request fulfilled with rate-limit code ${fulfilledRateLimit}`,
            ),
            {
              response: {
                status: 200,
...
function mergeFeishuAccountConfig(cfg, accountId) {
  ...
  if (merged.tools === void 0 && topTools !== void 0)
    return {
      ...merged,
      tools: topTools,
    };
  if (topTools?.bitable === false || (topTools?.bitable === void 0 && topTools?.base === false))
    return {
      ...merged,
      tools: {
        ...merged.tools,
  ...
  if (accountTools?.bitable === void 0 && accountTools?.base !== void 0)
    return {
      ...merged,
      tools: {
        ...merged.tools,
...
//#endregion
export {
  requestFeishuApi as _,
  resolveDefaultFeishuAccountId as a,
  parseFeishuCommentTarget as b,
  resolveFeishuCredentials as c,
  extractReplyText as d,
  formatFeishuApiError as f,
  readString as g,
  parseCommentContentElements as h,
  listFeishuAccountIds as i,
  resolveFeishuRuntimeAccount as l,
  normalizeString as m,
  ...
  encodeQuery as u,
  buildFeishuCommentTarget as v,
  normalizeCommentFileType as y,
};
