...
import {
  ...
  i as generatePKCE,
  l as resolveOAuthTokenLifetimeMs,
...
function loadNodeOAuthRuntime() {
  if (typeof process === "undefined" || (!process.versions?.node && !process.versions?.bun))
    return Promise.reject(
      /* @__PURE__ */ new Error("OpenAI Codex OAuth is only available in Node.js environments"),
    );
...
async function exchangeAuthorizationCode(code, verifier, redirectUri = REDIRECT_URI, options = {}) {
  ...
  if (!json.access_token || !json.refresh_token || expires === void 0)
    return {
      type: "failed",
...
export {
  testing as i,
  openaiCodexOAuthProvider as n,
  refreshOpenAICodexToken as r,
  loginOpenAICodex as t,
};
