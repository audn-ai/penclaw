...
declare function resolveAbsolutePathForRead(
  filePath: string,
  options?: {
    symlinks?: AbsolutePathSymlinkPolicy;
  },
): Promise<ResolvedAbsolutePath>;
declare function resolveAbsolutePathForWrite(
  filePath: string,
  options?: {
    symlinks?: AbsolutePathSymlinkPolicy;
  },
...
//#endregion
export {
  EnsureAbsoluteDirectoryOptions as a,
  ResolvedWritableAbsolutePath as c,
  findExistingAncestor as d,
  resolveAbsolutePathForRead as f,
  AbsolutePathSymlinkPolicy as i,
  assertAbsolutePathInput as l,
  pathExistsSync as n,
  EnsureAbsoluteDirectoryResult as o,
  resolveAbsolutePathForWrite as p,
  sanitizeUntrustedFileName as r,
  ResolvedAbsolutePath as s,
  pathExists as t,
  canonicalPathFromExistingAncestor as u,
};
