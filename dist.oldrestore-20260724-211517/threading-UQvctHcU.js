...
import "./simple-completion-runtime-Cs7_U_Yb.js";
import {
  ...
  try {
    try {
      const existingThreadId = (
        await getChannelMessage(params.client.rest, messageChannelId, params.message.id)
      )?.thread?.id;
      if (existingThreadId) {
        logVerbose(
...
export {
  ...
  resetDiscordThreadStarterCacheForTest as u,
};
