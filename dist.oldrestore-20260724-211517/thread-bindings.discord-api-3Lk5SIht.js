...
import { l as createThreadDiscord, s as sendWebhookMessageDiscord } from "./send-BrvWC0qr.js";
...
import {
  M as toReusableWebhookKey,
  _ as rememberReusableWebhook,
...
function resolveThreadBindingPersona(params) {
  return truncateUtf16Safe(
    `${SYSTEM_MARK} ${normalizePersonaLabel(params.label) || normalizePersonaLabel(params.agentId) || "agent"}`,
