...
import {
  ...
  c as withPluginScanExistenceCache,
  i as detectBundleManifestFormat,
} from "./bundle-manifest-Dxp5qa20.js";
import { r as resolveSourceCheckoutDependencyDiagnostic } from "./bundled-dir-CehpKn-r.js";
...
import { p as validatePluginId } from "./install-paths-CqMnrXsY.js";
import "./json-files-CTWRDHag.js";
import { a as readRootJsonObjectSync, c as tryReadJsonSync } from "./json-7OTJmMaB.js";
import {
  i as loadPluginManifest,
  r as getPackageManifestMetadata,
  s as resolvePackageExtensionEntries,
  t as DEFAULT_PLUGIN_ENTRY_CANDIDATES,
...
import {
  ...
  n as resolvePackageSetupSource,
  t as resolvePackageRuntimeExtensionSources,
...
import { n as resolvePluginSourceRoots } from "./roots-62ohA5O8.js";
import {
...
function deriveIdHint(params) {
  ...
  const normalizedPackageId =
    unscoped.endsWith("-provider") && unscoped.length > 9
      ? unscoped.slice(0, -9)
      : unscoped.endsWith("-plugin") && unscoped.length > 7
        ? unscoped.slice(0, -7)
        : unscoped;
...
function discoverInDirectory(params) {
  ...
  for (const entry of entries) {
    ...
    if (entryType === "file") {
      if (!(params.scanFiles ?? params.origin === "bundled") || !isExtensionFile(fullPath))
        continue;
      addCandidate({
        candidates: params.candidates,
        diagnostics: params.diagnostics,
  ...
  for (const name of readChildDirectoryNames(sourceExtensionsDir))
    if (
      getPackageManifestMetadata(
        readTrustedPackageManifest(path.join(sourceExtensionsDir, name)) ?? void 0,
...
function discoverFromPath(params) {
  ...
  if (stat.isDirectory()) {
    ...
    discoverInDirectory({
      ...
      realpathCache: params.realpathCache,
      packageManifestCache: params.packageManifestCache,
      ...(params.scanFiles !== void 0 || params.origin === "config"
        ? { scanFiles: params.scanFiles ?? true }
        : {}),
      ...(params.requireBuiltRuntimeEntry !== void 0
...
//#endregion
export {
  tracePluginLifecyclePhase as a,
  isBundledSourceOverlayPath as c,
  buildLegacyBundledRootPath as d,
  normalizeBundledLookupPath as f,
  normalizePluginDependencySpecs as i,
  listBundledSourceOverlayDirs as l,
  parsePackagedBundledPluginPath as m,
  discoverOpenClawPlugins as n,
  tracePluginLifecyclePhaseAsync as o,
  parseLegacyBundledPluginPath as p,
  buildPluginDependencyStatus as r,
  readLegacyNpmPluginDeclaration as s,
  discoverConfiguredPluginLoadPaths as t,
  buildBundledPluginLoadPathAliases as u,
};
