...
import { i as stripAnsiForStreamChunk } from "./ansi-D4OHEz5F.js";
...
function getShellEnv() {
  ...
  const updatedPath = currentPath.split(path.delimiter).filter(Boolean).includes(binDir)
    ? currentPath
...
//#endregion
export {
  killProcessTree as a,
  getShellEnv as i,
  getBashShellConfig as n,
  sanitizeBinaryOutput as o,
  getShellConfig as r,
  detectRuntimeShell as t,
};
