...
import {
  a as classifyFailoverSignal,
  d as inferSignalStatus,
  s as extractFailoverSignalDetails,
  w as isUnclassifiedNoBodyHttpSignal,
} from "./errors-BwoE4095.js";
import { y as parseStrictNonNegativeInteger } from "./number-coercion-CJQ8TR--.js";
import { x as isTimeoutErrorMessage } from "./sanitize-user-facing-text-B_JqK9fo.js";
...
function resolveFailoverClassificationFromError(err, providerHint) {
  return resolveFailoverClassificationFromErrorInternal(
    err,
    /* @__PURE__ */ new Set(),
    0,
    providerHint,
...
//#endregion
export {
  describeFailoverError as a,
  isNonProviderRuntimeCoordinationError as c,
  resolveFailoverReasonFromError as d,
  resolveFailoverStatus as f,
  coerceToFailoverError as i,
  isSignalTimeoutReason as l,
  buildFailoverRemediationHint as n,
  findCliMaxTurnsError as o,
  resolveModelFallbackError as p,
  buildProviderReauthCommand as r,
  isFailoverError as s,
  FailoverError as t,
  isTimeoutError as u,
};
