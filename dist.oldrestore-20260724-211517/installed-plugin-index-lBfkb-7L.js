...
const pluginCompatRecordByCode = new Map(
...
function hasMissingConfigPathActivationMetadata(index) {
  return index.plugins.some(
    (plugin) => recordUsesConfigPathActivation(plugin) && plugin.startup.configPaths === void 0,
  );
}
...
function hasConfigPathActivationMetadataMigration(params) {
  return (
    ...
    params.previous.startup.configPaths === void 0 &&
    params.current.startup.configPaths !== void 0
  );
}
//#endregion
...
//#endregion
export {
  getPluginCompatRecord as _,
  refreshInstalledPluginIndex as a,
  hasMissingConfigPathActivationMetadata as c,
  hasOptionalMissingPluginManifestFile as d,
  extractPluginInstallRecordsFromInstalledPluginIndex as f,
  hashJson as g,
  fileSignatureMatches as h,
  loadInstalledPluginIndexWithDiscovery as i,
  INSTALLED_PLUGIN_INDEX_WARNING as l,
  resolveInstalledPluginIndexPolicyHash as m,
  isInstalledPluginEnabled as n,
  diffInstalledPluginIndexInvalidationReasons as o,
  resolveCompatRegistryVersion as p,
  loadInstalledPluginIndex as r,
  CONFIG_PATH_ACTIVATION_COMPAT_CODE as s,
  getInstalledPluginRecord as t,
  collectPluginManifestCompatCodes as u,
};
