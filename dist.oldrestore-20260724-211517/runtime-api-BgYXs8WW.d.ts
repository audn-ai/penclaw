...
import {
  ...
  l as LineSendResult,
  u as LineTemplateMessagePayload,
 ...
 */
declare function datetimePickerAction(
  label: string,
  data: string,
 ...
 */
declare function createConfirmTemplate(
  text: string,
  confirmAction: Action$2,
  cancelAction: Action$2,
  altText?: string,
): TemplateMessage$1;
/**
 * Create a button template with title, text, and action buttons
 */
declare function createButtonTemplate(
 ...
 */
declare function createTemplateCarousel(
 ...
 */
declare function createImageCarousel(
 ...
 */
declare function createYesNoConfirm(
  question: string,
  options?: {
    yesText?: string;
    noText?: string;
 ...
 */
declare function createButtonMenu(
  title: string,
  text: string,
  buttons: Array<{
    label: string;
 ...
 */
declare function createLinkMenu(
  title: string,
  text: string,
  links: Array<{
    label: string;
 ...
 */
declare function createProductCarousel(
  products: Array<{
    title: string;
    description: string;
    imageUrl?: string;
 ...
 */
declare function buildTemplateMessageFromPayload(
  payload: LineTemplateMessagePayload,
): TemplateMessage$1 | null;
//#endregion
...
declare function createImageMessage(
  originalContentUrl: string,
  previewImageUrl?: string,
): ImageMessage;
declare function createVideoMessage(
  originalContentUrl: string,
  previewImageUrl: string,
  trackingId?: string,
): VideoMessage;
...
declare function sendMessageLine(
  to: string,
  text: string,
  opts: LineSendOpts,
): Promise<LineSendResult>;
declare function pushMessageLine(
  to: string,
  text: string,
  opts: LineSendOpts,
): Promise<LineSendResult>;
declare function replyMessageLine(
  replyToken: string,
  messages: Message[],
  opts: LinePushOpts,
): Promise<void>;
declare function pushMessagesLine(
  to: string,
  messages: Message[],
  opts: LinePushOpts,
): Promise<LineSendResult>;
declare function createFlexMessage(altText: string, contents: FlexContainer$2): FlexMessage$1;
declare function pushImageMessage(
  to: string,
  originalContentUrl: string,
  previewImageUrl: string | undefined,
  opts: LinePushOpts,
): Promise<LineSendResult>;
declare function pushLocationMessage(
  to: string,
  location: {
    title: string;
    address: string;
...
declare function pushFlexMessage(
  to: string,
  altText: string,
  contents: FlexContainer$1,
  opts: LinePushOpts,
): Promise<LineSendResult>;
declare function pushTemplateMessage(
  to: string,
  template: TemplateMessage,
  opts: LinePushOpts,
): Promise<LineSendResult>;
declare function pushTextMessageWithQuickReplies(
  to: string,
  text: string,
...
declare function createTextMessageWithQuickReplies(
  text: string,
  quickReplyLabels: string[],
): TextMessage & {
  quickReply: QuickReply;
};
declare function showLoadingAnimation(
  chatId: string,
  opts: LineClientOpts & {
...
declare function monitorLineProvider(
...
declare function downloadLineMedia(
  messageId: string,
  channelAccessToken: string,
  maxBytes?: number,
  options?: {
...
declare function resolveLineChannelAccessToken(
 ...
 */
declare function createImageCard(
  imageUrl: string,
  title: string,
  body?: string,
  options?: {
 ...
 */
declare function createActionCard(
  title: string,
  body: string,
  actions: CardAction[],
  options?: {
 ...
 */
declare function createNotificationBubble(
  text: string,
  options?: {
    icon?: string;
...
declare function validateLineSignature(
  body: string,
  signature: string,
  channelSecret: string,
): boolean;
...
declare function readLineWebhookRequestBody(
  req: IncomingMessage,
  maxBytes?: number,
  timeoutMs?: number,
): Promise<string>;
...
declare function createLineWebhookMiddleware(
...
declare function uploadRichMenuImage(
  richMenuId: string,
  imagePath: string,
  opts: RichMenuOpts,
): Promise<void>;
...
export {
  CardAction as $,
  createImageCarouselColumn as $t,
  MarkdownTable as A,
  pushFlexMessage as At,
  toFlexMessage as B,
  ButtonsTemplate as Bt,
  createLineWebhookMiddleware as C,
  createImageMessage as Ct,
  validateLineSignature as D,
  createVideoMessage as Dt,
  readLineWebhookRequestBody as E,
  createTextMessageWithQuickReplies as Et,
  extractCodeBlocks as F,
  pushTemplateMessage as Ft,
  createEventCard as G,
  ImageCarouselTemplate as Gt,
  createDeviceControlCard as H,
  CarouselTemplate as Ht,
  extractLinks as I,
  pushTextMessageWithQuickReplies as It,
  createCarousel as J,
  createButtonMenu as Jt,
  createReceiptCard as K,
  TemplateMessage$1 as Kt,
  extractMarkdownTables as L,
  replyMessageLine as Lt,
  convertCodeBlockToFlexBubble as M,
  pushLocationMessage as Mt,
  convertLinksToFlexBubble as N,
  pushMessageLine as Nt,
  CodeBlock as O,
  getUserDisplayName as Ot,
  convertTableToFlexBubble as P,
  pushMessagesLine as Pt,
  createNotificationBubble as Q,
  createImageCarousel as Qt,
  hasMarkdownToConvert as R,
  sendMessageLine as Rt,
  StartLineWebhookOptions as S,
  createFlexMessage as St,
  createLineNodeWebhookHandler as T,
  createQuickReplyItems as Tt,
  createMediaPlayerCard as U,
  ConfirmTemplate as Ut,
  createAppleTvRemoteCard as V,
  CarouselColumn as Vt,
  createAgendaCard as W,
  ImageCarouselColumn as Wt,
  createInfoCard as X,
  createCarouselColumn as Xt,
  createImageCard as Y,
  createButtonTemplate as Yt,
  createListCard as Z,
  createConfirmTemplate as Zt,
  getRichMenuList as _,
  NormalizedAllowFrom as _t,
  RichMenuResponse as a,
  datetimePickerAction as an,
  FlexContainer as at,
  parseLineWebhookBody as b,
  monitorLineProvider as bt,
  createDefaultMenuConfig as c,
  uriAction as cn,
  ListItem as ct,
  createRichMenuAlias as d,
  LineConfigSchemaType as dt,
  createLinkMenu as en,
  FlexBox as et,
  deleteRichMenu as f,
  resolveLineChannelAccessToken as ft,
  getRichMenuIdOfUser as g,
  downloadLineMedia as gt,
  getRichMenu as h,
  probeLineBot as ht,
  RichMenuRequest as i,
  Action$2 as in,
  FlexComponent as it,
  ProcessedLineMessage as j,
  pushImageMessage as jt,
  MarkdownLink as k,
  getUserProfile as kt,
  createGridLayout as l,
  LineChannelConfigSchema as lt,
  getDefaultRichMenuId as m,
  parseLineDirectives as mt,
  RichMenuArea as n,
  createTemplateCarousel as nn,
  FlexButton as nt,
  RichMenuSize as o,
  messageAction as on,
  FlexImage as ot,
  deleteRichMenuAlias as p,
  hasLineDirectives as pt,
  createActionCard as q,
  buildTemplateMessageFromPayload as qt,
  RichMenuAreaRequest as r,
  createYesNoConfirm as rn,
  FlexCarousel as rt,
  cancelDefaultRichMenu as s,
  postbackAction as sn,
  FlexText as st,
  CreateRichMenuParams as t,
  createProductCarousel as tn,
  FlexBubble as tt,
  createRichMenu as u,
  LineConfigSchema as ut,
  setDefaultRichMenu as v,
  normalizeAllowFrom as vt,
  startLineWebhook as w,
  createLocationMessage as wt,
  LineWebhookOptions as x,
  createAudioMessage as xt,
  uploadRichMenuImage as y,
  setLineRuntime as yt,
  processLineMessage as z,
  showLoadingAnimation as zt,
};
