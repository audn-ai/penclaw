...
function parseTelegramTarget(to) {
  ...
  if (topicMatch) {
    ...
    if (chatId === void 0 || threadIdText === void 0)
      return {
        chatId: normalized,
...
//#endregion
export {
  parseTelegramTarget as a,
  normalizeTelegramOutboundTarget as i,
  normalizeTelegramChatId as n,
  resolveTelegramTargetChatType as o,
  normalizeTelegramLookupTarget as r,
  stripTelegramInternalPrefixes as s,
  isNumericTelegramChatId as t,
};
