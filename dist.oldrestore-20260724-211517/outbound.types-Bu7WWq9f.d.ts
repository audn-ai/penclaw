...
import { D as ReplyPayloadDeliveryPin, c as MessagePresentation } from "./payload-DYmvszuK.js";
...
import {
  D as ChannelOutboundTargetMode,
  O as ChannelPollContext,
...
declare function resolveTextChunkLimit(
...
declare function resolveChunkMode(
  cfg: OpenClawConfig | undefined,
  provider?: TextChunkProvider,
  accountId?: string | null,
): ChunkMode;
 ...
 */
declare function chunkByNewline(
  text: string,
  ...
  limits?: {
    ...
    text?: {
      ...
      encoding?:
        | "characters"
        | "utf8-bytes"
        | "utf16-units" /** Markdown dialect understood by rendered text blocks. */;
      markdownDialect?:
        | "plain"
        | "markdown"
        | "html"
        | "slack-mrkdwn"
        | "discord-markdown" /** Whether the channel can edit presentation text in-place. */;
...
//#endregion
export {
  chunkTextWithMode as _,
  ChannelOutboundFormattedContext as a,
  ChannelOutboundTargetRef as c,
  OutboundDeliveryFormattingOptions as d,
  ChunkMode as f,
  chunkText as g,
  chunkMarkdownTextWithMode as h,
  ChannelOutboundContext as i,
  ChannelPresentationCapabilities as l,
  chunkMarkdownText as m,
  ChannelOutboundAdapter as n,
  ChannelOutboundPayloadContext as o,
  chunkByNewline as p,
  ChannelOutboundChunkContext as r,
  ChannelOutboundPayloadHint as s,
  ChannelDeliveryCapabilities as t,
  OutboundIdentity as u,
  resolveChunkMode as v,
  resolveTextChunkLimit as y,
};
