...
import { u as generatePkceVerifierChallenge } from "./provider-auth-mypr64nh.js";
import { n as generateOAuthState } from "./provider-auth-runtime-DpUprUn3.js";
  ...
  return new Promise((resolve, reject) => {
    ...
    const server = createServer((req, res) => {
      try {
        ...
        try {
          ...
          finish(
            err instanceof Error
              ? err
              : /* @__PURE__ */ new Error("OpenRouter OAuth state mismatch"),
          );
          return;
        }
        ...
        res.end(
          "<!doctype html><html><head><meta charset='utf-8'/></head><body><h2>OpenRouter OAuth complete</h2><p>You can close this window and return to OpenClaw.</p></body></html>",
        );
        finish(void 0, {
          code,
        ...
        finish(
          err instanceof Error
            ? err
            : /* @__PURE__ */ new Error("OpenRouter OAuth callback failed"),
        );
      }
    });
    ...
    server.once("error", (err) => {
      finish(
        err instanceof Error
          ? err
          : /* @__PURE__ */ new Error("OpenRouter OAuth callback server error"),
      );
    });
...
async function promptForOpenRouterRedirect(ctx, expectedState) {
  return parseOpenRouterOAuthCallbackInput(
...
//#endregion
export {
  OPENROUTER_OAUTH_CODE_CHALLENGE_METHOD as a,
  buildOpenRouterOAuthAuthorizeUrl as c,
  exchangeOpenRouterOAuthCode as d,
  loginOpenRouterOAuth as f,
  OPENROUTER_OAUTH_CHOICE_ID as i,
  buildOpenRouterOAuthRedirectUri as l,
  waitForOpenRouterOAuthCallback as m,
  OPENROUTER_OAUTH_CALLBACK_PATH as n,
  OPENROUTER_OAUTH_REDIRECT_URI as o,
  parseOpenRouterOAuthCallbackInput as p,
  OPENROUTER_OAUTH_CALLBACK_PORT as r,
  OPENROUTER_OAUTH_TOKEN_URL as s,
  OPENROUTER_OAUTH_CALLBACK_HOST as t,
  createOpenRouterOAuthAuthMethod as u,
};
